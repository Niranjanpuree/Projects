...
namespace AutoCare.Product.VcdbSearchIndex.Model
{
    ...
    public class VehicleToBodyStyleConfigDocument
    {
        public string VehicleToBodyStyleConfigId { get; set; }
        ...
        public long? VehicleToBodyStyleConfigChangeRequestId { get; set; }
        public long? BodyStyleConfigChangeRequestId { get; set; }
    }
}
