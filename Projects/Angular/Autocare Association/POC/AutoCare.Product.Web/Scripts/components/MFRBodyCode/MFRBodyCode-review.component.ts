...
import { IMfrBodyCodeChangeRequestReview }                           from "./mfrBodyCode.model";
...
@Component({
    ...
    providers: [MfrBodyCodeService, LikeStagingService, UserService, ChangeService],
})

export class MfrBodyCodeReviewComponent implements OnInit {
    mfrBodyCodeChangeRequest: IMfrBodyCodeChangeRequestReview;
    ...
    onSubmitReview(deletebuttonclicked: String) {
        ...
        if (deletebuttonclicked == 'delete') {
            ...
            if (this.isPreliminaryApproveChecked) {
                ...
                this.changeRequestReview.reviewStatus = ChangeRequestStatus[this.mfrBodyCodeChangeRequest.stagingItem.status];
            }
        }
        ...
        this.newAcFileUploader.uploadAttachments().subscribe(uploadedFiles => {
            ...
            this.mfrBodyCodeService.submitChangeRequestReview(this.mfrBodyCodeChangeRequest.stagingItem.changeRequestId, this.changeRequestReview).subscribe(
                result => {
                    if (result) {
                        ...
                        if (this.changeRequestReview.reviewStatus != ChangeRequestStatus.Deleted) {
                            toasterMessage = {
                                ...
                                body: `Your review for ${this.mfrBodyCodeChangeRequest.stagingItem.changeType} ${this.mfrBodyCodeChangeRequest.stagingItem.entityName} : ${this.mfrBodyCodeChangeRequest.entityStaging.name}  change request ID ${this.mfrBodyCodeChangeRequest.stagingItem.changeRequestId} was submitted successfully.`
                            };
                        } else {
                            toasterMessage = {
                                title: ConstantsWarehouse.reviewDeleteSuccessTitle,
                                body: `Your delete request for ${this.mfrBodyCodeChangeRequest.stagingItem.changeType} ${this.mfrBodyCodeChangeRequest.stagingItem.entityName} : ${this.mfrBodyCodeChangeRequest.entityStaging.name}  change request ID ${this.mfrBodyCodeChangeRequest.stagingItem.changeRequestId} was submitted successfully.`
                            };
                        }
                        ...
                        if (this.changeRequestReview.reviewStatus != ChangeRequestStatus.Deleted) {
                            toasterMessage = {
                                ...
                                body: `Your review for ${this.mfrBodyCodeChangeRequest.stagingItem.changeType} ${this.mfrBodyCodeChangeRequest.stagingItem.entityName} : ${this.mfrBodyCodeChangeRequest.entityStaging.name}  change request ID ${this.mfrBodyCodeChangeRequest.stagingItem.changeRequestId} failed.`
                            };
                        } else {
                            toasterMessage = {
                                title: ConstantsWarehouse.reviewDeleteErrorTitle,
                                body: `Your delete request for ${this.mfrBodyCodeChangeRequest.stagingItem.changeType} ${this.mfrBodyCodeChangeRequest.stagingItem.entityName} : ${this.mfrBodyCodeChangeRequest.entityStaging.name}  change request ID ${this.mfrBodyCodeChangeRequest.stagingItem.changeRequestId} failed.`
                            };
                        }
        ...
        this.changeService.assignReviewer(this.assignedReviewer).subscribe(result => {
            if (result) {
                let toasterMessage = {
                    ...
                    body: `Your review for ${this.mfrBodyCodeChangeRequest.stagingItem.changeType} ${this.mfrBodyCodeChangeRequest.stagingItem.entityName} : ${this.mfrBodyCodeChangeRequest.entityStaging.name} assigned successfully.`
                }
                this.toastr.success(toasterMessage.body, toasterMessage.title);
                ...
                let toasterMessage = {
                    ...
                    body: `Your assignment for ${this.mfrBodyCodeChangeRequest.stagingItem.changeType} ${this.mfrBodyCodeChangeRequest.stagingItem.entityName} : ${this.mfrBodyCodeChangeRequest.entityStaging.name} failed.`
                }
                this.toastr.warning(toasterMessage.body, toasterMessage.title);
            }
        },
