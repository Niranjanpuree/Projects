...
import { IBedLengthChangeRequestReview }                               from "./bedLength.model";
...
@Component({
    ...
    providers: [BedLengthService, LikeStagingService, UserService, ChangeService],
})

export class BedLengthReviewComponent implements OnInit {
    bedLengthChangeRequest: IBedLengthChangeRequestReview;
    ...
    constructor(private bedLengthService: BedLengthService, private likeStagingService: LikeStagingService, private toastr: ToastsManager,
    ...
    ngOnInit() {
        ...
        this.bedLengthService.getChangeRequestStaging(id).subscribe(
            result => {
                this.bedLengthChangeRequest = result;
               
                // set review's changerequestid
                this.changeRequestReview.changeRequestId = this.bedLengthChangeRequest.stagingItem.changeRequestId;
                ...
                this.likeStagingService.getLikeDetails(id).subscribe(result => {
                 ...
                 if (this.bedLengthChangeRequest.stagingItem.status === "PreliminaryApproved") {
    ...
    onSubmitReview(deletebuttonclicked: String) {
        ...
        this.newAcFileUploader.uploadAttachments().subscribe(uploadedFiles => {
            ...
            this.bedLengthService.submitChangeRequestReview(this.bedLengthChangeRequest.stagingItem.changeRequestId, this.changeRequestReview).subscribe(
                result => {
                    if (result) {
                        ...
                        if (this.changeRequestReview.reviewStatus != ChangeRequestStatus.Deleted) {
                            toasterMessage = {
                                ...
                                body: `Your review for ${this.bedLengthChangeRequest.stagingItem.changeType} ${this.bedLengthChangeRequest.stagingItem.entityName} : ${this.bedLengthChangeRequest.entityStaging.length} change request ID '${this.bedLengthChangeRequest.stagingItem.changeRequestId}' was submitted successfully.`
                            };
                        } else {
                            toasterMessage = {
                                title: ConstantsWarehouse.reviewDeleteSuccessTitle,
                                body: `Your delete request for ${this.bedLengthChangeRequest.stagingItem.changeType} ${this.bedLengthChangeRequest.stagingItem.entityName} : ${this.bedLengthChangeRequest.entityStaging.length} change request ID '${this.bedLengthChangeRequest.stagingItem.changeRequestId}' was submitted successfully.`
                            };
                        }
                        ...
                        if (this.changeRequestReview.reviewStatus != ChangeRequestStatus.Deleted) {
                            toasterMessage = {
                                ...
                                body: `Your review for ${this.bedLengthChangeRequest.stagingItem.changeType} ${this.bedLengthChangeRequest.stagingItem.entityName} : ${this.bedLengthChangeRequest.entityStaging.length} change request ID '${this.bedLengthChangeRequest.stagingItem.changeRequestId}' failed.`
                            };
                        } else {
                            toasterMessage = {
                                title: ConstantsWarehouse.reviewDeleteErrorTitle,
                                body: `Your delete request for ${this.bedLengthChangeRequest.stagingItem.changeType} ${this.bedLengthChangeRequest.stagingItem.entityName} : ${this.bedLengthChangeRequest.entityStaging.length} change request ID '${this.bedLengthChangeRequest.stagingItem.changeRequestId}' failed.`
                            };
                        }
                ...
                error => {
                    ...
                    if (this.changeRequestReview.reviewStatus != ChangeRequestStatus.Deleted) {
                        toasterMessage = {
                            title: ConstantsWarehouse.reviewSubmitErrorTitle,
                            body: `Your review for ${this.bedLengthChangeRequest.stagingItem.changeType} ${this.bedLengthChangeRequest.stagingItem.entityName} : ${this.bedLengthChangeRequest.entityStaging.length} failed.\n${<any>error.toString()}.`
                        };
                    } else {
                        toasterMessage = {
                            title: ConstantsWarehouse.reviewSubmitErrorTitle,
                            body: `Your delete request for ${this.bedLengthChangeRequest.stagingItem.changeType} ${this.bedLengthChangeRequest.stagingItem.entityName} : ${this.bedLengthChangeRequest.entityStaging.length} failed.\n${<any>error.toString()}.`
                        };
                    }
                    this.toastr.warning(toasterMessage.body, toasterMessage.title);
        ...
        this.changeService.assignReviewer(this.assignedReviewer).subscribe(result => {
            if (result) {
                let toasterMessage = {
                    ...
                    body: `Your review for ${this.bedLengthChangeRequest.stagingItem.changeType} ${this.bedLengthChangeRequest.stagingItem.entityName} : ${this.bedLengthChangeRequest.entityStaging.length} assigned successfully.`
                }
                this.toastr.success(toasterMessage.body, toasterMessage.title);
                ...
                let toasterMessage = {
                    ...
                    body: `Your assignment for ${this.bedLengthChangeRequest.stagingItem.changeType} ${this.bedLengthChangeRequest.stagingItem.entityName} : ${this.bedLengthChangeRequest.entityStaging.length} failed.`
                }
                this.toastr.warning(toasterMessage.body, toasterMessage.title);
            }
        },
