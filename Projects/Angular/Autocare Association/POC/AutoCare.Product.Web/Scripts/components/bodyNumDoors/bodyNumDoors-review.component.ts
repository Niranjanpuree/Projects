...
import { IBodyNumDoorsChangeRequestReview }                              from "./bodyNumDoors.model";
...
@Component({
    ...
    providers: [BodyNumDoorsService, LikeStagingService, UserService, ChangeService],
})

export class BodyNumDoorsReviewComponent implements OnInit {
    usersForAssignment: IUser[] = [];
    assignedReviewer: IAssignReviewer = { assignedToUserId: "-1", changeRequestIds: [] };
    bodyNumDoorsChangeRequest: IBodyNumDoorsChangeRequestReview;
   ...
   showPrelimRadio: boolean = true;
    ...
    constructor(private bodyNumDoorsService: BodyNumDoorsService, private likeStagingService: LikeStagingService,
    ...
    ngOnInit() {
        ...
        this.bodyNumDoorsService.getChangeRequestStaging(id).subscribe(
            result => {
                this.bodyNumDoorsChangeRequest = result;

                // set review's changerequestid
                this.changeRequestReview.changeRequestId = this.bodyNumDoorsChangeRequest.stagingItem.changeRequestId;
                //this.getLikes(id);
                ...
                if (this.bodyNumDoorsChangeRequest.stagingItem.status === "PreliminaryApproved") {
    ...
    onSubmitReview(deletebuttonclicked: String) {
        ...
        if (deletebuttonclicked == 'delete') {
            ...
            if (this.isPreliminaryApproveChecked) {
                ...
                this.changeRequestReview.reviewStatus = ChangeRequestStatus[this.bodyNumDoorsChangeRequest.stagingItem.status];
            }
        }
        ...
        this.newAcFileUploader.uploadAttachments().subscribe(uploadedFiles => {
            ...
            this.bodyNumDoorsService.submitChangeRequestReview(this.bodyNumDoorsChangeRequest.stagingItem.changeRequestId, this.changeRequestReview).subscribe(
                result => {
                    if (result) {
                        ...
                        if (this.changeRequestReview.reviewStatus != ChangeRequestStatus.Deleted) {
                            toasterMessage = {
                                ...
                                body: `Your review for ${this.bodyNumDoorsChangeRequest.stagingItem.changeType} ${this.bodyNumDoorsChangeRequest.stagingItem.entityName} : ${this.bodyNumDoorsChangeRequest.entityStaging.numDoors} change request ID ${this.bodyNumDoorsChangeRequest.stagingItem.changeRequestId} was submitted successfully.`
                            };
                        } else {
                            toasterMessage = {
                                title: ConstantsWarehouse.reviewDeleteSuccessTitle,
                                body: `Your delete request for ${this.bodyNumDoorsChangeRequest.stagingItem.changeType} ${this.bodyNumDoorsChangeRequest.stagingItem.entityName} : ${this.bodyNumDoorsChangeRequest.entityStaging.numDoors}  change request ID ${this.bodyNumDoorsChangeRequest.stagingItem.changeRequestId} was submitted successfully.`
                            };
                        }
                        ...
                        if (this.changeRequestReview.reviewStatus != ChangeRequestStatus.Deleted) {
                            toasterMessage = {
                                ...
                                body: `Your review for ${this.bodyNumDoorsChangeRequest.stagingItem.changeType} ${this.bodyNumDoorsChangeRequest.stagingItem.entityName} : ${this.bodyNumDoorsChangeRequest.entityStaging.numDoors}  change request ID ${this.bodyNumDoorsChangeRequest.stagingItem.changeRequestId} failed.`
                            };
                        } else {
                            toasterMessage = {
                                title: ConstantsWarehouse.reviewDeleteErrorTitle,
                                body: `Your delete request for ${this.bodyNumDoorsChangeRequest.stagingItem.changeType} ${this.bodyNumDoorsChangeRequest.stagingItem.entityName} : ${this.bodyNumDoorsChangeRequest.entityStaging.numDoors}  change request ID ${this.bodyNumDoorsChangeRequest.stagingItem.changeRequestId} failed.`
                            };
                        }
        ...
        this.changeService.assignReviewer(this.assignedReviewer).subscribe(result => {
            if (result) {
                let toasterMessage = {
                    ...
                    body: `Your review for ${this.bodyNumDoorsChangeRequest.stagingItem.changeType} ${this.bodyNumDoorsChangeRequest.stagingItem.entityName} : ${this.bodyNumDoorsChangeRequest.entityStaging.numDoors} assigned successfully.`
                }
                this.toastr.success(toasterMessage.body, toasterMessage.title);
                ...
                let toasterMessage = {
                    ...
                    body: `Your assignment for ${this.bodyNumDoorsChangeRequest.stagingItem.changeType} ${this.bodyNumDoorsChangeRequest.stagingItem.entityName} : ${this.bodyNumDoorsChangeRequest.entityStaging.numDoors} failed.`
                }
                this.toastr.warning(toasterMessage.body, toasterMessage.title);
            }
        },
