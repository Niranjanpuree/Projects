...
import { IBrakeABSChangeRequestReview }                               from "./brakeABS.model";
...
@Component({
    ...
    providers: [BrakeABSService, LikeStagingService, UserService, ChangeService],
})

export class BrakeABSReviewComponent implements OnInit {
    brakeABSChangeRequest: IBrakeABSChangeRequestReview;
    ...
    constructor(private brakeABSService: BrakeABSService, private likeStagingService: LikeStagingService, private toastr: ToastsManager,
    ...
    ngOnInit() {
        ...
        this.brakeABSService.getChangeRequestStaging(id).subscribe(
            result => {
                this.brakeABSChangeRequest = result;

                // set review's changerequestid
                this.changeRequestReview.changeRequestId = this.brakeABSChangeRequest.stagingItem.changeRequestId;
                ...
                if (this.brakeABSChangeRequest.stagingItem.status == "PreliminaryApproved") {
                    this.showPrelimRadio = false;
                }
            },
            error => {
    ...
    onSubmitReview(deletebuttonclicked: String) {
        ...
        if (deletebuttonclicked == 'delete') {
            ...
            if (this.isPreliminaryApproveChecked) {
                ...
                this.changeRequestReview.reviewStatus = ChangeRequestStatus[this.brakeABSChangeRequest.stagingItem.status];
            }
        }
        ...
        this.newAcFileUploader.uploadAttachments().subscribe(uploadedFiles => {
            ...
            this.brakeABSService.submitChangeRequestReview(this.brakeABSChangeRequest.stagingItem.changeRequestId, this.changeRequestReview).subscribe(
                result => {
                    if (result) {
                        ...
                        if (this.changeRequestReview.reviewStatus != ChangeRequestStatus.Deleted) {
                            toasterMessage = {
                                ...
                                body: `Your review for ${this.brakeABSChangeRequest.stagingItem.changeType} ${this.brakeABSChangeRequest.stagingItem.entityName} : ${this.brakeABSChangeRequest.entityStaging.name} change request ID '${this.brakeABSChangeRequest.stagingItem.changeRequestId}' was submitted successfully.`
                            };
                        } else {
                            toasterMessage = {
                                title: ConstantsWarehouse.reviewDeleteSuccessTitle,
                                body: `Your delete request for ${this.brakeABSChangeRequest.stagingItem.changeType} ${this.brakeABSChangeRequest.stagingItem.entityName} : ${this.brakeABSChangeRequest.entityStaging.name} change request ID '${this.brakeABSChangeRequest.stagingItem.changeRequestId}' was submitted successfully.`
                            };
                        }
                        ...
                        if (this.changeRequestReview.reviewStatus != ChangeRequestStatus.Deleted) {
                            toasterMessage = {
                                ...
                                body: `Your review for ${this.brakeABSChangeRequest.stagingItem.changeType} ${this.brakeABSChangeRequest.stagingItem.entityName} : ${this.brakeABSChangeRequest.entityStaging.name} change request ID '${this.brakeABSChangeRequest.stagingItem.changeRequestId}' failed.`
                            };
                        } else {
                            toasterMessage = {
                                title: ConstantsWarehouse.reviewDeleteErrorTitle,
                                body: `Your delete request for ${this.brakeABSChangeRequest.stagingItem.changeType} ${this.brakeABSChangeRequest.stagingItem.entityName} : ${this.brakeABSChangeRequest.entityStaging.name} change request ID '${this.brakeABSChangeRequest.stagingItem.changeRequestId}' failed.`
                            };
                        }
                ...
                error => {
                    ...
                    if (this.changeRequestReview.reviewStatus != ChangeRequestStatus.Deleted) {
                        toasterMessage = {
                            title: ConstantsWarehouse.reviewSubmitErrorTitle,
                            body: `Your review for ${this.brakeABSChangeRequest.stagingItem.changeType} ${this.brakeABSChangeRequest.stagingItem.entityName} : ${this.brakeABSChangeRequest.entityStaging.name} failed.\n${<any>error.toString()}.`
                        };
                    } else {
                        toasterMessage = {
                            title: ConstantsWarehouse.reviewSubmitErrorTitle,
                            body: `Your delete request for ${this.brakeABSChangeRequest.stagingItem.changeType} ${this.brakeABSChangeRequest.stagingItem.entityName} : ${this.brakeABSChangeRequest.entityStaging.name} failed.\n${<any>error.toString()}.`
                        };
                    }
                    this.toastr.warning(toasterMessage.body, toasterMessage.title);
        ...
        this.changeService.assignReviewer(this.assignedReviewer).subscribe(result => {
            if (result) {
                let toasterMessage = {
                    ...
                    body: `Your review for ${this.brakeABSChangeRequest.stagingItem.changeType} ${this.brakeABSChangeRequest.stagingItem.entityName} : ${this.brakeABSChangeRequest.entityStaging.name} assigned successfully.`
                }
                this.toastr.success(toasterMessage.body, toasterMessage.title);
                ...
                let toasterMessage = {
                    ...
                    body: `Your assignment for ${this.brakeABSChangeRequest.stagingItem.changeType} ${this.brakeABSChangeRequest.stagingItem.entityName} : ${this.brakeABSChangeRequest.entityStaging.name} failed.`
                }
                this.toastr.warning(toasterMessage.body, toasterMessage.title);
            }
        },
