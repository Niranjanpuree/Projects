...
import { IBrakeSystemChangeRequestReview }                            from "./brakeSystem.model";
...
@Component({
    ...
    providers: [BrakeSystemService, LikeStagingService, UserService, ChangeService],
})

export class BrakeSystemReviewComponent implements OnInit {
    disabled: boolean = false;
    brakeSystemChangeRequest: IBrakeSystemChangeRequestReview;
    ...
    numberOfBaseVehiclesAffected: Number = 0;
    ...
    constructor(private brakeSystemService: BrakeSystemService, private likeStagingService: LikeStagingService, private toastr: ToastsManager,
    ...
    ngOnInit() {
        ...
        this.brakeSystemService.getChangeRequestStaging(id).subscribe(
            result => {
                this.brakeSystemChangeRequest = result;

                this.changeRequestReview.changeRequestId = this.brakeSystemChangeRequest.stagingItem.changeRequestId;
                ...
                if (this.brakeSystemChangeRequest.stagingItem.status == "PreliminaryApproved") {
                    this.showPrelimRadio = false;
                }
            },
            error => {
    ...
    onSubmitReview(deletebuttonclicked: String) {
        ...
        if (deletebuttonclicked == 'delete') {
            ...
            if (this.isPreliminaryApproveChecked) {
                ...
                this.changeRequestReview.reviewStatus = ChangeRequestStatus[this.brakeSystemChangeRequest.stagingItem.status];
            }
        }
        ...
        this.newAcFileUploader.uploadAttachments().subscribe(uploadedFiles => {
            ...
            this.brakeSystemService.submitChangeRequestReview(this.brakeSystemChangeRequest.stagingItem.changeRequestId, this.changeRequestReview).subscribe(
                result => {
                    if (result) {
                        ...
                        if (this.changeRequestReview.reviewStatus != ChangeRequestStatus.Deleted) {
                            toasterMessage = {
                                ...
                                body: `Your review for ${this.brakeSystemChangeRequest.stagingItem.changeType} ${this.brakeSystemChangeRequest.stagingItem.entityName} : ${this.brakeSystemChangeRequest.entityStaging.name} change request ID ${this.brakeSystemChangeRequest.stagingItem.changeRequestId} was submitted successfully.`
                            };
                        } else {
                            toasterMessage = {
                                title: ConstantsWarehouse.reviewDeleteSuccessTitle,
                                body: `Your delete request for ${this.brakeSystemChangeRequest.stagingItem.changeType} ${this.brakeSystemChangeRequest.stagingItem.entityName} : ${this.brakeSystemChangeRequest.entityStaging.name} change request ID ${this.brakeSystemChangeRequest.stagingItem.changeRequestId} was submitted successfully.`
                            };
                        }
                        ...
                        if (this.changeRequestReview.reviewStatus != ChangeRequestStatus.Deleted) {
                            toasterMessage = {
                                ...
                                body: `Your review for ${this.brakeSystemChangeRequest.stagingItem.changeType} ${this.brakeSystemChangeRequest.stagingItem.entityName} : ${this.brakeSystemChangeRequest.entityStaging.name} change request ID ${this.brakeSystemChangeRequest.stagingItem.changeRequestId} failed.`
                            };
                        } else {
                            toasterMessage = {
                                title: ConstantsWarehouse.reviewDeleteErrorTitle,
                                body: `Your delete request for ${this.brakeSystemChangeRequest.stagingItem.changeType} ${this.brakeSystemChangeRequest.stagingItem.entityName} : ${this.brakeSystemChangeRequest.entityStaging.name} change request ID ${this.brakeSystemChangeRequest.stagingItem.changeRequestId} failed.`
                            };
                        }
        ...
        this.changeService.assignReviewer(this.assignedReviewer).subscribe(result => {
            if (result) {
                let toasterMessage = {
                    ...
                    body: `Your review for ${this.brakeSystemChangeRequest.stagingItem.changeType} ${this.brakeSystemChangeRequest.stagingItem.entityName} : ${this.brakeSystemChangeRequest.entityStaging.name} assigned successfully.`
                }
                this.toastr.success(toasterMessage.body, toasterMessage.title);
                ...
                let toasterMessage = {
                    ...
                    body: `Your assignment for ${this.brakeSystemChangeRequest.stagingItem.changeType} ${this.brakeSystemChangeRequest.stagingItem.entityName} : ${this.brakeSystemChangeRequest.entityStaging.name} failed.`
                }
                this.toastr.warning(toasterMessage.body, toasterMessage.title);
            }
        },
