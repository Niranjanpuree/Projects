...
import { IBrakeTypeChangeRequestReview }                              from "./brakeType.model";
...
@Component({
    ...
    providers: [BrakeTypeService, LikeStagingService, UserService, ChangeService],
})

export class BrakeTypeReviewComponent implements OnInit {
    usersForAssignment: IUser[] = [];
    assignedReviewer: IAssignReviewer = { assignedToUserId: "-1", changeRequestIds: [] };
    brakeTypeChangeRequest: IBrakeTypeChangeRequestReview;
    ...
    constructor(private brakeTypeService: BrakeTypeService, private likeStagingService: LikeStagingService,
    ...
    ngOnInit() {
        ...
        this.brakeTypeService.getChangeRequestStaging(id).subscribe(
            result => {
                this.brakeTypeChangeRequest = result;

                // set review's changerequestid
                this.changeRequestReview.changeRequestId = this.brakeTypeChangeRequest.stagingItem.changeRequestId;
                //this.getLikes(id);
                ...
                if (this.brakeTypeChangeRequest.stagingItem.status == "PreliminaryApproved") {
                    this.showPrelimRadio = false;
                }
            },
            error => {
    ...
    onSubmitReview(deletebuttonclicked: String) {
        ...
        if (deletebuttonclicked == 'delete') {
            ...
            if (this.isPreliminaryApproveChecked) {
                ...
                this.changeRequestReview.reviewStatus = ChangeRequestStatus[this.brakeTypeChangeRequest.stagingItem.status];
            }
        }
        ...
        this.newAcFileUploader.uploadAttachments().subscribe(uploadedFiles => {
            ...
            this.brakeTypeService.submitChangeRequestReview(this.brakeTypeChangeRequest.stagingItem.changeRequestId, this.changeRequestReview).subscribe(
                result => {
                    if (result) {
                        ...
                        if (this.changeRequestReview.reviewStatus != ChangeRequestStatus.Deleted) {
                            toasterMessage = {
                                ...
                                body: `Your review for ${this.brakeTypeChangeRequest.stagingItem.changeType} ${this.brakeTypeChangeRequest.stagingItem.entityName} : ${this.brakeTypeChangeRequest.entityStaging.name} change request ID ${this.brakeTypeChangeRequest.stagingItem.changeRequestId} was submitted successfully.`
                            };
                        } else {
                            toasterMessage = {
                                title: ConstantsWarehouse.reviewDeleteSuccessTitle,
                                body: `Your delete request for ${this.brakeTypeChangeRequest.stagingItem.changeType} ${this.brakeTypeChangeRequest.stagingItem.entityName} : ${this.brakeTypeChangeRequest.entityStaging.name}  change request ID ${this.brakeTypeChangeRequest.stagingItem.changeRequestId} was submitted successfully.`
                            };
                        }
                        ...
                        if (this.changeRequestReview.reviewStatus != ChangeRequestStatus.Deleted) {
                            toasterMessage = {
                                ...
                                body: `Your review for ${this.brakeTypeChangeRequest.stagingItem.changeType} ${this.brakeTypeChangeRequest.stagingItem.entityName} : ${this.brakeTypeChangeRequest.entityStaging.name}  change request ID ${this.brakeTypeChangeRequest.stagingItem.changeRequestId} failed.`
                            };
                        } else {
                            toasterMessage = {
                                title: ConstantsWarehouse.reviewDeleteErrorTitle,
                                body: `Your delete request for ${this.brakeTypeChangeRequest.stagingItem.changeType} ${this.brakeTypeChangeRequest.stagingItem.entityName} : ${this.brakeTypeChangeRequest.entityStaging.name}  change request ID ${this.brakeTypeChangeRequest.stagingItem.changeRequestId} failed.`
                            };
                        }
        ...
        this.changeService.assignReviewer(this.assignedReviewer).subscribe(result => {
            if (result) {
                let toasterMessage = {
                    ...
                    body: `Your review for ${this.brakeTypeChangeRequest.stagingItem.changeType} ${this.brakeTypeChangeRequest.stagingItem.entityName} : ${this.brakeTypeChangeRequest.entityStaging.name} assigned successfully.`
                }
                this.toastr.success(toasterMessage.body, toasterMessage.title);
                ...
                let toasterMessage = {
                    ...
                    body: `Your assignment for ${this.brakeTypeChangeRequest.stagingItem.changeType} ${this.brakeTypeChangeRequest.stagingItem.entityName} : ${this.brakeTypeChangeRequest.entityStaging.name} failed.`
                }
                this.toastr.warning(toasterMessage.body, toasterMessage.title);
            }
        },
