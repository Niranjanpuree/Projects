...
import { IEngineDesignationChangeRequestReview }                               from "./engineDesignation.model";
...
@Component({
    ...
    providers: [EngineDesignationService, LikeStagingService, UserService, ChangeService],
})

export class EngineDesignationReviewComponent implements OnInit {

    usersForAssignment: IUser[] = [];
    assignedReviewer: IAssignReviewer = { assignedToUserId: "-1", changeRequestIds: [] };
    engineDesignationChangeRequest: IEngineDesignationChangeRequestReview;
    ...
    constructor(private engineDesignationService: EngineDesignationService, private likeStagingService: LikeStagingService,
    ...
    ngOnInit() {
        ...
        this.engineDesignationService.getChangeRequestStaging(id).subscribe(
            result => {
                this.engineDesignationChangeRequest = result;

                // set review's changerequestid
                this.changeRequestReview.changeRequestId = this.engineDesignationChangeRequest.stagingItem.changeRequestId;
                //this.getLikes(id);
                ...
                if (this.engineDesignationChangeRequest.stagingItem.status === "Approved" || this.engineDesignationChangeRequest.stagingItem.status === "Deleted" || this.engineDesignationChangeRequest.stagingItem.status === "Rejected") {
                    this.reviewCompleted = true;
                } else if (this.engineDesignationChangeRequest.stagingItem.status === "PreliminaryApproved") {
    ...
    onSubmitReview(deletebuttonclicked: String) {
        ...
        this.newAcFileUploader.uploadAttachments().subscribe(uploadedFiles => {
            ...
            this.engineDesignationService.submitChangeRequestReview(this.engineDesignationChangeRequest.stagingItem.changeRequestId, this.changeRequestReview).subscribe(
                result => {
                    if (result) {
                        ...
                        if (this.changeRequestReview.reviewStatus != ChangeRequestStatus.Deleted) {
                            toasterMessage = {
                                ...
                                body: `Your review for ${this.engineDesignationChangeRequest.stagingItem.changeType} ${this.engineDesignationChangeRequest.stagingItem.entityName} : ${this.engineDesignationChangeRequest.entityStaging.engineDesignationName} change request ID ${this.engineDesignationChangeRequest.stagingItem.changeRequestId} was submitted successfully.`
                            };
                        } else {
                            toasterMessage = {
                                title: ConstantsWarehouse.reviewDeleteSuccessTitle,
                                body: `Your delete request for ${this.engineDesignationChangeRequest.stagingItem.changeType} ${this.engineDesignationChangeRequest.stagingItem.entityName} : ${this.engineDesignationChangeRequest.entityStaging.engineDesignationName}  change request ID ${this.engineDesignationChangeRequest.stagingItem.changeRequestId} was submitted successfully.`
                            };
                        }
                        ...
                        if (this.changeRequestReview.reviewStatus != ChangeRequestStatus.Deleted) {
                            toasterMessage = {
                                ...
                                body: `Your review for ${this.engineDesignationChangeRequest.stagingItem.changeType} ${this.engineDesignationChangeRequest.stagingItem.entityName} : ${this.engineDesignationChangeRequest.entityStaging.engineDesignationName}  change request ID ${this.engineDesignationChangeRequest.stagingItem.changeRequestId} failed.`
                            };
                        } else {
                            toasterMessage = {
                                title: ConstantsWarehouse.reviewDeleteErrorTitle,
                                body: `Your delete request for ${this.engineDesignationChangeRequest.stagingItem.changeType} ${this.engineDesignationChangeRequest.stagingItem.entityName} : ${this.engineDesignationChangeRequest.entityStaging.engineDesignationName}  change request ID ${this.engineDesignationChangeRequest.stagingItem.changeRequestId} failed.`
                            };
                        }
        ...
        this.changeService.assignReviewer(this.assignedReviewer).subscribe(result => {
            if (result) {
                let toasterMessage = {
                    ...
                    body: `Your review for ${this.engineDesignationChangeRequest.stagingItem.changeType} ${this.engineDesignationChangeRequest.stagingItem.entityName} : ${this.engineDesignationChangeRequest.entityStaging.engineDesignationName} assigned successfully.`
                }
                this.toastr.success(toasterMessage.body, toasterMessage.title);
                ...
                let toasterMessage = {
                    ...
                    body: `Your assignment for ${this.engineDesignationChangeRequest.stagingItem.changeType} ${this.engineDesignationChangeRequest.stagingItem.entityName} : ${this.engineDesignationChangeRequest.entityStaging.engineDesignationName} failed.`
                }
                this.toastr.warning(toasterMessage.body, toasterMessage.title);
            }
        },
