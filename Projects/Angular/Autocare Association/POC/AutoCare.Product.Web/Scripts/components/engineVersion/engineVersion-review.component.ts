...
import { IEngineVersionChangeRequestReview }                               from "./engineVersion.model";
...
@Component({
    ...
    providers: [EngineVersionService, LikeStagingService, UserService, ChangeService],
})

export class EngineVersionReviewComponent implements OnInit {

    usersForAssignment: IUser[] = [];
    assignedReviewer: IAssignReviewer = { assignedToUserId: "-1", changeRequestIds: [] };
    engineVersionChangeRequest: IEngineVersionChangeRequestReview;
    ...
    constructor(private engineVersionService: EngineVersionService, private likeStagingService: LikeStagingService,
    ...
    ngOnInit() {
        ...
        this.engineVersionService.getChangeRequestStaging(id).subscribe(
            result => {
                this.engineVersionChangeRequest = result;

                // set review's changerequestid
                this.changeRequestReview.changeRequestId = this.engineVersionChangeRequest.stagingItem.changeRequestId;
                //this.getLikes(id);
                ...
                if (this.engineVersionChangeRequest.stagingItem.status === "Approved" || this.engineVersionChangeRequest.stagingItem.status === "Deleted" || this.engineVersionChangeRequest.stagingItem.status === "Rejected") {
                    this.reviewCompleted = true;
                } else if (this.engineVersionChangeRequest.stagingItem.status === "PreliminaryApproved") {
    ...
    onSubmitReview(deletebuttonclicked: String) {
        ...
        this.newAcFileUploader.uploadAttachments().subscribe(uploadedFiles => {
            ...
            this.engineVersionService.submitChangeRequestReview(this.engineVersionChangeRequest.stagingItem.changeRequestId, this.changeRequestReview).subscribe(
                result => {
                    if (result) {
                        ...
                        if (this.changeRequestReview.reviewStatus != ChangeRequestStatus.Deleted) {
                            toasterMessage = {
                                ...
                                body: `Your review for ${this.engineVersionChangeRequest.stagingItem.changeType} ${this.engineVersionChangeRequest.stagingItem.entityName} : ${this.engineVersionChangeRequest.entityStaging.engineVersionName} change request ID ${this.engineVersionChangeRequest.stagingItem.changeRequestId} was submitted successfully.`
                            };
                        } else {
                            toasterMessage = {
                                title: ConstantsWarehouse.reviewDeleteSuccessTitle,
                                body: `Your delete request for ${this.engineVersionChangeRequest.stagingItem.changeType} ${this.engineVersionChangeRequest.stagingItem.entityName} : ${this.engineVersionChangeRequest.entityStaging.engineVersionName}  change request ID ${this.engineVersionChangeRequest.stagingItem.changeRequestId} was submitted successfully.`
                            };
                        }
                        ...
                        if (this.changeRequestReview.reviewStatus != ChangeRequestStatus.Deleted) {
                            toasterMessage = {
                                ...
                                body: `Your review for ${this.engineVersionChangeRequest.stagingItem.changeType} ${this.engineVersionChangeRequest.stagingItem.entityName} : ${this.engineVersionChangeRequest.entityStaging.engineVersionName}  change request ID ${this.engineVersionChangeRequest.stagingItem.changeRequestId} failed.`
                            };
                        } else {
                            toasterMessage = {
                                title: ConstantsWarehouse.reviewDeleteErrorTitle,
                                body: `Your delete request for ${this.engineVersionChangeRequest.stagingItem.changeType} ${this.engineVersionChangeRequest.stagingItem.entityName} : ${this.engineVersionChangeRequest.entityStaging.engineVersionName}  change request ID ${this.engineVersionChangeRequest.stagingItem.changeRequestId} failed.`
                            };
                        }
        ...
        this.changeService.assignReviewer(this.assignedReviewer).subscribe(result => {
            if (result) {
                let toasterMessage = {
                    ...
                    body: `Your review for ${this.engineVersionChangeRequest.stagingItem.changeType} ${this.engineVersionChangeRequest.stagingItem.entityName} : ${this.engineVersionChangeRequest.entityStaging.engineVersionName} assigned successfully.`
                }
                this.toastr.success(toasterMessage.body, toasterMessage.title);
                ...
                let toasterMessage = {
                    ...
                    body: `Your assignment for ${this.engineVersionChangeRequest.stagingItem.changeType} ${this.engineVersionChangeRequest.stagingItem.entityName} : ${this.engineVersionChangeRequest.entityStaging.engineVersionName} failed.`
                }
                this.toastr.warning(toasterMessage.body, toasterMessage.title);
            }
        },
