...
import { IEngineVinChangeRequestReview }                               from "./engineVin.model";
...
@Component({
    ...
    providers: [EngineVinService, LikeStagingService, UserService, ChangeService],
})

export class EngineVinReviewComponent implements OnInit {

    usersForAssignment: IUser[] = [];
    assignedReviewer: IAssignReviewer = { assignedToUserId: "-1", changeRequestIds: [] };
    engineVinChangeRequest: IEngineVinChangeRequestReview;
    ...
    constructor(private engineVinService: EngineVinService, private likeStagingService: LikeStagingService,
    ...
    ngOnInit() {
        ...
        this.engineVinService.getChangeRequestStaging(id).subscribe(
            result => {
                this.engineVinChangeRequest = result;

                // set review's changerequestid
                this.changeRequestReview.changeRequestId = this.engineVinChangeRequest.stagingItem.changeRequestId;
                //this.getLikes(id);
                ...
                if (this.engineVinChangeRequest.stagingItem.status === "Approved" || this.engineVinChangeRequest.stagingItem.status === "Deleted" || this.engineVinChangeRequest.stagingItem.status === "Rejected") {
                    this.reviewCompleted = true;
                } else if (this.engineVinChangeRequest.stagingItem.status === "PreliminaryApproved") {
    ...
    onSubmitReview(deletebuttonclicked: String) {
        ...
        this.newAcFileUploader.uploadAttachments().subscribe(uploadedFiles => {
            ...
            this.engineVinService.submitChangeRequestReview(this.engineVinChangeRequest.stagingItem.changeRequestId, this.changeRequestReview).subscribe(
                result => {
                    if (result) {
                        ...
                        if (this.changeRequestReview.reviewStatus != ChangeRequestStatus.Deleted) {
                            toasterMessage = {
                                ...
                                body: `Your review for ${this.engineVinChangeRequest.stagingItem.changeType} ${this.engineVinChangeRequest.stagingItem.entityName} : ${this.engineVinChangeRequest.entityStaging.engineVinName} change request ID ${this.engineVinChangeRequest.stagingItem.changeRequestId} was submitted successfully.`
                            };
                        } else {
                            toasterMessage = {
                                title: ConstantsWarehouse.reviewDeleteSuccessTitle,
                                body: `Your delete request for ${this.engineVinChangeRequest.stagingItem.changeType} ${this.engineVinChangeRequest.stagingItem.entityName} : ${this.engineVinChangeRequest.entityStaging.engineVinName}  change request ID ${this.engineVinChangeRequest.stagingItem.changeRequestId} was submitted successfully.`
                            };
                        }
                        ...
                        if (this.changeRequestReview.reviewStatus != ChangeRequestStatus.Deleted) {
                            toasterMessage = {
                                ...
                                body: `Your review for ${this.engineVinChangeRequest.stagingItem.changeType} ${this.engineVinChangeRequest.stagingItem.entityName} : ${this.engineVinChangeRequest.entityStaging.engineVinName}  change request ID ${this.engineVinChangeRequest.stagingItem.changeRequestId} failed.`
                            };
                        } else {
                            toasterMessage = {
                                title: ConstantsWarehouse.reviewDeleteErrorTitle,
                                body: `Your delete request for ${this.engineVinChangeRequest.stagingItem.changeType} ${this.engineVinChangeRequest.stagingItem.entityName} : ${this.engineVinChangeRequest.entityStaging.engineVinName}  change request ID ${this.engineVinChangeRequest.stagingItem.changeRequestId} failed.`
                            };
                        }
        ...
        this.changeService.assignReviewer(this.assignedReviewer).subscribe(result => {
            if (result) {
                let toasterMessage = {
                    ...
                    body: `Your review for ${this.engineVinChangeRequest.stagingItem.changeType} ${this.engineVinChangeRequest.stagingItem.entityName} : ${this.engineVinChangeRequest.entityStaging.engineVinName} assigned successfully.`
                }
                this.toastr.success(toasterMessage.body, toasterMessage.title);
                ...
                let toasterMessage = {
                    ...
                    body: `Your assignment for ${this.engineVinChangeRequest.stagingItem.changeType} ${this.engineVinChangeRequest.stagingItem.entityName} : ${this.engineVinChangeRequest.entityStaging.engineVinName} failed.`
                }
                this.toastr.warning(toasterMessage.body, toasterMessage.title);
            }
        },
