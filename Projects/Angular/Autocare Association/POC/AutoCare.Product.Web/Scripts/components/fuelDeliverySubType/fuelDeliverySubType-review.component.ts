...
import { IFuelDeliverySubTypeChangeRequestStagingReview }                            from "./fuelDeliverySubType.model";
...
@Component({
    ...
    providers: [FuelDeliverySubTypeService, LikeStagingService, UserService, ChangeService],
})

export class FuelDeliverySubTypeReviewComponent implements OnInit {
    fuelDeliverySubTypeChangeRequest: IFuelDeliverySubTypeChangeRequestStagingReview;
    ...
    constructor(private fuelDeliverySubTypeService: FuelDeliverySubTypeService, private likeStagingService: LikeStagingService,
    ...
    ngOnInit() {
        ...
        this.fuelDeliverySubTypeService.getChangeRequestStaging(id).subscribe(
            result => {

                this.fuelDeliverySubTypeChangeRequest = result;

                // set review's changerequestid
                this.changeRequestReview.changeRequestId = this.fuelDeliverySubTypeChangeRequest.stagingItem.changeRequestId;
                ...
                if (this.fuelDeliverySubTypeChangeRequest.stagingItem.status == "PreliminaryApproved") {
    ...
    onSubmitReview(deletebuttonclicked: String) {
        ...
        if (deletebuttonclicked == 'delete') {
            ...
            if (this.isPreliminaryApproveChecked) {
                ...
                this.changeRequestReview.reviewStatus = ChangeRequestStatus[this.fuelDeliverySubTypeChangeRequest.stagingItem.status];
            }
        }
        ...
        this.newAcFileUploader.uploadAttachments().subscribe(uploadedFiles => {
            ...
            this.fuelDeliverySubTypeService.submitChangeRequestReview(this.fuelDeliverySubTypeChangeRequest.stagingItem.changeRequestId, this.changeRequestReview).subscribe(
                result => {
                    if (result) {
                        ...
                        if (this.changeRequestReview.reviewStatus != ChangeRequestStatus.Deleted) {
                            toasterMessage = {
                                ...
                                body: `Your review for ${this.fuelDeliverySubTypeChangeRequest.stagingItem.changeType} ${this.fuelDeliverySubTypeChangeRequest.stagingItem.entityName} : ${this.fuelDeliverySubTypeChangeRequest.entityStaging.name}  change request ID ${this.fuelDeliverySubTypeChangeRequest.stagingItem.changeRequestId} was submitted successfully.`
                            };
                        } else {
                            toasterMessage = {
                                title: ConstantsWarehouse.reviewDeleteSuccessTitle,
                                body: `Your delete request for ${this.fuelDeliverySubTypeChangeRequest.stagingItem.changeType} ${this.fuelDeliverySubTypeChangeRequest.stagingItem.entityName} : ${this.fuelDeliverySubTypeChangeRequest.entityStaging.name}  change request ID ${this.fuelDeliverySubTypeChangeRequest.stagingItem.changeRequestId} was submitted successfully.`
                            };
                        }
                        ...
                        if (this.changeRequestReview.reviewStatus != ChangeRequestStatus.Deleted) {
                            toasterMessage = {
                                ...
                                body: `Your review for ${this.fuelDeliverySubTypeChangeRequest.stagingItem.changeType} ${this.fuelDeliverySubTypeChangeRequest.stagingItem.entityName} : ${this.fuelDeliverySubTypeChangeRequest.entityStaging.name}  change request ID ${this.fuelDeliverySubTypeChangeRequest.stagingItem.changeRequestId} failed.`
                            };
                        } else {
                            toasterMessage = {
                                title: ConstantsWarehouse.reviewDeleteErrorTitle,
                                body: `Your delete request for ${this.fuelDeliverySubTypeChangeRequest.stagingItem.changeType} ${this.fuelDeliverySubTypeChangeRequest.stagingItem.entityName} : ${this.fuelDeliverySubTypeChangeRequest.entityStaging.name}  change request ID ${this.fuelDeliverySubTypeChangeRequest.stagingItem.changeRequestId} failed.`
                            };
                        }
        ...
        this.changeService.assignReviewer(this.assignedReviewer).subscribe(result => {
            if (result) {
                let toasterMessage = {
                    ...
                    body: `Your review for ${this.fuelDeliverySubTypeChangeRequest.stagingItem.changeType} ${this.fuelDeliverySubTypeChangeRequest.stagingItem.entityName} : ${this.fuelDeliverySubTypeChangeRequest.entityStaging.name} assigned successfully.`
                }
                this.toastr.success(toasterMessage.body, toasterMessage.title);
                ...
                let toasterMessage = {
                    ...
                    body: `Your assignment for ${this.fuelDeliverySubTypeChangeRequest.stagingItem.changeType} ${this.fuelDeliverySubTypeChangeRequest.stagingItem.entityName} : ${this.fuelDeliverySubTypeChangeRequest.entityStaging.name} failed.`
                }
                this.toastr.warning(toasterMessage.body, toasterMessage.title);
            }
        },
