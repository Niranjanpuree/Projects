...
import { IVehicleToMfrBodyCodeChangeRequestStagingReview }            from "./vehicleToMfrBodyCode.model";
...
@Component({
    selector: 'vehicleToMfrBodyCode-review-comp',
    templateUrl: 'app/templates/vehicleToMfrBodyCode/vehicleToMfrBodyCode-review.component.html',
    providers: [VehicleToMfrBodyCodeService, VehicleService, MfrBodyCodeService, LikeStagingService, ChangeService, UserService],
})

export class VehicleToMfrBodyCodeReviewComponent implements OnInit {
    disabled: boolean = false;
    vehicleToMfrBodyCodeChangeRequest: IVehicleToMfrBodyCodeChangeRequestStagingReview;
    ...
    constructor(private vehicleToMfrBodyCodeService: VehicleToMfrBodyCodeService, private likeStagingService: LikeStagingService,
        private toastr: ToastsManager, private route: ActivatedRoute, private router: Router, private vehicleService: VehicleService,
        private mfrBodyCodeService: MfrBodyCodeService, private sharedService: SharedService,
    ...
    ngOnInit() {
        ...
        this.vehicleToMfrBodyCodeService.getChangeRequestStaging(id).subscribe(
            result => {
                this.vehicleToMfrBodyCodeChangeRequest = result;
                
                if (this.vehicleToMfrBodyCodeChangeRequest.stagingItem.status == "PreliminaryApproved") {
                    this.showPrelimRadio = false;
                }
                // set review's changerequestid
                this.changeRequestReview.changeRequestId = this.vehicleToMfrBodyCodeChangeRequest.stagingItem.changeRequestId;

                //this.getLikes(id);
                this.likeStagingService.getLikeDetails(id).subscribe(result => {
                    this.likeStagingGet = result;

                    this.vehicleService.getVehicle(this.vehicleToMfrBodyCodeChangeRequest.entityStaging.vehicleId).subscribe(result => {
                        this.vehicleToMfrBodyCodeChangeRequest.entityStaging.vehicle = result;

                        this.mfrBodyCodeService.getMfrBodyCode(this.vehicleToMfrBodyCodeChangeRequest.entityStaging.mfrBodyCodeId).subscribe(result => {
                            this.vehicleToMfrBodyCodeChangeRequest.entityStaging.mfrBodyCode = result;
    ...
    onSubmitReview(deletebuttonclicked: String) {
        ...
        if (deletebuttonclicked == 'delete') {
            ...
            if (this.isPreliminaryApproveChecked) {
                ...
                this.changeRequestReview.reviewStatus = ChangeRequestStatus[this.vehicleToMfrBodyCodeChangeRequest.stagingItem.status];
            }
        }
        ...
        this.newAcFileUploader.uploadAttachments().subscribe(uploadedFiles => {
            ...
            this.vehicleToMfrBodyCodeService.submitChangeRequestReview(this.vehicleToMfrBodyCodeChangeRequest.stagingItem.changeRequestId, this.changeRequestReview).subscribe(
                result => {
                    if (result) {
                        ...
                        if (this.changeRequestReview.reviewStatus != ChangeRequestStatus.Deleted) {
                            toasterMessage = {
                                ...
                                body: `Your review for ${this.vehicleToMfrBodyCodeChangeRequest.stagingItem.changeType} ${this.vehicleToMfrBodyCodeChangeRequest.stagingItem.entityName} : ${this.vehicleToMfrBodyCodeChangeRequest.entityStaging.id} change request ID ${this.vehicleToMfrBodyCodeChangeRequest.stagingItem.changeRequestId} was submitted successfully.`
                            };
                        } else {
                            toasterMessage = {
                                title: ConstantsWarehouse.reviewDeleteSuccessTitle,
                                body: `Your delete request for ${this.vehicleToMfrBodyCodeChangeRequest.stagingItem.changeType} ${this.vehicleToMfrBodyCodeChangeRequest.stagingItem.entityName} : ${this.vehicleToMfrBodyCodeChangeRequest.entityStaging.id} change request ID ${this.vehicleToMfrBodyCodeChangeRequest.stagingItem.changeRequestId} was submitted successfully.`
                            };
                        }
                        ...
                        if (this.changeRequestReview.reviewStatus != ChangeRequestStatus.Deleted) {
                            toasterMessage = {
                                ...
                                body: `Your review for ${this.vehicleToMfrBodyCodeChangeRequest.stagingItem.changeType} ${this.vehicleToMfrBodyCodeChangeRequest.stagingItem.entityName} : ${this.vehicleToMfrBodyCodeChangeRequest.entityStaging.id} change request ID ${this.vehicleToMfrBodyCodeChangeRequest.stagingItem.changeRequestId} failed.`
                            };
                        } else {
                            toasterMessage = {
                                title: ConstantsWarehouse.reviewDeleteErrorTitle,
                                body: `Your delete request for ${this.vehicleToMfrBodyCodeChangeRequest.stagingItem.changeType} ${this.vehicleToMfrBodyCodeChangeRequest.stagingItem.entityName} : ${this.vehicleToMfrBodyCodeChangeRequest.entityStaging.id} change request ID ${this.vehicleToMfrBodyCodeChangeRequest.stagingItem.changeRequestId} failed.`
                            };
                        }
    ...
    private onAssignReviewer() {
        ...
        this.assignedReviewer.changeRequestIds[0] = this.vehicleToMfrBodyCodeChangeRequest.stagingItem.changeRequestId;
        this.changeService.assignReviewer(this.assignedReviewer).subscribe(result => {
            if (result) {
                let toasterMessage = {
                    title: `Your review was assigned to ${user.user}`,
                    body: `Your review for ${this.vehicleToMfrBodyCodeChangeRequest.stagingItem.changeType} ${this.vehicleToMfrBodyCodeChangeRequest.stagingItem.entityName} : ${this.vehicleToMfrBodyCodeChangeRequest.entityStaging.id} assigned successfully.`
                }
                this.toastr.success(toasterMessage.body, toasterMessage.title);
                ...
                let toasterMessage = {
                    ...
                    body: `Your assignment for ${this.vehicleToMfrBodyCodeChangeRequest.stagingItem.changeType} ${this.vehicleToMfrBodyCodeChangeRequest.stagingItem.entityName} : ${this.vehicleToMfrBodyCodeChangeRequest.entityStaging.id} failed.`
                }
                this.toastr.warning(toasterMessage.body, toasterMessage.title);
            }
        },
