...
import { IVehicleToWheelBaseChangeRequestStagingReview }            from "./vehicleToWheelBase.model";
...
@Component({
    ...
    providers: [VehicleToWheelBaseService, VehicleService, WheelBaseService, LikeStagingService, ChangeService, UserService],
})

export class VehicleToWheelBaseReviewComponent {
    disabled: boolean = false;
    vehicleToWheelBaseChangeRequest: IVehicleToWheelBaseChangeRequestStagingReview;
    ...
    constructor(private vehicleToWheelBaseService: VehicleToWheelBaseService, private likeStagingService: LikeStagingService,
        private toastr: ToastsManager, private route: ActivatedRoute, private router: Router, private vehicleService: VehicleService,
        private wheelBaseService: WheelBaseService, private sharedService: SharedService,
    ...
    ngOnInit() {
        ...
        this.vehicleToWheelBaseService.getChangeRequestStaging(id).subscribe(
            result => {
                     this.vehicleToWheelBaseChangeRequest = result;
                
                // check if Preliminary Approved.
                if (this.vehicleToWheelBaseChangeRequest.stagingItem.status == "PreliminaryApproved") {
                    this.showPrelimRadio = false;
                }

                // set review's changerequestid
                this.changeRequestReview.changeRequestId = this.vehicleToWheelBaseChangeRequest.stagingItem.changeRequestId;

                //this.getLikes(id);
                this.likeStagingService.getLikeDetails(id).subscribe(result => {
                    this.likeStagingGet = result;

                    this.vehicleService.getVehicle(this.vehicleToWheelBaseChangeRequest.entityStaging.vehicleId).subscribe(result => {
                        this.vehicleToWheelBaseChangeRequest.entityStaging.vehicle = result;

                        this.wheelBaseService.getWheelBasebyid(this.vehicleToWheelBaseChangeRequest.entityStaging.wheelBaseId).subscribe(result => {
                           this.vehicleToWheelBaseChangeRequest.entityStaging.wheelBase = result;
    ...
    onSubmitReview(deletebuttonclicked: String) {
        ...
        if (deletebuttonclicked == 'delete') {
            ...
            if (this.isPreliminaryApproveChecked) {
                ...
                this.changeRequestReview.reviewStatus = ChangeRequestStatus[this.vehicleToWheelBaseChangeRequest.stagingItem.status];
            }
        }
        ...
        this.newAcFileUploader.uploadAttachments().subscribe(uploadedFiles => {
            ...
            this.vehicleToWheelBaseService.submitChangeRequestReview(this.vehicleToWheelBaseChangeRequest.stagingItem.changeRequestId, this.changeRequestReview).subscribe(
                result => {
                    if (result) {
                        ...
                        if (this.changeRequestReview.reviewStatus != ChangeRequestStatus.Deleted) {
                            toasterMessage = {
                                ...
                                body: `Your review for ${this.vehicleToWheelBaseChangeRequest.stagingItem.changeType} ${this.vehicleToWheelBaseChangeRequest.stagingItem.entityName} : ${this.vehicleToWheelBaseChangeRequest.entityStaging.id} change request ID ${this.vehicleToWheelBaseChangeRequest.stagingItem.changeRequestId} was submitted successfully.`
                            };
                        } else {
                            toasterMessage = {
                                title: ConstantsWarehouse.reviewDeleteSuccessTitle,
                                body: `Your delete request for ${this.vehicleToWheelBaseChangeRequest.stagingItem.changeType} ${this.vehicleToWheelBaseChangeRequest.stagingItem.entityName} : ${this.vehicleToWheelBaseChangeRequest.entityStaging.id} change request ID ${this.vehicleToWheelBaseChangeRequest.stagingItem.changeRequestId} was submitted successfully.`
                            };
                        }
                        ...
                        if (this.changeRequestReview.reviewStatus != ChangeRequestStatus.Deleted) {
                            toasterMessage = {
                                ...
                                body: `Your review for ${this.vehicleToWheelBaseChangeRequest.stagingItem.changeType} ${this.vehicleToWheelBaseChangeRequest.stagingItem.entityName} : ${this.vehicleToWheelBaseChangeRequest.entityStaging.id} change request ID ${this.vehicleToWheelBaseChangeRequest.stagingItem.changeRequestId} failed.`
                            };
                        } else {
                            toasterMessage = {
                                title: ConstantsWarehouse.reviewDeleteErrorTitle,
                                body: `Your delete request for ${this.vehicleToWheelBaseChangeRequest.stagingItem.changeType} ${this.vehicleToWheelBaseChangeRequest.stagingItem.entityName} : ${this.vehicleToWheelBaseChangeRequest.entityStaging.id} change request ID ${this.vehicleToWheelBaseChangeRequest.stagingItem.changeRequestId} failed.`
                            };
                        }
        ...
        this.changeService.assignReviewer(this.assignedReviewer).subscribe(result => {
            if (result) {
                let toasterMessage = {
                    ...
                    body: `Your review for ${this.vehicleToWheelBaseChangeRequest.stagingItem.changeType} ${this.vehicleToWheelBaseChangeRequest.stagingItem.entityName} : ${this.vehicleToWheelBaseChangeRequest.entityStaging.id} assigned successfully.`
                }
                this.toastr.success(toasterMessage.body, toasterMessage.title);
                ...
                let toasterMessage = {
                    ...
                    body: `Your assignment for ${this.vehicleToWheelBaseChangeRequest.stagingItem.changeType} ${this.vehicleToWheelBaseChangeRequest.stagingItem.entityName} : ${this.vehicleToWheelBaseChangeRequest.entityStaging.id} failed.`
                }
                this.toastr.warning(toasterMessage.body, toasterMessage.title);
            }
        },
