...
import { IVehicleTypeChangeRequestStagingReview }          from './vehicleType.model';
...
@Component({
    ...
    providers: [VehicleTypeService, VehicleTypeGroupService, LikeStagingService, UserService, ChangeService],
})

export class VehicleTypeReviewComponent implements OnInit {
    vehicleTypeChangeRequest: IVehicleTypeChangeRequestStagingReview;
    numberOfVehiclesAffected: Number = 0;
    ...
    constructor(private vehicleTypeService: VehicleTypeService, private likeStagingService: LikeStagingService,
        private toastr: ToastsManager, private route: ActivatedRoute, private vehicleTypeGroupService: VehicleTypeGroupService, private router: Router,
    ...
    ngOnInit() {
        ...
        this.vehicleTypeService.getChangeRequestStaging(id).subscribe(
            result => {
                this.vehicleTypeChangeRequest = result;
                var vId = this.vehicleTypeChangeRequest.entityStaging.vehicleTypeGroupId;
                // set review's changerequestid
                this.changeRequestReview.changeRequestId = this.vehicleTypeChangeRequest.stagingItem.changeRequestId;
                this.likeStagingService.getLikeDetails(id).subscribe(result => {
                    ...
                    if (vId > 0) {
                        this.showLoadingGif = true;
                        this.vehicleTypeGroupService.getVehicleTypeGroupDetail(vId).subscribe(data => {
                            this.vehicleTypeChangeRequest.entityStaging.vehicleTypeGroupName = data.name;
                ...
                if (this.vehicleTypeChangeRequest.stagingItem.status == "PreliminaryApproved") {
                    this.showPrelimRadio = false;
                }
    ...
    onSubmitReview(deletebuttonclicked: String) {
        ...
        if (deletebuttonclicked == 'delete') {
            ...
            if (this.isPreliminaryApproveChecked) {
                ...
                this.changeRequestReview.reviewStatus = ChangeRequestStatus[this.vehicleTypeChangeRequest.stagingItem.status];
            }
        }
        ...
        this.newAcFileUploader.uploadAttachments().subscribe(uploadedFiles => {
            ...
            this.vehicleTypeService.submitChangeRequestReview(this.vehicleTypeChangeRequest.stagingItem.changeRequestId, this.changeRequestReview).subscribe(
                result => {
                    if (result) {
                        ...
                        if (this.changeRequestReview.reviewStatus != ChangeRequestStatus.Deleted) {
                            toasterMessage = {
                                ...
                                body: `Your review for ${this.vehicleTypeChangeRequest.stagingItem.changeType} ${this.vehicleTypeChangeRequest.stagingItem.entityName} : ${this.vehicleTypeChangeRequest.entityStaging.name} change request ID ${this.vehicleTypeChangeRequest.stagingItem.changeRequestId} was submitted successfully.`
                            };
                        } else {
                            toasterMessage = {
                                title: ConstantsWarehouse.reviewDeleteSuccessTitle,
                                body: `Your delete request for ${this.vehicleTypeChangeRequest.stagingItem.changeType} ${this.vehicleTypeChangeRequest.stagingItem.entityName} : ${this.vehicleTypeChangeRequest.entityStaging.name} change request ID ${this.vehicleTypeChangeRequest.stagingItem.changeRequestId} was submitted successfully.`
                            };
                        }
                        ...
                        if (this.changeRequestReview.reviewStatus != ChangeRequestStatus.Deleted) {
                            toasterMessage = {
                                ...
                                body: `Your review for ${this.vehicleTypeChangeRequest.stagingItem.changeType} ${this.vehicleTypeChangeRequest.stagingItem.entityName} : ${this.vehicleTypeChangeRequest.entityStaging.name} change request ID ${this.vehicleTypeChangeRequest.stagingItem.changeRequestId} failed.`
                            };
                        } else {
                            toasterMessage = {
                                title: ConstantsWarehouse.reviewDeleteErrorTitle,
                                body: `Your delete request for ${this.vehicleTypeChangeRequest.stagingItem.changeType} ${this.vehicleTypeChangeRequest.stagingItem.entityName} : ${this.vehicleTypeChangeRequest.entityStaging.name} change request ID ${this.vehicleTypeChangeRequest.stagingItem.changeRequestId} failed.`
                            };
                        }
        ...
        this.changeService.assignReviewer(this.assignedReviewer).subscribe(result => {
            if (result) {
                let toasterMessage = {
                    ...
                    body: `Your review for ${this.vehicleTypeChangeRequest.stagingItem.changeType} ${this.vehicleTypeChangeRequest.stagingItem.entityName} : ${this.vehicleTypeChangeRequest.entityStaging.name} assigned successfully.`
                }
                this.toastr.success(toasterMessage.body, toasterMessage.title);
                ...
                let toasterMessage = {
                    ...
                    body: `Your assignment for ${this.vehicleTypeChangeRequest.stagingItem.changeType} ${this.vehicleTypeChangeRequest.stagingItem.entityName} : ${this.vehicleTypeChangeRequest.entityStaging.name} failed.`
                }
                this.toastr.warning(toasterMessage.body, toasterMessage.title);
            }
        },
