...
@Component({
    ...
    providers: [VehicleTypeGroupService, LikeStagingService, UserService, ChangeService],
})

export class VehicleTypeGroupReviewComponent implements OnInit {
    vehicleTypegroupChangeRequest: IVehicleTypeGroupChangeRequestStagingReview;
    ...
    constructor(private vehicleTypeGroupService: VehicleTypeGroupService, private likeStagingService: LikeStagingService,
    ...
    ngOnInit() {
        ...
        this.vehicleTypeGroupService.getChangeRequestStaging(id).subscribe(
            result => {
                this.vehicleTypegroupChangeRequest = result;

                // set review's changerequestid
                this.changeRequestReview.changeRequestId = this.vehicleTypegroupChangeRequest.stagingItem.changeRequestId;
                ...
                if (this.vehicleTypegroupChangeRequest.stagingItem.status == "PreliminaryApproved") {
                    this.showPrelimRadio = false;
                }
            },
            error => {
    ...
    onSubmitReview(deletebuttonclicked: String) {
        ...
        if (deletebuttonclicked == 'delete') {
            ...
            if (this.isPreliminaryApproveChecked) {
                ...
                this.changeRequestReview.reviewStatus = ChangeRequestStatus[this.vehicleTypegroupChangeRequest.stagingItem.status];
            }
        }
        ...
        this.newAcFileUploader.uploadAttachments().subscribe(uploadedFiles => {
            ...
            this.vehicleTypeGroupService.submitChangeRequestReview(this.vehicleTypegroupChangeRequest.stagingItem.changeRequestId, this.changeRequestReview).subscribe(
                result => {
                    if (result) {
                        ...
                        if (this.changeRequestReview.reviewStatus != ChangeRequestStatus.Deleted) {
                            toasterMessage = {
                                ...
                                body: `Your review for ${this.vehicleTypegroupChangeRequest.stagingItem.changeType} ${this.vehicleTypegroupChangeRequest.stagingItem.entityName} : ${this.vehicleTypegroupChangeRequest.entityStaging.name} change request ID ${this.vehicleTypegroupChangeRequest.stagingItem.changeRequestId} was submitted successfully.`
                            };
                        } else {
                            toasterMessage = {
                                title: ConstantsWarehouse.reviewDeleteSuccessTitle,
                                body: `Your delete request for ${this.vehicleTypegroupChangeRequest.stagingItem.changeType} ${this.vehicleTypegroupChangeRequest.stagingItem.entityName} : ${this.vehicleTypegroupChangeRequest.entityStaging.name} change request ID ${this.vehicleTypegroupChangeRequest.stagingItem.changeRequestId} was submitted successfully.`
                            };
                        }
                        ...
                        if (this.changeRequestReview.reviewStatus != ChangeRequestStatus.Deleted) {
                            toasterMessage = {
                                ...
                                body: `Your review for ${this.vehicleTypegroupChangeRequest.stagingItem.changeType} ${this.vehicleTypegroupChangeRequest.stagingItem.entityName} : ${this.vehicleTypegroupChangeRequest.entityStaging.name} change request ID ${this.vehicleTypegroupChangeRequest.stagingItem.changeRequestId} failed.`
                            };
                        } else {
                            toasterMessage = {
                                title: ConstantsWarehouse.reviewDeleteErrorTitle,
                                body: `Your delete request for ${this.vehicleTypegroupChangeRequest.stagingItem.changeType} ${this.vehicleTypegroupChangeRequest.stagingItem.entityName} : ${this.vehicleTypegroupChangeRequest.entityStaging.name} change request ID ${this.vehicleTypegroupChangeRequest.stagingItem.changeRequestId} failed.`
                            };
                        }
                ...
                error => {
                    ...
                    if (this.changeRequestReview.reviewStatus != ChangeRequestStatus.Deleted) {
                        ...
                        toasterMessage = {
                            title: ConstantsWarehouse.reviewSubmitErrorTitle,
                            body: `Your delete request for ${this.vehicleTypegroupChangeRequest.stagingItem.changeType} ${this.vehicleTypegroupChangeRequest.stagingItem.entityName} : ${this.vehicleTypegroupChangeRequest.entityStaging.name} failed.\n${<any>error.toString()}.`
                        };
                    }
                    this.toastr.warning(toasterMessage.body, toasterMessage.title);
        ...
        this.changeService.assignReviewer(this.assignedReviewer).subscribe(result => {
            if (result) {
                let toasterMessage = {
                    ...
                    body: `Your review for ${this.vehicleTypegroupChangeRequest.stagingItem.changeType} ${this.vehicleTypegroupChangeRequest.stagingItem.entityName} : ${this.vehicleTypegroupChangeRequest.entityStaging.name} assigned successfully.`
                }
                this.toastr.success(toasterMessage.body, toasterMessage.title);
                ...
                let toasterMessage = {
                    ...
                    body: `Your assignment for ${this.vehicleTypegroupChangeRequest.stagingItem.changeType} ${this.vehicleTypegroupChangeRequest.stagingItem.entityName} : ${this.vehicleTypegroupChangeRequest.entityStaging.name} failed.`
                }
                this.toastr.warning(toasterMessage.body, toasterMessage.title);
            }
        },
