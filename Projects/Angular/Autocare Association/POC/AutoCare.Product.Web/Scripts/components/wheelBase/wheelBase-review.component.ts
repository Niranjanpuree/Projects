...
@Component({
    ...
    providers: [WheelBaseService, LikeStagingService, UserService, ChangeService],
})

export class WheelBaseReviewComponent implements OnInit {
    wheelBaseChangeRequest: IWheelBaseChangeRequestStagingReview;
    ...
    constructor(private wheelBaseService: WheelBaseService, private likeStagingService: LikeStagingService, private toastr: ToastsManager,
    ...
    ngOnInit() {
        ...
        this.wheelBaseService.getChangeRequestStaging(id).subscribe(
            result => {
                this.wheelBaseChangeRequest = result;
                // set review's changerequestid
                this.changeRequestReview.changeRequestId = this.wheelBaseChangeRequest.stagingItem.changeRequestId;
                ...
                if (this.wheelBaseChangeRequest.stagingItem.status === "PreliminaryApproved") {
    ...
    onSubmitReview(deletebuttonclicked: String) {
        ...
        this.newAcFileUploader.uploadAttachments().subscribe(uploadedFiles => {
            ...
            this.wheelBaseService.submitChangeRequestReview(this.wheelBaseChangeRequest.stagingItem.changeRequestId, this.changeRequestReview).subscribe(
                result => {
                    if (result) {
                        ...
                        if (this.changeRequestReview.reviewStatus != ChangeRequestStatus.Deleted) {
                            toasterMessage = {
                                ...
                                body: `Your review for ${this.wheelBaseChangeRequest.stagingItem.changeType} ${this.wheelBaseChangeRequest.stagingItem.entityName} : ${this.wheelBaseChangeRequest.entityStaging.base} change request ID '${this.wheelBaseChangeRequest.stagingItem.changeRequestId}' was submitted successfully.`
                            };
                        } else {
                            toasterMessage = {
                                title: ConstantsWarehouse.reviewDeleteSuccessTitle,
                                body: `Your delete request for ${this.wheelBaseChangeRequest.stagingItem.changeType} ${this.wheelBaseChangeRequest.stagingItem.entityName} : ${this.wheelBaseChangeRequest.entityStaging.base} change request ID '${this.wheelBaseChangeRequest.stagingItem.changeRequestId}' was submitted successfully.`
                            };
                        }
                        ...
                        if (this.changeRequestReview.reviewStatus != ChangeRequestStatus.Deleted) {
                            toasterMessage = {
                                ...
                                body: `Your review for ${this.wheelBaseChangeRequest.stagingItem.changeType} ${this.wheelBaseChangeRequest.stagingItem.entityName} : ${this.wheelBaseChangeRequest.entityStaging.base} change request ID '${this.wheelBaseChangeRequest.stagingItem.changeRequestId}' failed.`
                            };
                        } else {
                            toasterMessage = {
                                title: ConstantsWarehouse.reviewDeleteErrorTitle,
                                body: `Your delete request for ${this.wheelBaseChangeRequest.stagingItem.changeType} ${this.wheelBaseChangeRequest.stagingItem.entityName} : ${this.wheelBaseChangeRequest.entityStaging.base} change request ID '${this.wheelBaseChangeRequest.stagingItem.changeRequestId}' failed.`
                            };
                        }
                ...
                error => {
                    ...
                    if (this.changeRequestReview.reviewStatus != ChangeRequestStatus.Deleted) {
                        toasterMessage = {
                            title: ConstantsWarehouse.reviewSubmitErrorTitle,
                            body: `Your review for ${this.wheelBaseChangeRequest.stagingItem.changeType} ${this.wheelBaseChangeRequest.stagingItem.entityName} : ${this.wheelBaseChangeRequest.entityStaging.base} failed.\n${<any>error.toString()}.`
                        };
                    } else {
                        toasterMessage = {
                            title: ConstantsWarehouse.reviewSubmitErrorTitle,
                            body: `Your delete request for ${this.wheelBaseChangeRequest.stagingItem.changeType} ${this.wheelBaseChangeRequest.stagingItem.entityName} : ${this.wheelBaseChangeRequest.entityStaging.base} failed.\n${<any>error.toString()}.`
                        };
                    }
                    this.toastr.warning(toasterMessage.body, toasterMessage.title);
        ...
        this.changeService.assignReviewer(this.assignedReviewer).subscribe(result => {
            if (result) {
                let toasterMessage = {
                    ...
                    body: `Your review for ${this.wheelBaseChangeRequest.stagingItem.changeType} ${this.wheelBaseChangeRequest.stagingItem.entityName} : ${this.wheelBaseChangeRequest.entityStaging.base} assigned successfully.`
                }
                this.toastr.success(toasterMessage.body, toasterMessage.title);
                ...
                let toasterMessage = {
                    ...
                    body: `Your assignment for ${this.wheelBaseChangeRequest.stagingItem.changeType} ${this.wheelBaseChangeRequest.stagingItem.entityName} : ${this.wheelBaseChangeRequest.entityStaging.base} failed.`
                }
                this.toastr.warning(toasterMessage.body, toasterMessage.title);
            }
        },
