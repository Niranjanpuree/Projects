...
import { IYearChangeRequestStagingReview }                            from "./year.model";
...
@Component({
    ...
    providers: [YearService, LikeStagingService, UserService, ChangeService],
})
...
export class YearReviewComponent implements OnInit {
    ...
    yearChangeRequest: IYearChangeRequestStagingReview;
    ...
    constructor(private yearService: YearService, private likeStagingService: LikeStagingService, private toastr: ToastsManager,
    ...
    ngOnInit() {
        ...
        this.yearService.getChangeRequestStaging(id).subscribe(
            result => {
                this.yearChangeRequest = result;

                // set review's changerequestid
                this.changeRequestReview.changeRequestId = this.yearChangeRequest.stagingItem.changeRequestId;
                ...
                if (this.yearChangeRequest.stagingItem.status == "PreliminaryApproved") {
                    this.showPrelimRadio = false;
                }
    ...
    onSubmitReview(deletebuttonclicked: String) {
        ...
        if (deletebuttonclicked == 'delete') {
            ...
            if (this.isPreliminaryApproveChecked) {
                ...
                this.changeRequestReview.reviewStatus = ChangeRequestStatus[this.yearChangeRequest.stagingItem.status];
            }
        }
        ...
        this.newAcFileUploader.uploadAttachments().subscribe(uploadedFiles => {
            ...
            this.yearService.submitChangeRequestReview(this.yearChangeRequest.stagingItem.changeRequestId, this.changeRequestReview).subscribe(
                result => {
                    if (result) {
                        ...
                        if (this.changeRequestReview.reviewStatus != ChangeRequestStatus.Deleted) {
                            toasterMessage = {
                                ...
                                body: `Your review for ${this.yearChangeRequest.stagingItem.changeType} ${this.yearChangeRequest.stagingItem.entityName} : ${this.yearChangeRequest.entityStaging.id} change request ID ${this.yearChangeRequest.stagingItem.changeRequestId} was submitted successfully.`
                            };
                        } else {
                            toasterMessage = {
                                title: ConstantsWarehouse.reviewDeleteSuccessTitle,
                                body: `Your delete request for ${this.yearChangeRequest.stagingItem.changeType} ${this.yearChangeRequest.stagingItem.entityName} : ${this.yearChangeRequest.entityStaging.id} change request ID ${this.yearChangeRequest.stagingItem.changeRequestId} was submitted successfully.`
                            };
                        }
                        ...
                        if (this.changeRequestReview.reviewStatus != ChangeRequestStatus.Deleted) {
                            toasterMessage = {
                                ...
                                body: `Your review for ${this.yearChangeRequest.stagingItem.changeType} ${this.yearChangeRequest.stagingItem.entityName} : ${this.yearChangeRequest.entityStaging.id} change request ID ${this.yearChangeRequest.stagingItem.changeRequestId} failed.`
                            };
                        } else {
                            toasterMessage = {
                                title: ConstantsWarehouse.reviewDeleteErrorTitle,
                                body: `Your delete request for ${this.yearChangeRequest.stagingItem.changeType} ${this.yearChangeRequest.stagingItem.entityName} : ${this.yearChangeRequest.entityStaging.id} change request ID ${this.yearChangeRequest.stagingItem.changeRequestId} failed.`
                            };
                        }
        ...
        this.changeService.assignReviewer(this.assignedReviewer).subscribe(result => {
            if (result) {
                let toasterMessage = {
                    ...
                    body: `Your review for ${this.yearChangeRequest.stagingItem.changeType} ${this.yearChangeRequest.stagingItem.entityName} : ${this.yearChangeRequest.entityStaging.id} assigned successfully.`
                }
                this.toastr.success(toasterMessage.body, toasterMessage.title);
                ...
                let toasterMessage = {
                    ...
                    body: `Your assignment for ${this.yearChangeRequest.stagingItem.changeType} ${this.yearChangeRequest.stagingItem.entityName} : ${this.yearChangeRequest.entityStaging.id} failed.`
                }
                this.toastr.warning(toasterMessage.body, toasterMessage.title);
            }
        },
