...
var MfrBodyCodeReviewComponent = (function () {
    function MfrBodyCodeReviewComponent(mfrBodyCodeService, likeStagingService, toastr, route, router, sharedService, userService, changeService, navgationService) {
    ...
    MfrBodyCodeReviewComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.showLoadingGif = true;
        // Load existing base vechile with reference from RouteParams
        var id = Number(this.route.snapshot.params["id"]);
        this.mfrBodyCodeService.getChangeRequestStaging(id).subscribe(function (result) {
            _this.mfrBodyCodeChangeRequest = result;
            // set review's changerequestid
            _this.changeRequestReview.changeRequestId = _this.mfrBodyCodeChangeRequest.stagingItem.changeRequestId;
            // get like
            // this.getLikes(id);
            ...
            if (_this.mfrBodyCodeChangeRequest.stagingItem.status == "PreliminaryApproved") {
    ...
    MfrBodyCodeReviewComponent.prototype.onReviewerChange = function () {
        if (this.assignedReviewer.assignedToUserId !== "-1" && !this.isPreliminaryApproveChecked) {
            this.isApproveChecked = false;
            this.isRejectChecked = false;
        }
    };
    MfrBodyCodeReviewComponent.prototype.onChange = function (approved) {
    ...
    MfrBodyCodeReviewComponent.prototype.onSubmitReview = function (deletebuttonclicked) {
        var _this = this;
        ...
        if (deletebuttonclicked == 'delete') {
            ...
            if (this.isPreliminaryApproveChecked) {
                ...
                this.changeRequestReview.reviewStatus = changeRequestReview_model_1.ChangeRequestStatus[this.mfrBodyCodeChangeRequest.stagingItem.status];
            }
        }
        ...
        this.newAcFileUploader.uploadAttachments().subscribe(function (uploadedFiles) {
            ...
            _this.mfrBodyCodeService.submitChangeRequestReview(_this.mfrBodyCodeChangeRequest.stagingItem.changeRequestId, _this.changeRequestReview).subscribe(function (result) {
                if (result) {
                    ...
                    if (_this.changeRequestReview.reviewStatus != changeRequestReview_model_1.ChangeRequestStatus.Deleted) {
                        toasterMessage = {
                            ...
                            body: "Your review for " + _this.mfrBodyCodeChangeRequest.stagingItem.changeType + " " + _this.mfrBodyCodeChangeRequest.stagingItem.entityName + " : " + _this.mfrBodyCodeChangeRequest.entityStaging.name + "  change request ID " + _this.mfrBodyCodeChangeRequest.stagingItem.changeRequestId + " was submitted successfully."
                        };
                    }
                    else {
                        toasterMessage = {
                            title: constants_warehouse_1.ConstantsWarehouse.reviewDeleteSuccessTitle,
                            body: "Your delete request for " + _this.mfrBodyCodeChangeRequest.stagingItem.changeType + " " + _this.mfrBodyCodeChangeRequest.stagingItem.entityName + " : " + _this.mfrBodyCodeChangeRequest.entityStaging.name + "  change request ID " + _this.mfrBodyCodeChangeRequest.stagingItem.changeRequestId + " was submitted successfully."
                        };
                    }
                    _this.toastr.success(toasterMessage.body, toasterMessage.title);
                    ...
                    if (_this.changeRequestReview.reviewStatus != changeRequestReview_model_1.ChangeRequestStatus.Deleted) {
                        toasterMessage = {
                            ...
                            body: "Your review for " + _this.mfrBodyCodeChangeRequest.stagingItem.changeType + " " + _this.mfrBodyCodeChangeRequest.stagingItem.entityName + " : " + _this.mfrBodyCodeChangeRequest.entityStaging.name + "  change request ID " + _this.mfrBodyCodeChangeRequest.stagingItem.changeRequestId + " failed."
                        };
                    }
                    else {
                        toasterMessage = {
                            title: constants_warehouse_1.ConstantsWarehouse.reviewDeleteErrorTitle,
                            body: "Your delete request for " + _this.mfrBodyCodeChangeRequest.stagingItem.changeType + " " + _this.mfrBodyCodeChangeRequest.stagingItem.entityName + " : " + _this.mfrBodyCodeChangeRequest.entityStaging.name + "  change request ID " + _this.mfrBodyCodeChangeRequest.stagingItem.changeRequestId + " failed."
                        };
                    }
    ...
    MfrBodyCodeReviewComponent.prototype.onAssignReviewer = function () {
        var _this = this;
        ...
        this.assignedReviewer.changeRequestIds[0] = this.mfrBodyCodeChangeRequest.stagingItem.changeRequestId;
        this.changeService.assignReviewer(this.assignedReviewer).subscribe(function (result) {
            if (result) {
                var toasterMessage = {
                    ...
                    body: "Your review for " + _this.mfrBodyCodeChangeRequest.stagingItem.changeType + " " + _this.mfrBodyCodeChangeRequest.stagingItem.entityName + " : " + _this.mfrBodyCodeChangeRequest.entityStaging.name + " assigned successfully."
                };
                _this.toastr.success(toasterMessage.body, toasterMessage.title);
                ...
                var toasterMessage = {
                    ...
                    body: "Your assignment for " + _this.mfrBodyCodeChangeRequest.stagingItem.changeType + " " + _this.mfrBodyCodeChangeRequest.stagingItem.entityName + " : " + _this.mfrBodyCodeChangeRequest.entityStaging.name + " failed."
                };
                _this.toastr.warning(toasterMessage.body, toasterMessage.title);
            }
        }, function (error) {
    ...
    MfrBodyCodeReviewComponent.prototype.onCancel = function () {
        // redirect to search result
        this.router.navigateByUrl(this.backNavigation);
    };
    MfrBodyCodeReviewComponent.prototype.validationCheck = function () {
        var status = false;
        //Status Changed
    ...
    MfrBodyCodeReviewComponent.prototype.onLikeClick = function (status) {
        var _this = this;
        var id = Number(this.route.snapshot.params["id"]);
    ...
    MfrBodyCodeReviewComponent.prototype.getLikes = function (changeRequestId) {
        var _this = this;
    ...
    MfrBodyCodeReviewComponent.prototype.onClickLikes = function (id) {
        this.likeComponent.showAllLikedBy(id);
    };
    MfrBodyCodeReviewComponent.prototype.cleanupComponent = function () {
        return this.newAcFileUploader.cleanupAllTempContainers();
    };
    __decorate([
        core_1.ViewChild("newAcFileUploader"), 
        __metadata('design:type', ac_fileuploader_1.AcFileUploader)
    ], MfrBodyCodeReviewComponent.prototype, "newAcFileUploader", void 0);
    __decorate([
        core_1.ViewChild("existingAcFileUploader"), 
        __metadata('design:type', ac_fileuploader_1.AcFileUploader)
    ], MfrBodyCodeReviewComponent.prototype, "existingAcFileUploader", void 0);
    __decorate([
        core_1.ViewChild("likeComponent"), 
        __metadata('design:type', userLikes_component_1.UserLikesComponent)
    ], MfrBodyCodeReviewComponent.prototype, "likeComponent", void 0);
    MfrBodyCodeReviewComponent = __decorate([
        core_1.Component({
            selector: 'mfrBodyCode-review-comp',
            templateUrl: 'app/templates/mfrBodyCode/mfrBodyCode-review.component.html',
            providers: [mfrBodyCode_service_1.MfrBodyCodeService, likeStaging_service_1.LikeStagingService, user_service_1.UserService, change_service_1.ChangeService],
        }), 
        __metadata('design:paramtypes', [mfrBodyCode_service_1.MfrBodyCodeService, likeStaging_service_1.LikeStagingService, ng2_toastr_1.ToastsManager, router_1.ActivatedRoute, router_1.Router, shared_service_1.SharedService, user_service_1.UserService, change_service_1.ChangeService, navigation_service_1.NavigationService])
    ], MfrBodyCodeReviewComponent);
    return MfrBodyCodeReviewComponent;
}());
exports.MfrBodyCodeReviewComponent = MfrBodyCodeReviewComponent;
