...
var BedConfigReviewComponent = (function () {
    function BedConfigReviewComponent(bedConfigService, bedTypeService, bedLengthService, likeStagingService, toastr, route, router, sharedService, userService, changeService, navgationService) {
    ...
    BedConfigReviewComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.showLoadingGif = true;
        // Load existing base vechile with reference from RouteParams
        var id = Number(this.route.snapshot.params["id"]);
        this.bedConfigService.getChangeRequestStaging(id).subscribe(function (result) {
            _this.bedConfigChangeRequest = result;
            // setup authorization components
            if (_this.bedConfigChangeRequest.stagingItem.status === "PreliminaryApproved") {
                _this.showPrelimRadio = false;
            }
            // set review's changerequestid
            _this.changeRequestReview.changeRequestId = _this.bedConfigChangeRequest.stagingItem.changeRequestId;
            //payload
            _this.bedTypeService.getBedTypeDetail(_this.bedConfigChangeRequest.entityStaging.bedTypeId).subscribe(function (result) {
                _this.bedConfigChangeRequest.entityStaging.bedTypeName = result.name;
                _this.changeRequestReview.changeRequestId = _this.bedConfigChangeRequest.stagingItem.changeRequestId;
                _this.bedLengthService.getBedLengthDetail(_this.bedConfigChangeRequest.entityStaging.bedLengthId).subscribe(function (result) {
                    _this.bedConfigChangeRequest.entityStaging.length = result.length;
                    _this.bedConfigChangeRequest.entityStaging.bedLengthMetric = result.bedLengthMetric;
            ...
            //exisitng payLoad
            if (_this.bedConfigChangeRequest.entityCurrent !== null) {
                _this.bedLengthService.getBedLengthDetail(_this.bedConfigChangeRequest.entityCurrent.bedLengthId).subscribe(function (result) {
                    _this.bedConfigChangeRequest.entityCurrent.length = result.name;
                    _this.bedTypeService.getBedTypeDetail(_this.bedConfigChangeRequest.entityCurrent.bedTypeId).subscribe(function (result) {
                        _this.bedConfigChangeRequest.entityCurrent.bedTypeName = result.name;
                    }, function (error) {
                        _this.toastr.warning(error, constants_warehouse_1.ConstantsWarehouse.errorTitle);
                        _this.showLoadingGif = false;
                    });
    ...
    BedConfigReviewComponent.prototype.onReviewerChange = function () {
    ...
    BedConfigReviewComponent.prototype.onChange = function (approved) {
    ...
    BedConfigReviewComponent.prototype.onSubmitReview = function (deletebuttonclicked) {
        var _this = this;
        ...
        this.showLoadingGif = true;
        var bedConfigIdentity = this.bedConfigChangeRequest.entityStaging.length + ", " + this.bedConfigChangeRequest.entityStaging.bedLengthMetric + ", " +
        ...
        this.newAcFileUploader.uploadAttachments().subscribe(function (uploadedFiles) {
            ...
            _this.bedConfigService.submitChangeRequestReview(_this.bedConfigChangeRequest.stagingItem.changeRequestId, _this.changeRequestReview).subscribe(function (result) {
                if (result) {
                    ...
                    if (_this.changeRequestReview.reviewStatus != changeRequestReview_model_1.ChangeRequestStatus.Deleted) {
                        toasterMessage = {
                            ...
                            body: "Your review for " + _this.bedConfigChangeRequest.stagingItem.changeType + " " + _this.bedConfigChangeRequest.stagingItem.entityName + " : " + bedConfigIdentity + " change request ID " + _this.bedConfigChangeRequest.stagingItem.changeRequestId + " was submitted successfully."
                        };
                    }
                    else {
                        toasterMessage = {
                            title: constants_warehouse_1.ConstantsWarehouse.reviewDeleteSuccessTitle,
                            body: "Your delete request for " + _this.bedConfigChangeRequest.stagingItem.changeType + " " + _this.bedConfigChangeRequest.stagingItem.entityName + " : " + bedConfigIdentity + "  change request ID " + _this.bedConfigChangeRequest.stagingItem.changeRequestId + " was submitted successfully."
                        };
                    }
                    _this.toastr.success(toasterMessage.body, toasterMessage.title);
                    ...
                    if (_this.changeRequestReview.reviewStatus != changeRequestReview_model_1.ChangeRequestStatus.Deleted) {
                        toasterMessage = {
                            ...
                            body: "Your review for " + _this.bedConfigChangeRequest.stagingItem.changeType + " " + _this.bedConfigChangeRequest.stagingItem.entityName + " : " + bedConfigIdentity + " change request ID " + _this.bedConfigChangeRequest.stagingItem.changeRequestId + " failed."
                        };
                    }
                    else {
                        toasterMessage = {
                            title: constants_warehouse_1.ConstantsWarehouse.reviewDeleteErrorTitle,
                            body: "Your delete request for " + _this.bedConfigChangeRequest.stagingItem.changeType + " " + _this.bedConfigChangeRequest.stagingItem.entityName + " : " + bedConfigIdentity + " change request ID " + _this.bedConfigChangeRequest.stagingItem.changeRequestId + " failed."
                        };
                    }
    ...
    BedConfigReviewComponent.prototype.onAssignReviewer = function () {
        var _this = this;
        ...
        var bedConfigIdentity = this.bedConfigChangeRequest.entityStaging.length + ", " + this.bedConfigChangeRequest.entityStaging.bedTypeName;
        this.changeService.assignReviewer(this.assignedReviewer).subscribe(function (result) {
            if (result) {
                var toasterMessage = {
                    ...
                    body: "Your review for " + _this.bedConfigChangeRequest.stagingItem.changeType + " " + _this.bedConfigChangeRequest.stagingItem.entityName + " : " + bedConfigIdentity + " assigned successfully."
                };
                _this.toastr.success(toasterMessage.body, toasterMessage.title);
                ...
                var toasterMessage = {
                    ...
                    body: "Your assignment for " + _this.bedConfigChangeRequest.stagingItem.changeType + " " + _this.bedConfigChangeRequest.stagingItem.entityName + " : " + bedConfigIdentity + " failed."
                };
                _this.toastr.warning(toasterMessage.body, toasterMessage.title);
            }
        }, function (error) {
    ...
    BedConfigReviewComponent.prototype.onCancel = function () {
        // redirect to search result
        this.router.navigateByUrl(this.backNavigation);
    };
    BedConfigReviewComponent.prototype.validationCheck = function () {
        var status = false;
        //Status Changed
    ...
    BedConfigReviewComponent.prototype.onLikeClick = function (status) {
        var _this = this;
        var id = Number(this.route.snapshot.params["id"]);
    ...
    BedConfigReviewComponent.prototype.getLikes = function (changeRequestId) {
        var _this = this;
    ...
    BedConfigReviewComponent.prototype.onClickLikes = function (id) {
        this.likeComponent.showAllLikedBy(id);
    };
    BedConfigReviewComponent.prototype.cleanupComponent = function () {
        return this.newAcFileUploader.cleanupAllTempContainers();
    };
    __decorate([
        core_1.ViewChild("newAcFileUploader"), 
        __metadata('design:type', ac_fileuploader_1.AcFileUploader)
    ], BedConfigReviewComponent.prototype, "newAcFileUploader", void 0);
    __decorate([
        core_1.ViewChild("existingAcFileUploader"), 
        __metadata('design:type', ac_fileuploader_1.AcFileUploader)
    ], BedConfigReviewComponent.prototype, "existingAcFileUploader", void 0);
    __decorate([
        core_1.ViewChild("likeComponent"), 
        __metadata('design:type', userLikes_component_1.UserLikesComponent)
    ], BedConfigReviewComponent.prototype, "likeComponent", void 0);
    BedConfigReviewComponent = __decorate([
        core_1.Component({
            selector: 'bedConfig-review-comp',
            templateUrl: 'app/templates/bedConfig/bedConfig-review.component.html',
            providers: [bedConfig_service_1.BedConfigService, bedType_service_1.BedTypeService, bedLength_service_1.BedLengthService, likeStaging_service_1.LikeStagingService, user_service_1.UserService, change_service_1.ChangeService],
        }), 
        __metadata('design:paramtypes', [bedConfig_service_1.BedConfigService, bedType_service_1.BedTypeService, bedLength_service_1.BedLengthService, likeStaging_service_1.LikeStagingService, ng2_toastr_1.ToastsManager, router_1.ActivatedRoute, router_1.Router, shared_service_1.SharedService, user_service_1.UserService, change_service_1.ChangeService, navigation_service_1.NavigationService])
    ], BedConfigReviewComponent);
    return BedConfigReviewComponent;
}());
exports.BedConfigReviewComponent = BedConfigReviewComponent;
