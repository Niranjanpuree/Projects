...
var BedTypeReviewComponent = (function () {
    function BedTypeReviewComponent(bedTypeService, likeStagingService, toastr, route, router, sharedService, userService, changeService, navgationService) {
    ...
    BedTypeReviewComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.showLoadingGif = true;
        // Load existing base vechile with reference from RouteParams
        var id = Number(this.route.snapshot.params["id"]);
        this.bedTypeService.getChangeRequestStaging(id).subscribe(function (result) {
            _this.bedTypeChangeRequest = result;
            // set review's changerequestid
            _this.changeRequestReview.changeRequestId = _this.bedTypeChangeRequest.stagingItem.changeRequestId;
            //this.getLikes(id);
            ...
            if (_this.bedTypeChangeRequest.stagingItem.status === "Approved" || _this.bedTypeChangeRequest.stagingItem.status === "Deleted" || _this.bedTypeChangeRequest.stagingItem.status === "Rejected") {
                _this.reviewCompleted = true;
            }
            else if (_this.bedTypeChangeRequest.stagingItem.status === "PreliminaryApproved") {
    ...
    BedTypeReviewComponent.prototype.onReviewerChange = function () {
    ...
    BedTypeReviewComponent.prototype.onChange = function (approved) {
    ...
    BedTypeReviewComponent.prototype.onSubmitReview = function (deletebuttonclicked) {
        var _this = this;
        ...
        this.newAcFileUploader.uploadAttachments().subscribe(function (uploadedFiles) {
            ...
            _this.bedTypeService.submitChangeRequestReview(_this.bedTypeChangeRequest.stagingItem.changeRequestId, _this.changeRequestReview).subscribe(function (result) {
                if (result) {
                    ...
                    if (_this.changeRequestReview.reviewStatus != changeRequestReview_model_1.ChangeRequestStatus.Deleted) {
                        toasterMessage = {
                            ...
                            body: "Your review for " + _this.bedTypeChangeRequest.stagingItem.changeType + " " + _this.bedTypeChangeRequest.stagingItem.entityName + " : " + _this.bedTypeChangeRequest.entityStaging.name + " change request ID " + _this.bedTypeChangeRequest.stagingItem.changeRequestId + " was submitted successfully."
                        };
                    }
                    else {
                        toasterMessage = {
                            title: constants_warehouse_1.ConstantsWarehouse.reviewDeleteSuccessTitle,
                            body: "Your delete request for " + _this.bedTypeChangeRequest.stagingItem.changeType + " " + _this.bedTypeChangeRequest.stagingItem.entityName + " : " + _this.bedTypeChangeRequest.entityStaging.name + "  change request ID " + _this.bedTypeChangeRequest.stagingItem.changeRequestId + " was submitted successfully."
                        };
                    }
                    _this.toastr.success(toasterMessage.body, toasterMessage.title);
                    ...
                    if (_this.changeRequestReview.reviewStatus != changeRequestReview_model_1.ChangeRequestStatus.Deleted) {
                        toasterMessage = {
                            ...
                            body: "Your review for " + _this.bedTypeChangeRequest.stagingItem.changeType + " " + _this.bedTypeChangeRequest.stagingItem.entityName + " : " + _this.bedTypeChangeRequest.entityStaging.name + "  change request ID " + _this.bedTypeChangeRequest.stagingItem.changeRequestId + " failed."
                        };
                    }
                    else {
                        toasterMessage = {
                            title: constants_warehouse_1.ConstantsWarehouse.reviewDeleteErrorTitle,
                            body: "Your delete request for " + _this.bedTypeChangeRequest.stagingItem.changeType + " " + _this.bedTypeChangeRequest.stagingItem.entityName + " : " + _this.bedTypeChangeRequest.entityStaging.name + "  change request ID " + _this.bedTypeChangeRequest.stagingItem.changeRequestId + " failed."
                        };
                    }
    ...
    BedTypeReviewComponent.prototype.onAssignReviewer = function () {
        var _this = this;
        ...
        this.assignedReviewer.changeRequestIds[0] = this.bedTypeChangeRequest.stagingItem.changeRequestId;
        this.changeService.assignReviewer(this.assignedReviewer).subscribe(function (result) {
            if (result) {
                var toasterMessage = {
                    ...
                    body: "Your review for " + _this.bedTypeChangeRequest.stagingItem.changeType + " " + _this.bedTypeChangeRequest.stagingItem.entityName + " : " + _this.bedTypeChangeRequest.entityStaging.name + " assigned successfully."
                };
                _this.toastr.success(toasterMessage.body, toasterMessage.title);
                ...
                var toasterMessage = {
                    ...
                    body: "Your assignment for " + _this.bedTypeChangeRequest.stagingItem.changeType + " " + _this.bedTypeChangeRequest.stagingItem.entityName + " : " + _this.bedTypeChangeRequest.entityStaging.name + " failed."
                };
                _this.toastr.warning(toasterMessage.body, toasterMessage.title);
            }
        }, function (error) {
    ...
    BedTypeReviewComponent.prototype.onCancel = function () {
        // redirect to search result
        this.router.navigateByUrl(this.backNavigation);
    };
    BedTypeReviewComponent.prototype.validationCheck = function () {
        var status = false;
        //Status Changed
    ...
    BedTypeReviewComponent.prototype.onLikeClick = function (status) {
        var _this = this;
        var id = Number(this.route.snapshot.params["id"]);
    ...
    BedTypeReviewComponent.prototype.getLikes = function (changeRequestId) {
        var _this = this;
    ...
    BedTypeReviewComponent.prototype.onClickLikes = function (id) {
        this.likeComponent.showAllLikedBy(id);
    };
    BedTypeReviewComponent.prototype.cleanupComponent = function () {
        return this.newAcFileUploader.cleanupAllTempContainers();
    };
    __decorate([
        core_1.ViewChild("newAcFileUploader"), 
        __metadata('design:type', ac_fileuploader_1.AcFileUploader)
    ], BedTypeReviewComponent.prototype, "newAcFileUploader", void 0);
    __decorate([
        core_1.ViewChild("existingAcFileUploader"), 
        __metadata('design:type', ac_fileuploader_1.AcFileUploader)
    ], BedTypeReviewComponent.prototype, "existingAcFileUploader", void 0);
    __decorate([
        core_1.ViewChild("likeComponent"), 
        __metadata('design:type', userLikes_component_1.UserLikesComponent)
    ], BedTypeReviewComponent.prototype, "likeComponent", void 0);
    BedTypeReviewComponent = __decorate([
        core_1.Component({
            selector: 'bedType-review-comp',
            templateUrl: 'app/templates/bedType/bedType-review.component.html',
            providers: [bedType_service_1.BedTypeService, likeStaging_service_1.LikeStagingService, user_service_1.UserService, change_service_1.ChangeService],
        }), 
        __metadata('design:paramtypes', [bedType_service_1.BedTypeService, likeStaging_service_1.LikeStagingService, ng2_toastr_1.ToastsManager, router_1.ActivatedRoute, router_1.Router, shared_service_1.SharedService, user_service_1.UserService, change_service_1.ChangeService, navigation_service_1.NavigationService])
    ], BedTypeReviewComponent);
    return BedTypeReviewComponent;
}());
exports.BedTypeReviewComponent = BedTypeReviewComponent;
