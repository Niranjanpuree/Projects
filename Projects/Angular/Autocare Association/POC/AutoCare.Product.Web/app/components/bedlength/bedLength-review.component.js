...
var BedLengthReviewComponent = (function () {
    function BedLengthReviewComponent(bedLengthService, likeStagingService, toastr, route, router, sharedService, userService, changeService, navgationService) {
    ...
    BedLengthReviewComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.showLoadingGif = true;
        // Load existing base vechile with reference from RouteParams
        var id = Number(this.route.snapshot.params["id"]);
        this.bedLengthService.getChangeRequestStaging(id).subscribe(function (result) {
            _this.bedLengthChangeRequest = result;
            // set review's changerequestid
            _this.changeRequestReview.changeRequestId = _this.bedLengthChangeRequest.stagingItem.changeRequestId;
            //this.getLikes(id);
            ...
            if (_this.bedLengthChangeRequest.stagingItem.status === "PreliminaryApproved") {
    ...
    BedLengthReviewComponent.prototype.onReviewerChange = function () {
        if (this.assignedReviewer.assignedToUserId !== "-1" && !this.isPreliminaryApproveChecked) {
            this.isApproveChecked = false;
            this.isRejectChecked = false;
        }
    };
    BedLengthReviewComponent.prototype.onChange = function (approved) {
    ...
    BedLengthReviewComponent.prototype.onSubmitReview = function (deletebuttonclicked) {
        var _this = this;
        ...
        this.newAcFileUploader.uploadAttachments().subscribe(function (uploadedFiles) {
            ...
            _this.bedLengthService.submitChangeRequestReview(_this.bedLengthChangeRequest.stagingItem.changeRequestId, _this.changeRequestReview).subscribe(function (result) {
                if (result) {
                    ...
                    if (_this.changeRequestReview.reviewStatus != changeRequestReview_model_1.ChangeRequestStatus.Deleted) {
                        toasterMessage = {
                            ...
                            body: "Your review for " + _this.bedLengthChangeRequest.stagingItem.changeType + " " + _this.bedLengthChangeRequest.stagingItem.entityName + " : " + _this.bedLengthChangeRequest.entityStaging.length + " change request ID '" + _this.bedLengthChangeRequest.stagingItem.changeRequestId + "' was submitted successfully."
                        };
                    }
                    else {
                        toasterMessage = {
                            title: constants_warehouse_1.ConstantsWarehouse.reviewDeleteSuccessTitle,
                            body: "Your delete request for " + _this.bedLengthChangeRequest.stagingItem.changeType + " " + _this.bedLengthChangeRequest.stagingItem.entityName + " : " + _this.bedLengthChangeRequest.entityStaging.length + " change request ID '" + _this.bedLengthChangeRequest.stagingItem.changeRequestId + "' was submitted successfully."
                        };
                    }
                    ...
                    if (_this.changeRequestReview.reviewStatus != changeRequestReview_model_1.ChangeRequestStatus.Deleted) {
                        toasterMessage = {
                            ...
                            body: "Your review for " + _this.bedLengthChangeRequest.stagingItem.changeType + " " + _this.bedLengthChangeRequest.stagingItem.entityName + " : " + _this.bedLengthChangeRequest.entityStaging.length + " change request ID '" + _this.bedLengthChangeRequest.stagingItem.changeRequestId + "' failed."
                        };
                    }
                    else {
                        toasterMessage = {
                            title: constants_warehouse_1.ConstantsWarehouse.reviewDeleteErrorTitle,
                            body: "Your delete request for " + _this.bedLengthChangeRequest.stagingItem.changeType + " " + _this.bedLengthChangeRequest.stagingItem.entityName + " : " + _this.bedLengthChangeRequest.entityStaging.length + " change request ID '" + _this.bedLengthChangeRequest.stagingItem.changeRequestId + "' failed."
                        };
                    }
                ...
                if (_this.changeRequestReview.reviewStatus != changeRequestReview_model_1.ChangeRequestStatus.Deleted) {
                    toasterMessage = {
                        title: constants_warehouse_1.ConstantsWarehouse.reviewSubmitErrorTitle,
                        body: "Your review for " + _this.bedLengthChangeRequest.stagingItem.changeType + " " + _this.bedLengthChangeRequest.stagingItem.entityName + " : " + _this.bedLengthChangeRequest.entityStaging.length + " failed.\n" + error.toString() + "."
                    };
                }
                else {
                    toasterMessage = {
                        title: constants_warehouse_1.ConstantsWarehouse.reviewSubmitErrorTitle,
                        body: "Your delete request for " + _this.bedLengthChangeRequest.stagingItem.changeType + " " + _this.bedLengthChangeRequest.stagingItem.entityName + " : " + _this.bedLengthChangeRequest.entityStaging.length + " failed.\n" + error.toString() + "."
                    };
                }
                _this.toastr.warning(toasterMessage.body, toasterMessage.title);
                _this.showLoadingGif = false;
    ...
    BedLengthReviewComponent.prototype.onAssignReviewer = function () {
        var _this = this;
        ...
        this.assignedReviewer.changeRequestIds[0] = this.bedLengthChangeRequest.stagingItem.changeRequestId;
        this.changeService.assignReviewer(this.assignedReviewer).subscribe(function (result) {
            if (result) {
                var toasterMessage = {
                    ...
                    body: "Your review for " + _this.bedLengthChangeRequest.stagingItem.changeType + " " + _this.bedLengthChangeRequest.stagingItem.entityName + " : " + _this.bedLengthChangeRequest.entityStaging.length + " assigned successfully."
                };
                _this.toastr.success(toasterMessage.body, toasterMessage.title);
                // redirect to search result
                _this.router.navigateByUrl("/change/search");
                ...
                var toasterMessage = {
                    ...
                    body: "Your assignment for " + _this.bedLengthChangeRequest.stagingItem.changeType + " " + _this.bedLengthChangeRequest.stagingItem.entityName + " : " + _this.bedLengthChangeRequest.entityStaging.length + " failed."
                };
                _this.toastr.warning(toasterMessage.body, toasterMessage.title);
            }
        }, function (error) {
    ...
    BedLengthReviewComponent.prototype.onCancel = function () {
        // redirect to search result
        this.router.navigateByUrl(this.backNavigation);
    };
    BedLengthReviewComponent.prototype.validationCheck = function () {
        var status = false;
        //Status Changed
    ...
    BedLengthReviewComponent.prototype.onLikeClick = function (status) {
        var _this = this;
        var id = Number(this.route.snapshot.params["id"]);
    ...
    BedLengthReviewComponent.prototype.getLikes = function (changeRequestId) {
        var _this = this;
    ...
    BedLengthReviewComponent.prototype.onClickLikes = function (id) {
        this.likeComponent.showAllLikedBy(id);
    };
    BedLengthReviewComponent.prototype.cleanupComponent = function () {
        return this.newAcFileUploader.cleanupAllTempContainers();
    };
    __decorate([
        core_1.ViewChild("newAcFileUploader"), 
        __metadata('design:type', ac_fileuploader_1.AcFileUploader)
    ], BedLengthReviewComponent.prototype, "newAcFileUploader", void 0);
    __decorate([
        core_1.ViewChild("existingAcFileUploader"), 
        __metadata('design:type', ac_fileuploader_1.AcFileUploader)
    ], BedLengthReviewComponent.prototype, "existingAcFileUploader", void 0);
    __decorate([
        core_1.ViewChild("likeComponent"), 
        __metadata('design:type', userLikes_component_1.UserLikesComponent)
    ], BedLengthReviewComponent.prototype, "likeComponent", void 0);
    BedLengthReviewComponent = __decorate([
        core_1.Component({
            selector: 'bedLength-review-comp',
            templateUrl: 'app/templates/bedLength/bedLength-review.component.html',
            providers: [bedLength_service_1.BedLengthService, likeStaging_service_1.LikeStagingService, user_service_1.UserService, change_service_1.ChangeService],
        }), 
        __metadata('design:paramtypes', [bedLength_service_1.BedLengthService, likeStaging_service_1.LikeStagingService, ng2_toastr_1.ToastsManager, router_1.ActivatedRoute, router_1.Router, shared_service_1.SharedService, user_service_1.UserService, change_service_1.ChangeService, navigation_service_1.NavigationService])
    ], BedLengthReviewComponent);
    return BedLengthReviewComponent;
}());
exports.BedLengthReviewComponent = BedLengthReviewComponent;
