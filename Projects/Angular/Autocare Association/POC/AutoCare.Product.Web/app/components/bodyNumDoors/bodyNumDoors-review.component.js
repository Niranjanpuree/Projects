...
var BodyNumDoorsReviewComponent = (function () {
    function BodyNumDoorsReviewComponent(bodyNumDoorsService, likeStagingService, toastr, route, router, sharedService, userService, changeService, navgationService) {
    ...
    BodyNumDoorsReviewComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.showLoadingGif = true;
        // Load existing base vechile with reference from RouteParams
        var id = Number(this.route.snapshot.params["id"]);
        this.bodyNumDoorsService.getChangeRequestStaging(id).subscribe(function (result) {
            _this.bodyNumDoorsChangeRequest = result;
            // set review's changerequestid
            _this.changeRequestReview.changeRequestId = _this.bodyNumDoorsChangeRequest.stagingItem.changeRequestId;
            //this.getLikes(id);
            ...
            if (_this.bodyNumDoorsChangeRequest.stagingItem.status === "PreliminaryApproved") {
    ...
    BodyNumDoorsReviewComponent.prototype.onReviewerChange = function () {
        if (this.assignedReviewer.assignedToUserId !== "-1" && !this.isPreliminaryApproveChecked) {
            this.isApproveChecked = false;
            this.isRejectChecked = false;
        }
    };
    BodyNumDoorsReviewComponent.prototype.onChange = function (approved) {
    ...
    BodyNumDoorsReviewComponent.prototype.onSubmitReview = function (deletebuttonclicked) {
        var _this = this;
        if (!this.validationCheck()) {
            if (this.assignedReviewer.assignedToUserId !== "-1" && deletebuttonclicked != 'delete') {
                // note: the value on this.assignedReviewer.assignedToUserId is -1 by default, but NumDoors is string. Default is -1 not "".
        ...
        if (deletebuttonclicked == 'delete') {
            ...
            if (this.isPreliminaryApproveChecked) {
                ...
                this.changeRequestReview.reviewStatus = changeRequestReview_model_1.ChangeRequestStatus[this.bodyNumDoorsChangeRequest.stagingItem.status];
            }
        }
        ...
        this.newAcFileUploader.uploadAttachments().subscribe(function (uploadedFiles) {
            ...
            _this.bodyNumDoorsService.submitChangeRequestReview(_this.bodyNumDoorsChangeRequest.stagingItem.changeRequestId, _this.changeRequestReview).subscribe(function (result) {
                if (result) {
                    ...
                    if (_this.changeRequestReview.reviewStatus != changeRequestReview_model_1.ChangeRequestStatus.Deleted) {
                        toasterMessage = {
                            ...
                            body: "Your review for " + _this.bodyNumDoorsChangeRequest.stagingItem.changeType + " " + _this.bodyNumDoorsChangeRequest.stagingItem.entityName + " : " + _this.bodyNumDoorsChangeRequest.entityStaging.numDoors + " change request ID " + _this.bodyNumDoorsChangeRequest.stagingItem.changeRequestId + " was submitted successfully."
                        };
                    }
                    else {
                        toasterMessage = {
                            title: constants_warehouse_1.ConstantsWarehouse.reviewDeleteSuccessTitle,
                            body: "Your delete request for " + _this.bodyNumDoorsChangeRequest.stagingItem.changeType + " " + _this.bodyNumDoorsChangeRequest.stagingItem.entityName + " : " + _this.bodyNumDoorsChangeRequest.entityStaging.numDoors + "  change request ID " + _this.bodyNumDoorsChangeRequest.stagingItem.changeRequestId + " was submitted successfully."
                        };
                    }
                    _this.toastr.success(toasterMessage.body, toasterMessage.title);
                    ...
                    if (_this.changeRequestReview.reviewStatus != changeRequestReview_model_1.ChangeRequestStatus.Deleted) {
                        toasterMessage = {
                            ...
                            body: "Your review for " + _this.bodyNumDoorsChangeRequest.stagingItem.changeType + " " + _this.bodyNumDoorsChangeRequest.stagingItem.entityName + " : " + _this.bodyNumDoorsChangeRequest.entityStaging.numDoors + "  change request ID " + _this.bodyNumDoorsChangeRequest.stagingItem.changeRequestId + " failed."
                        };
                    }
                    else {
                        toasterMessage = {
                            title: constants_warehouse_1.ConstantsWarehouse.reviewDeleteErrorTitle,
                            body: "Your delete request for " + _this.bodyNumDoorsChangeRequest.stagingItem.changeType + " " + _this.bodyNumDoorsChangeRequest.stagingItem.entityName + " : " + _this.bodyNumDoorsChangeRequest.entityStaging.numDoors + "  change request ID " + _this.bodyNumDoorsChangeRequest.stagingItem.changeRequestId + " failed."
                        };
                    }
    ...
    BodyNumDoorsReviewComponent.prototype.onAssignReviewer = function () {
        var _this = this;
        ...
        this.assignedReviewer.changeRequestIds[0] = this.bodyNumDoorsChangeRequest.stagingItem.changeRequestId;
        this.changeService.assignReviewer(this.assignedReviewer).subscribe(function (result) {
            if (result) {
                var toasterMessage = {
                    ...
                    body: "Your review for " + _this.bodyNumDoorsChangeRequest.stagingItem.changeType + " " + _this.bodyNumDoorsChangeRequest.stagingItem.entityName + " : " + _this.bodyNumDoorsChangeRequest.entityStaging.numDoors + " assigned successfully."
                };
                _this.toastr.success(toasterMessage.body, toasterMessage.title);
                ...
                var toasterMessage = {
                    ...
                    body: "Your assignment for " + _this.bodyNumDoorsChangeRequest.stagingItem.changeType + " " + _this.bodyNumDoorsChangeRequest.stagingItem.entityName + " : " + _this.bodyNumDoorsChangeRequest.entityStaging.numDoors + " failed."
                };
                _this.toastr.warning(toasterMessage.body, toasterMessage.title);
            }
        }, function (error) {
    ...
    BodyNumDoorsReviewComponent.prototype.onCancel = function () {
        // redirect to search result
        this.router.navigateByUrl(this.backNavigation);
    };
    BodyNumDoorsReviewComponent.prototype.validationCheck = function () {
        var status = false;
        //Status Changed
    ...
    BodyNumDoorsReviewComponent.prototype.onLikeClick = function (status) {
        var _this = this;
        var id = Number(this.route.snapshot.params["id"]);
    ...
    BodyNumDoorsReviewComponent.prototype.getLikes = function (changeRequestId) {
        var _this = this;
    ...
    BodyNumDoorsReviewComponent.prototype.onClickLikes = function (id) {
        this.likeComponent.showAllLikedBy(id);
    };
    BodyNumDoorsReviewComponent.prototype.cleanupComponent = function () {
        return this.newAcFileUploader.cleanupAllTempContainers();
    };
    __decorate([
        core_1.ViewChild("newAcFileUploader"), 
        __metadata('design:type', ac_fileuploader_1.AcFileUploader)
    ], BodyNumDoorsReviewComponent.prototype, "newAcFileUploader", void 0);
    __decorate([
        core_1.ViewChild("existingAcFileUploader"), 
        __metadata('design:type', ac_fileuploader_1.AcFileUploader)
    ], BodyNumDoorsReviewComponent.prototype, "existingAcFileUploader", void 0);
    __decorate([
        core_1.ViewChild("likeComponent"), 
        __metadata('design:type', userLikes_component_1.UserLikesComponent)
    ], BodyNumDoorsReviewComponent.prototype, "likeComponent", void 0);
    BodyNumDoorsReviewComponent = __decorate([
        core_1.Component({
            selector: 'bodyNumDoors-review-comp',
            templateUrl: 'app/templates/bodyNumDoors/bodyNumDoors-review.component.html',
            providers: [bodyNumDoors_service_1.BodyNumDoorsService, likeStaging_service_1.LikeStagingService, user_service_1.UserService, change_service_1.ChangeService],
        }), 
        __metadata('design:paramtypes', [bodyNumDoors_service_1.BodyNumDoorsService, likeStaging_service_1.LikeStagingService, ng2_toastr_1.ToastsManager, router_1.ActivatedRoute, router_1.Router, shared_service_1.SharedService, user_service_1.UserService, change_service_1.ChangeService, navigation_service_1.NavigationService])
    ], BodyNumDoorsReviewComponent);
    return BodyNumDoorsReviewComponent;
}());
exports.BodyNumDoorsReviewComponent = BodyNumDoorsReviewComponent;
