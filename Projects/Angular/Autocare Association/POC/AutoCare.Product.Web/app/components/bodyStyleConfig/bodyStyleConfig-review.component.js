...
var BodyStyleConfigReviewComponent = (function () {
    function BodyStyleConfigReviewComponent(bodyStyleConfigService, bodyTypeService, bodyNumDoorsService, likeStagingService, toastr, route, router, sharedService, userService, changeService, navgationService) {
    ...
    BodyStyleConfigReviewComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.showLoadingGif = true;
        // Load existing base vechile with reference from RouteParams
        var id = Number(this.route.snapshot.params["id"]);
        this.bodyStyleConfigService.getChangeRequestStaging(id).subscribe(function (result) {
            _this.bodyStyleConfigChangeRequest = result;
            if (_this.bodyStyleConfigChangeRequest.stagingItem.status === "PreliminaryApproved") {
                _this.showPrelimRadio = false;
            }
            _this.changeRequestReview.changeRequestId = _this.bodyStyleConfigChangeRequest.stagingItem.changeRequestId;
            //payload
            _this.bodyTypeService.getBodyTypeDetail(_this.bodyStyleConfigChangeRequest.entityStaging.bodyTypeId).subscribe(function (result) {
                _this.bodyStyleConfigChangeRequest.entityStaging.bodyTypeName = result.name;
                _this.changeRequestReview.changeRequestId = _this.bodyStyleConfigChangeRequest.stagingItem.changeRequestId;
                _this.bodyNumDoorsService.getBodyNumDoorsDetail(_this.bodyStyleConfigChangeRequest.entityStaging.bodyNumDoorsId).subscribe(function (result) {
                    _this.bodyStyleConfigChangeRequest.entityStaging.numDoors = result.numDoors;
            ...
            //exisitng payLoad
            if (_this.bodyStyleConfigChangeRequest.entityCurrent !== null) {
                _this.bodyNumDoorsService.getBodyNumDoorsDetail(_this.bodyStyleConfigChangeRequest.entityCurrent.bodyNumDoorsId).subscribe(function (result) {
                    _this.bodyStyleConfigChangeRequest.entityCurrent.numDoors = result.numDoors;
                    _this.bodyTypeService.getBodyTypeDetail(_this.bodyStyleConfigChangeRequest.entityCurrent.bodyTypeId).subscribe(function (result) {
                        _this.bodyStyleConfigChangeRequest.entityCurrent.bodyTypeName = result.name;
                    }, function (error) {
                        _this.toastr.warning(error, constants_warehouse_1.ConstantsWarehouse.errorTitle);
                        _this.showLoadingGif = false;
                    });
    ...
    BodyStyleConfigReviewComponent.prototype.onReviewerChange = function () {
    ...
    BodyStyleConfigReviewComponent.prototype.onChange = function (approved) {
    ...
    BodyStyleConfigReviewComponent.prototype.onSubmitReview = function (deletebuttonclicked) {
        var _this = this;
        ...
        this.showLoadingGif = true;
        var bodyStyleConfigIdentity = this.bodyStyleConfigChangeRequest.entityStaging.numDoors + ", " +
            this.bodyStyleConfigChangeRequest.entityStaging.bodyTypeName;
        this.newAcFileUploader.uploadAttachments().subscribe(function (uploadedFiles) {
            ...
            _this.bodyStyleConfigService.submitChangeRequestReview(_this.bodyStyleConfigChangeRequest.stagingItem.changeRequestId, _this.changeRequestReview).subscribe(function (result) {
                if (result) {
                    ...
                    if (_this.changeRequestReview.reviewStatus != changeRequestReview_model_1.ChangeRequestStatus.Deleted) {
                        toasterMessage = {
                            ...
                            body: "Your review for " + _this.bodyStyleConfigChangeRequest.stagingItem.changeType + " " + _this.bodyStyleConfigChangeRequest.stagingItem.entityName + " : " + bodyStyleConfigIdentity + " change request ID " + _this.bodyStyleConfigChangeRequest.stagingItem.changeRequestId + " was submitted successfully."
                        };
                    }
                    else {
                        toasterMessage = {
                            title: constants_warehouse_1.ConstantsWarehouse.reviewDeleteSuccessTitle,
                            body: "Your delete request for " + _this.bodyStyleConfigChangeRequest.stagingItem.changeType + " " + _this.bodyStyleConfigChangeRequest.stagingItem.entityName + " : " + bodyStyleConfigIdentity + "  change request ID " + _this.bodyStyleConfigChangeRequest.stagingItem.changeRequestId + " was submitted successfully."
                        };
                    }
                    _this.toastr.success(toasterMessage.body, toasterMessage.title);
                    ...
                    if (_this.changeRequestReview.reviewStatus != changeRequestReview_model_1.ChangeRequestStatus.Deleted) {
                        toasterMessage = {
                            ...
                            body: "Your review for " + _this.bodyStyleConfigChangeRequest.stagingItem.changeType + " " + _this.bodyStyleConfigChangeRequest.stagingItem.entityName + " : " + bodyStyleConfigIdentity + " change request ID " + _this.bodyStyleConfigChangeRequest.stagingItem.changeRequestId + " failed."
                        };
                    }
                    else {
                        toasterMessage = {
                            title: constants_warehouse_1.ConstantsWarehouse.reviewDeleteErrorTitle,
                            body: "Your delete request for " + _this.bodyStyleConfigChangeRequest.stagingItem.changeType + " " + _this.bodyStyleConfigChangeRequest.stagingItem.entityName + " : " + bodyStyleConfigIdentity + " change request ID " + _this.bodyStyleConfigChangeRequest.stagingItem.changeRequestId + " failed."
                        };
                    }
    ...
    BodyStyleConfigReviewComponent.prototype.onAssignReviewer = function () {
        var _this = this;
        ...
        this.assignedReviewer.changeRequestIds[0] = this.bodyStyleConfigChangeRequest.stagingItem.changeRequestId;
        var bodyStyleConfigIdentity = this.bodyStyleConfigChangeRequest.entityStaging.bodyTypeName;
        this.changeService.assignReviewer(this.assignedReviewer).subscribe(function (result) {
            if (result) {
                var toasterMessage = {
                    ...
                    body: "Your review for " + _this.bodyStyleConfigChangeRequest.stagingItem.changeType + " " + _this.bodyStyleConfigChangeRequest.stagingItem.entityName + " : " + bodyStyleConfigIdentity + " assigned successfully."
                };
                _this.toastr.success(toasterMessage.body, toasterMessage.title);
                ...
                var toasterMessage = {
                    ...
                    body: "Your assignment for " + _this.bodyStyleConfigChangeRequest.stagingItem.changeType + " " + _this.bodyStyleConfigChangeRequest.stagingItem.entityName + " : " + bodyStyleConfigIdentity + " failed."
                };
                _this.toastr.warning(toasterMessage.body, toasterMessage.title);
            }
        }, function (error) {
    ...
    BodyStyleConfigReviewComponent.prototype.onCancel = function () {
        // redirect to search result
        this.router.navigateByUrl(this.backNavigation);
    };
    BodyStyleConfigReviewComponent.prototype.validationCheck = function () {
        var status = false;
        //Status Changed
    ...
    BodyStyleConfigReviewComponent.prototype.onLikeClick = function (status) {
        var _this = this;
        var id = Number(this.route.snapshot.params["id"]);
    ...
    BodyStyleConfigReviewComponent.prototype.getLikes = function (changeRequestId) {
        var _this = this;
    ...
    BodyStyleConfigReviewComponent.prototype.onClickLikes = function (id) {
        this.likeComponent.showAllLikedBy(id);
    };
    BodyStyleConfigReviewComponent.prototype.cleanupComponent = function () {
        return this.newAcFileUploader.cleanupAllTempContainers();
    };
    __decorate([
        core_1.ViewChild("newAcFileUploader"), 
        __metadata('design:type', ac_fileuploader_1.AcFileUploader)
    ], BodyStyleConfigReviewComponent.prototype, "newAcFileUploader", void 0);
    __decorate([
        core_1.ViewChild("existingAcFileUploader"), 
        __metadata('design:type', ac_fileuploader_1.AcFileUploader)
    ], BodyStyleConfigReviewComponent.prototype, "existingAcFileUploader", void 0);
    __decorate([
        core_1.ViewChild("likeComponent"), 
        __metadata('design:type', userLikes_component_1.UserLikesComponent)
    ], BodyStyleConfigReviewComponent.prototype, "likeComponent", void 0);
    BodyStyleConfigReviewComponent = __decorate([
        core_1.Component({
            selector: 'bodyStyleConfig-review-comp',
            templateUrl: 'app/templates/bodyStyleConfig/bodyStyleConfig-review.component.html',
            providers: [bodyStyleConfig_service_1.BodyStyleConfigService, bodyType_service_1.BodyTypeService, bodyNumDoors_service_1.BodyNumDoorsService, likeStaging_service_1.LikeStagingService, user_service_1.UserService, change_service_1.ChangeService],
        }), 
        __metadata('design:paramtypes', [bodyStyleConfig_service_1.BodyStyleConfigService, bodyType_service_1.BodyTypeService, bodyNumDoors_service_1.BodyNumDoorsService, likeStaging_service_1.LikeStagingService, ng2_toastr_1.ToastsManager, router_1.ActivatedRoute, router_1.Router, shared_service_1.SharedService, user_service_1.UserService, change_service_1.ChangeService, navigation_service_1.NavigationService])
    ], BodyStyleConfigReviewComponent);
    return BodyStyleConfigReviewComponent;
}());
exports.BodyStyleConfigReviewComponent = BodyStyleConfigReviewComponent;
