...
var BodyTypeReviewComponent = (function () {
    function BodyTypeReviewComponent(bodyTypeService, likeStagingService, toastr, route, router, sharedService, userService, changeService, navgationService) {
    ...
    BodyTypeReviewComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.showLoadingGif = true;
        // Load existing base vechile with reference from RouteParams
        var id = Number(this.route.snapshot.params["id"]);
        this.bodyTypeService.getChangeRequestStaging(id).subscribe(function (result) {
            _this.bodyTypeChangeRequest = result;
            // set review's changerequestid
            _this.changeRequestReview.changeRequestId = _this.bodyTypeChangeRequest.stagingItem.changeRequestId;
            //this.getLikes(id);
            ...
            if (_this.bodyTypeChangeRequest.stagingItem.status === "PreliminaryApproved") {
    ...
    BodyTypeReviewComponent.prototype.onReviewerChange = function () {
        if (this.assignedReviewer.assignedToUserId !== "-1" && !this.isPreliminaryApproveChecked) {
            this.isApproveChecked = false;
            this.isRejectChecked = false;
        }
    };
    BodyTypeReviewComponent.prototype.onChange = function (approved) {
    ...
    BodyTypeReviewComponent.prototype.onSubmitReview = function (deletebuttonclicked) {
        var _this = this;
        ...
        if (deletebuttonclicked == 'delete') {
            ...
            if (this.isPreliminaryApproveChecked) {
                ...
                this.changeRequestReview.reviewStatus = changeRequestReview_model_1.ChangeRequestStatus[this.bodyTypeChangeRequest.stagingItem.status];
            }
        }
        ...
        this.newAcFileUploader.uploadAttachments().subscribe(function (uploadedFiles) {
            ...
            _this.bodyTypeService.submitChangeRequestReview(_this.bodyTypeChangeRequest.stagingItem.changeRequestId, _this.changeRequestReview).subscribe(function (result) {
                if (result) {
                    ...
                    if (_this.changeRequestReview.reviewStatus != changeRequestReview_model_1.ChangeRequestStatus.Deleted) {
                        toasterMessage = {
                            ...
                            body: "Your review for " + _this.bodyTypeChangeRequest.stagingItem.changeType + " " + _this.bodyTypeChangeRequest.stagingItem.entityName + " : " + _this.bodyTypeChangeRequest.entityStaging.name + " change request ID " + _this.bodyTypeChangeRequest.stagingItem.changeRequestId + " was submitted successfully."
                        };
                    }
                    else {
                        toasterMessage = {
                            title: constants_warehouse_1.ConstantsWarehouse.reviewDeleteSuccessTitle,
                            body: "Your delete request for " + _this.bodyTypeChangeRequest.stagingItem.changeType + " " + _this.bodyTypeChangeRequest.stagingItem.entityName + " : " + _this.bodyTypeChangeRequest.entityStaging.name + "  change request ID " + _this.bodyTypeChangeRequest.stagingItem.changeRequestId + " was submitted successfully."
                        };
                    }
                    _this.toastr.success(toasterMessage.body, toasterMessage.title);
                    ...
                    if (_this.changeRequestReview.reviewStatus != changeRequestReview_model_1.ChangeRequestStatus.Deleted) {
                        toasterMessage = {
                            ...
                            body: "Your review for " + _this.bodyTypeChangeRequest.stagingItem.changeType + " " + _this.bodyTypeChangeRequest.stagingItem.entityName + " : " + _this.bodyTypeChangeRequest.entityStaging.name + "  change request ID " + _this.bodyTypeChangeRequest.stagingItem.changeRequestId + " failed."
                        };
                    }
                    else {
                        toasterMessage = {
                            title: constants_warehouse_1.ConstantsWarehouse.reviewDeleteErrorTitle,
                            body: "Your delete request for " + _this.bodyTypeChangeRequest.stagingItem.changeType + " " + _this.bodyTypeChangeRequest.stagingItem.entityName + " : " + _this.bodyTypeChangeRequest.entityStaging.name + "  change request ID " + _this.bodyTypeChangeRequest.stagingItem.changeRequestId + " failed."
                        };
                    }
    ...
    BodyTypeReviewComponent.prototype.onAssignReviewer = function () {
        var _this = this;
        ...
        this.assignedReviewer.changeRequestIds[0] = this.bodyTypeChangeRequest.stagingItem.changeRequestId;
        this.changeService.assignReviewer(this.assignedReviewer).subscribe(function (result) {
            if (result) {
                var toasterMessage = {
                    ...
                    body: "Your review for " + _this.bodyTypeChangeRequest.stagingItem.changeType + " " + _this.bodyTypeChangeRequest.stagingItem.entityName + " : " + _this.bodyTypeChangeRequest.entityStaging.name + " assigned successfully."
                };
                _this.toastr.success(toasterMessage.body, toasterMessage.title);
                ...
                var toasterMessage = {
                    ...
                    body: "Your assignment for " + _this.bodyTypeChangeRequest.stagingItem.changeType + " " + _this.bodyTypeChangeRequest.stagingItem.entityName + " : " + _this.bodyTypeChangeRequest.entityStaging.name + " failed."
                };
                _this.toastr.warning(toasterMessage.body, toasterMessage.title);
            }
        }, function (error) {
    ...
    BodyTypeReviewComponent.prototype.onCancel = function () {
        // redirect to search result
        this.router.navigateByUrl(this.backNavigation);
    };
    BodyTypeReviewComponent.prototype.validationCheck = function () {
        var status = false;
        //Status Changed
    ...
    BodyTypeReviewComponent.prototype.onLikeClick = function (status) {
        var _this = this;
        var id = Number(this.route.snapshot.params["id"]);
    ...
    BodyTypeReviewComponent.prototype.getLikes = function (changeRequestId) {
        var _this = this;
    ...
    BodyTypeReviewComponent.prototype.onClickLikes = function (id) {
        this.likeComponent.showAllLikedBy(id);
    };
    BodyTypeReviewComponent.prototype.cleanupComponent = function () {
        return this.newAcFileUploader.cleanupAllTempContainers();
    };
    __decorate([
        core_1.ViewChild("newAcFileUploader"), 
        __metadata('design:type', ac_fileuploader_1.AcFileUploader)
    ], BodyTypeReviewComponent.prototype, "newAcFileUploader", void 0);
    __decorate([
        core_1.ViewChild("existingAcFileUploader"), 
        __metadata('design:type', ac_fileuploader_1.AcFileUploader)
    ], BodyTypeReviewComponent.prototype, "existingAcFileUploader", void 0);
    __decorate([
        core_1.ViewChild("likeComponent"), 
        __metadata('design:type', userLikes_component_1.UserLikesComponent)
    ], BodyTypeReviewComponent.prototype, "likeComponent", void 0);
    BodyTypeReviewComponent = __decorate([
        core_1.Component({
            selector: 'bodyType-review-comp',
            templateUrl: 'app/templates/bodyType/bodyType-review.component.html',
            providers: [bodyType_service_1.BodyTypeService, likeStaging_service_1.LikeStagingService, user_service_1.UserService, change_service_1.ChangeService],
        }), 
        __metadata('design:paramtypes', [bodyType_service_1.BodyTypeService, likeStaging_service_1.LikeStagingService, ng2_toastr_1.ToastsManager, router_1.ActivatedRoute, router_1.Router, shared_service_1.SharedService, user_service_1.UserService, change_service_1.ChangeService, navigation_service_1.NavigationService])
    ], BodyTypeReviewComponent);
    return BodyTypeReviewComponent;
}());
exports.BodyTypeReviewComponent = BodyTypeReviewComponent;
