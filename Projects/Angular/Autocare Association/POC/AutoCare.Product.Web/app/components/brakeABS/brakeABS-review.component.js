...
var BrakeABSReviewComponent = (function () {
    function BrakeABSReviewComponent(brakeABSService, likeStagingService, toastr, route, router, sharedService, userService, changeService, navgationService) {
    ...
    BrakeABSReviewComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.showLoadingGif = true;
        // Load existing base vechile with reference from RouteParams
        var id = Number(this.route.snapshot.params["id"]);
        this.brakeABSService.getChangeRequestStaging(id).subscribe(function (result) {
            _this.brakeABSChangeRequest = result;
            // set review's changerequestid
            _this.changeRequestReview.changeRequestId = _this.brakeABSChangeRequest.stagingItem.changeRequestId;
            //this.getLikes(id);
            ...
            //this._identityInfo = this.sharedService.getIdentityInfo(String(this.brakeABSChangeRequest.stagingItem.submittedBy));
            //if (this.brakeABSChangeRequest.stagingItem.status === "Approved" || this.brakeABSChangeRequest.stagingItem.status === "Deleted" || this.brakeABSChangeRequest.stagingItem.status === "Rejected") {
            //    this.isReviewCompleted = true;
            //} else if (this.brakeABSChangeRequest.stagingItem.status === "PreliminaryApproved") {
            //    this.showPrelimRadio = false;
            //    if (this._identityInfo.isResearcher)
            //        this.isReviewCompleted = true;
            //}
            // check if Preliminary Approved.
            if (_this.brakeABSChangeRequest.stagingItem.status == "PreliminaryApproved") {
    ...
    BrakeABSReviewComponent.prototype.onReviewerChange = function () {
        if (this.assignedReviewer.assignedToUserId !== "-1" && !this.isPreliminaryApproveChecked) {
            this.isApproveChecked = false;
            this.isRejectChecked = false;
        }
    };
    BrakeABSReviewComponent.prototype.onChange = function (approved) {
    ...
    BrakeABSReviewComponent.prototype.onSubmitReview = function (deletebuttonclicked) {
        var _this = this;
        ...
        if (deletebuttonclicked == 'delete') {
            ...
            if (this.isPreliminaryApproveChecked) {
                ...
                this.changeRequestReview.reviewStatus = changeRequestReview_model_1.ChangeRequestStatus[this.brakeABSChangeRequest.stagingItem.status];
            }
        }
        ...
        this.newAcFileUploader.uploadAttachments().subscribe(function (uploadedFiles) {
            ...
            _this.brakeABSService.submitChangeRequestReview(_this.brakeABSChangeRequest.stagingItem.changeRequestId, _this.changeRequestReview).subscribe(function (result) {
                if (result) {
                    ...
                    if (_this.changeRequestReview.reviewStatus != changeRequestReview_model_1.ChangeRequestStatus.Deleted) {
                        toasterMessage = {
                            ...
                            body: "Your review for " + _this.brakeABSChangeRequest.stagingItem.changeType + " " + _this.brakeABSChangeRequest.stagingItem.entityName + " : " + _this.brakeABSChangeRequest.entityStaging.name + " change request ID '" + _this.brakeABSChangeRequest.stagingItem.changeRequestId + "' was submitted successfully."
                        };
                    }
                    else {
                        toasterMessage = {
                            title: constants_warehouse_1.ConstantsWarehouse.reviewDeleteSuccessTitle,
                            body: "Your delete request for " + _this.brakeABSChangeRequest.stagingItem.changeType + " " + _this.brakeABSChangeRequest.stagingItem.entityName + " : " + _this.brakeABSChangeRequest.entityStaging.name + " change request ID '" + _this.brakeABSChangeRequest.stagingItem.changeRequestId + "' was submitted successfully."
                        };
                    }
                    ...
                    if (_this.changeRequestReview.reviewStatus != changeRequestReview_model_1.ChangeRequestStatus.Deleted) {
                        toasterMessage = {
                            ...
                            body: "Your review for " + _this.brakeABSChangeRequest.stagingItem.changeType + " " + _this.brakeABSChangeRequest.stagingItem.entityName + " : " + _this.brakeABSChangeRequest.entityStaging.name + " change request ID '" + _this.brakeABSChangeRequest.stagingItem.changeRequestId + "' failed."
                        };
                    }
                    else {
                        toasterMessage = {
                            title: constants_warehouse_1.ConstantsWarehouse.reviewDeleteErrorTitle,
                            body: "Your delete request for " + _this.brakeABSChangeRequest.stagingItem.changeType + " " + _this.brakeABSChangeRequest.stagingItem.entityName + " : " + _this.brakeABSChangeRequest.entityStaging.name + " change request ID '" + _this.brakeABSChangeRequest.stagingItem.changeRequestId + "' failed."
                        };
                    }
                ...
                if (_this.changeRequestReview.reviewStatus != changeRequestReview_model_1.ChangeRequestStatus.Deleted) {
                    toasterMessage = {
                        title: constants_warehouse_1.ConstantsWarehouse.reviewSubmitErrorTitle,
                        body: "Your review for " + _this.brakeABSChangeRequest.stagingItem.changeType + " " + _this.brakeABSChangeRequest.stagingItem.entityName + " : " + _this.brakeABSChangeRequest.entityStaging.name + " failed.\n" + error.toString() + "."
                    };
                }
                else {
                    toasterMessage = {
                        title: constants_warehouse_1.ConstantsWarehouse.reviewSubmitErrorTitle,
                        body: "Your delete request for " + _this.brakeABSChangeRequest.stagingItem.changeType + " " + _this.brakeABSChangeRequest.stagingItem.entityName + " : " + _this.brakeABSChangeRequest.entityStaging.name + " failed.\n" + error.toString() + "."
                    };
                }
                _this.toastr.warning(toasterMessage.body, toasterMessage.title);
                _this.showLoadingGif = false;
    ...
    BrakeABSReviewComponent.prototype.onAssignReviewer = function () {
        var _this = this;
        ...
        this.assignedReviewer.changeRequestIds[0] = this.brakeABSChangeRequest.stagingItem.changeRequestId;
        this.changeService.assignReviewer(this.assignedReviewer).subscribe(function (result) {
            if (result) {
                var toasterMessage = {
                    ...
                    body: "Your review for " + _this.brakeABSChangeRequest.stagingItem.changeType + " " + _this.brakeABSChangeRequest.stagingItem.entityName + " : " + _this.brakeABSChangeRequest.entityStaging.name + " assigned successfully."
                };
                _this.toastr.success(toasterMessage.body, toasterMessage.title);
                ...
                var toasterMessage = {
                    ...
                    body: "Your assignment for " + _this.brakeABSChangeRequest.stagingItem.changeType + " " + _this.brakeABSChangeRequest.stagingItem.entityName + " : " + _this.brakeABSChangeRequest.entityStaging.name + " failed."
                };
                _this.toastr.warning(toasterMessage.body, toasterMessage.title);
            }
        }, function (error) {
    ...
    BrakeABSReviewComponent.prototype.onCancel = function () {
        // redirect to search result
        this.router.navigateByUrl(this.backNavigation);
    };
    BrakeABSReviewComponent.prototype.validationCheck = function () {
        var status = false;
        //Status Changed
    ...
    BrakeABSReviewComponent.prototype.onLikeClick = function (status) {
        var _this = this;
        var id = Number(this.route.snapshot.params["id"]);
    ...
    BrakeABSReviewComponent.prototype.getLikes = function (changeRequestId) {
        var _this = this;
    ...
    BrakeABSReviewComponent.prototype.onClickLikes = function (id) {
        this.likeComponent.showAllLikedBy(id);
    };
    BrakeABSReviewComponent.prototype.cleanupComponent = function () {
        return this.newAcFileUploader.cleanupAllTempContainers();
    };
    __decorate([
        core_1.ViewChild("newAcFileUploader"), 
        __metadata('design:type', ac_fileuploader_1.AcFileUploader)
    ], BrakeABSReviewComponent.prototype, "newAcFileUploader", void 0);
    __decorate([
        core_1.ViewChild("existingAcFileUploader"), 
        __metadata('design:type', ac_fileuploader_1.AcFileUploader)
    ], BrakeABSReviewComponent.prototype, "existingAcFileUploader", void 0);
    __decorate([
        core_1.ViewChild("likeComponent"), 
        __metadata('design:type', userLikes_component_1.UserLikesComponent)
    ], BrakeABSReviewComponent.prototype, "likeComponent", void 0);
    BrakeABSReviewComponent = __decorate([
        core_1.Component({
            selector: 'brakeABS-review-comp',
            templateUrl: 'app/templates/brakeABS/brakeABS-review.component.html',
            providers: [brakeABS_service_1.BrakeABSService, likeStaging_service_1.LikeStagingService, user_service_1.UserService, change_service_1.ChangeService],
        }), 
        __metadata('design:paramtypes', [brakeABS_service_1.BrakeABSService, likeStaging_service_1.LikeStagingService, ng2_toastr_1.ToastsManager, router_1.ActivatedRoute, router_1.Router, shared_service_1.SharedService, user_service_1.UserService, change_service_1.ChangeService, navigation_service_1.NavigationService])
    ], BrakeABSReviewComponent);
    return BrakeABSReviewComponent;
}());
exports.BrakeABSReviewComponent = BrakeABSReviewComponent;
