...
var BrakeConfigReviewComponent = (function () {
    function BrakeConfigReviewComponent(brakeConfigService, brakeTypeService, brakeSystemService, brakeABSService, likeStagingService, toastr, route, router, sharedService, userService, changeService, navgationService) {
    ...
    BrakeConfigReviewComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.showLoadingGif = true;
        // Load existing base vechile with reference from RouteParams
        var id = Number(this.route.snapshot.params["id"]);
        this.brakeConfigService.getChangeRequestStaging(id).subscribe(function (result) {
            _this.brakeConfigChangeRequest = result;
            // setup authorization components
            //this._identityInfo = this.sharedService.getIdentityInfo(String(this.brakeConfigChangeRequest.stagingItem.submittedBy));
            //if (this.brakeConfigChangeRequest.stagingItem.status === "Approved" || this.brakeConfigChangeRequest.stagingItem.status === "Deleted"
            //    || this.brakeConfigChangeRequest.stagingItem.status === "Rejected") {
            //    this.isReviewCompleted = true;
            //} else if (this.brakeConfigChangeRequest.stagingItem.status === "PreliminaryApproved") {
            //    this.showPrelimRadio = false;
            //    if (this._identityInfo.isResearcher)
            //        this.isReviewCompleted = true;
            //}
            // check if Preliminary Approved.
            if (_this.brakeConfigChangeRequest.stagingItem.status == "PreliminaryApproved") {
                _this.showPrelimRadio = false;
            }
            // set review's changerequestid
            _this.changeRequestReview.changeRequestId = _this.brakeConfigChangeRequest.stagingItem.changeRequestId;
            //payload
            _this.brakeTypeService.getBrakeTypeDetail(_this.brakeConfigChangeRequest.entityStaging.frontBrakeTypeId).subscribe(function (result) {
                _this.brakeConfigChangeRequest.entityStaging.frontBrakeTypeName = result.name;
                _this.changeRequestReview.changeRequestId = _this.brakeConfigChangeRequest.stagingItem.changeRequestId;
                _this.brakeTypeService.getBrakeTypeDetail(_this.brakeConfigChangeRequest.entityStaging.rearBrakeTypeId).subscribe(function (result) {
                    _this.brakeConfigChangeRequest.entityStaging.rearBrakeTypeName = result.name;
                    _this.brakeSystemService.getBrakeSystemDetail(_this.brakeConfigChangeRequest.entityStaging.brakeSystemId).subscribe(function (result) {
                        _this.brakeConfigChangeRequest.entityStaging.brakeSystemName = result.name;
                        _this.brakeABSService.getBrakeABSDetail(_this.brakeConfigChangeRequest.entityStaging.brakeABSId).subscribe(function (result) {
                            _this.brakeConfigChangeRequest.entityStaging.brakeABSName = result.name;
                            //this.getLikes(id);
            ...
            //exisitng payLoad
            if (_this.brakeConfigChangeRequest.entityCurrent !== null) {
                _this.brakeTypeService.getBrakeTypeDetail(_this.brakeConfigChangeRequest.entityCurrent.frontBrakeTypeId).subscribe(function (result) {
                    _this.brakeConfigChangeRequest.entityCurrent.frontBrakeTypeName = result.name;
                    _this.brakeTypeService.getBrakeTypeDetail(_this.brakeConfigChangeRequest.entityCurrent.rearBrakeTypeId).subscribe(function (result) {
                        _this.brakeConfigChangeRequest.entityCurrent.rearBrakeTypeName = result.name;
                        _this.brakeSystemService.getBrakeSystemDetail(_this.brakeConfigChangeRequest.entityCurrent.brakeSystemId).subscribe(function (result) {
                            _this.brakeConfigChangeRequest.entityCurrent.brakeSystemName = result.name;
                            _this.brakeABSService.getBrakeABSDetail(_this.brakeConfigChangeRequest.entityCurrent.brakeABSId).subscribe(function (result) {
                                _this.brakeConfigChangeRequest.entityCurrent.brakeABSName = result.name;
                            }, function (error) {
                                _this.toastr.warning(error, constants_warehouse_1.ConstantsWarehouse.errorTitle);
                                _this.showLoadingGif = false;
                            });
    ...
    BrakeConfigReviewComponent.prototype.onReviewerChange = function () {
        if (this.assignedReviewer.assignedToUserId !== "-1" && !this.isPreliminaryApproveChecked) {
            this.isApproveChecked = false;
            this.isRejectChecked = false;
        }
    };
    BrakeConfigReviewComponent.prototype.onChange = function (approved) {
    ...
    BrakeConfigReviewComponent.prototype.onSubmitReview = function (deletebuttonclicked) {
        var _this = this;
        ...
        if (deletebuttonclicked == 'delete') {
            ...
            if (this.isPreliminaryApproveChecked) {
                ...
                this.changeRequestReview.reviewStatus = changeRequestReview_model_1.ChangeRequestStatus[this.brakeConfigChangeRequest.stagingItem.status];
            }
        }
        this.changeRequestReview.reviewComment = this.reviewComment;
        this.showLoadingGif = true;
        var brakeConfigIdentity = this.brakeConfigChangeRequest.entityStaging.frontBrakeTypeName + ", " + this.brakeConfigChangeRequest.entityStaging.rearBrakeTypeName + ", " +
            this.brakeConfigChangeRequest.entityStaging.brakeABSName + ", " + this.brakeConfigChangeRequest.entityStaging.brakeSystemName;
        this.newAcFileUploader.uploadAttachments().subscribe(function (uploadedFiles) {
            ...
            _this.brakeConfigService.submitChangeRequestReview(_this.brakeConfigChangeRequest.stagingItem.changeRequestId, _this.changeRequestReview).subscribe(function (result) {
                if (result) {
                    ...
                    if (_this.changeRequestReview.reviewStatus != changeRequestReview_model_1.ChangeRequestStatus.Deleted) {
                        toasterMessage = {
                            ...
                            body: "Your review for " + _this.brakeConfigChangeRequest.stagingItem.changeType + " " + _this.brakeConfigChangeRequest.stagingItem.entityName + " : " + brakeConfigIdentity + " change request ID " + _this.brakeConfigChangeRequest.stagingItem.changeRequestId + " was submitted successfully."
                        };
                    }
                    else {
                        toasterMessage = {
                            title: constants_warehouse_1.ConstantsWarehouse.reviewDeleteSuccessTitle,
                            body: "Your delete request for " + _this.brakeConfigChangeRequest.stagingItem.changeType + " " + _this.brakeConfigChangeRequest.stagingItem.entityName + " : " + brakeConfigIdentity + "  change request ID " + _this.brakeConfigChangeRequest.stagingItem.changeRequestId + " was submitted successfully."
                        };
                    }
                    _this.toastr.success(toasterMessage.body, toasterMessage.title);
                    ...
                    if (_this.changeRequestReview.reviewStatus != changeRequestReview_model_1.ChangeRequestStatus.Deleted) {
                        toasterMessage = {
                            ...
                            body: "Your review for " + _this.brakeConfigChangeRequest.stagingItem.changeType + " " + _this.brakeConfigChangeRequest.stagingItem.entityName + " : " + brakeConfigIdentity + " change request ID " + _this.brakeConfigChangeRequest.stagingItem.changeRequestId + " failed."
                        };
                    }
                    else {
                        toasterMessage = {
                            title: constants_warehouse_1.ConstantsWarehouse.reviewDeleteErrorTitle,
                            body: "Your delete request for " + _this.brakeConfigChangeRequest.stagingItem.changeType + " " + _this.brakeConfigChangeRequest.stagingItem.entityName + " : " + brakeConfigIdentity + " change request ID " + _this.brakeConfigChangeRequest.stagingItem.changeRequestId + " failed."
                        };
                    }
    ...
    BrakeConfigReviewComponent.prototype.onAssignReviewer = function () {
        var _this = this;
        ...
        this.assignedReviewer.changeRequestIds[0] = this.brakeConfigChangeRequest.stagingItem.changeRequestId;
        var brakeConfigIdentity = this.brakeConfigChangeRequest.entityStaging.frontBrakeTypeName + ", " + this.brakeConfigChangeRequest.entityStaging.rearBrakeTypeName + ", " +
            this.brakeConfigChangeRequest.entityStaging.brakeABSName + ", " + this.brakeConfigChangeRequest.entityStaging.brakeSystemName;
        this.changeService.assignReviewer(this.assignedReviewer).subscribe(function (result) {
            if (result) {
                var toasterMessage = {
                    ...
                    body: "Your review for " + _this.brakeConfigChangeRequest.stagingItem.changeType + " " + _this.brakeConfigChangeRequest.stagingItem.entityName + " : " + brakeConfigIdentity + " assigned successfully."
                };
                _this.toastr.success(toasterMessage.body, toasterMessage.title);
                ...
                var toasterMessage = {
                    ...
                    body: "Your assignment for " + _this.brakeConfigChangeRequest.stagingItem.changeType + " " + _this.brakeConfigChangeRequest.stagingItem.entityName + " : " + brakeConfigIdentity + " failed."
                };
                _this.toastr.warning(toasterMessage.body, toasterMessage.title);
            }
        }, function (error) {
    ...
    BrakeConfigReviewComponent.prototype.onCancel = function () {
        // redirect to search result
        this.router.navigateByUrl(this.backNavigation);
    };
    BrakeConfigReviewComponent.prototype.validationCheck = function () {
        var status = false;
        //Status Changed
    ...
    BrakeConfigReviewComponent.prototype.onLikeClick = function (status) {
        var _this = this;
        var id = Number(this.route.snapshot.params["id"]);
    ...
    BrakeConfigReviewComponent.prototype.getLikes = function (changeRequestId) {
        var _this = this;
    ...
    BrakeConfigReviewComponent.prototype.onClickLikes = function (id) {
        this.likeComponent.showAllLikedBy(id);
    };
    BrakeConfigReviewComponent.prototype.cleanupComponent = function () {
        return this.newAcFileUploader.cleanupAllTempContainers();
    };
    __decorate([
        core_1.ViewChild("newAcFileUploader"), 
        __metadata('design:type', ac_fileuploader_1.AcFileUploader)
    ], BrakeConfigReviewComponent.prototype, "newAcFileUploader", void 0);
    __decorate([
        core_1.ViewChild("existingAcFileUploader"), 
        __metadata('design:type', ac_fileuploader_1.AcFileUploader)
    ], BrakeConfigReviewComponent.prototype, "existingAcFileUploader", void 0);
    __decorate([
        core_1.ViewChild("likeComponent"), 
        __metadata('design:type', userLikes_component_1.UserLikesComponent)
    ], BrakeConfigReviewComponent.prototype, "likeComponent", void 0);
    BrakeConfigReviewComponent = __decorate([
        core_1.Component({
            selector: 'brakeConfig-review-comp',
            templateUrl: 'app/templates/brakeConfig/brakeConfig-review.component.html',
            providers: [brakeConfig_service_1.BrakeConfigService, brakeType_service_1.BrakeTypeService, brakeSystem_service_1.BrakeSystemService, brakeABS_service_1.BrakeABSService, likeStaging_service_1.LikeStagingService, user_service_1.UserService, change_service_1.ChangeService],
        }), 
        __metadata('design:paramtypes', [brakeConfig_service_1.BrakeConfigService, brakeType_service_1.BrakeTypeService, brakeSystem_service_1.BrakeSystemService, brakeABS_service_1.BrakeABSService, likeStaging_service_1.LikeStagingService, ng2_toastr_1.ToastsManager, router_1.ActivatedRoute, router_1.Router, shared_service_1.SharedService, user_service_1.UserService, change_service_1.ChangeService, navigation_service_1.NavigationService])
    ], BrakeConfigReviewComponent);
    return BrakeConfigReviewComponent;
}());
exports.BrakeConfigReviewComponent = BrakeConfigReviewComponent;
