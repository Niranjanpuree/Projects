...
var DriveTypeReviewComponent = (function () {
    function DriveTypeReviewComponent(driveTypeService, likeStagingService, toastr, route, router, sharedService, userService, changeService, navgationService) {
    ...
    DriveTypeReviewComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.showLoadingGif = true;
        // Load existing base vechile with reference from RouteParams
        var id = Number(this.route.snapshot.params["id"]);
        this.driveTypeService.getChangeRequestStaging(id).subscribe(function (result) {
            _this.driveTypeChangeRequest = result;
            // set review's changerequestid
            _this.changeRequestReview.changeRequestId = _this.driveTypeChangeRequest.stagingItem.changeRequestId;
            // get like
            // this.getLikes(id);
            ...
            if (_this.driveTypeChangeRequest.stagingItem.status == "PreliminaryApproved") {
    ...
    DriveTypeReviewComponent.prototype.onReviewerChange = function () {
        if (this.assignedReviewer.assignedToUserId !== "-1" && !this.isPreliminaryApproveChecked) {
            this.isApproveChecked = false;
            this.isRejectChecked = false;
        }
    };
    DriveTypeReviewComponent.prototype.onChange = function (approved) {
    ...
    DriveTypeReviewComponent.prototype.onSubmitReview = function (deletebuttonclicked) {
        var _this = this;
        ...
        if (deletebuttonclicked == 'delete') {
            ...
            if (this.isPreliminaryApproveChecked) {
                ...
                this.changeRequestReview.reviewStatus = changeRequestReview_model_1.ChangeRequestStatus[this.driveTypeChangeRequest.stagingItem.status];
            }
        }
        ...
        this.newAcFileUploader.uploadAttachments().subscribe(function (uploadedFiles) {
            ...
            _this.driveTypeService.submitChangeRequestReview(_this.driveTypeChangeRequest.stagingItem.changeRequestId, _this.changeRequestReview).subscribe(function (result) {
                if (result) {
                    ...
                    if (_this.changeRequestReview.reviewStatus != changeRequestReview_model_1.ChangeRequestStatus.Deleted) {
                        toasterMessage = {
                            ...
                            body: "Your review for " + _this.driveTypeChangeRequest.stagingItem.changeType + " " + _this.driveTypeChangeRequest.stagingItem.entityName + " : " + _this.driveTypeChangeRequest.entityStaging.name + "  change request ID " + _this.driveTypeChangeRequest.stagingItem.changeRequestId + " was submitted successfully."
                        };
                    }
                    else {
                        toasterMessage = {
                            title: constants_warehouse_1.ConstantsWarehouse.reviewDeleteSuccessTitle,
                            body: "Your delete request for " + _this.driveTypeChangeRequest.stagingItem.changeType + " " + _this.driveTypeChangeRequest.stagingItem.entityName + " : " + _this.driveTypeChangeRequest.entityStaging.name + "  change request ID " + _this.driveTypeChangeRequest.stagingItem.changeRequestId + " was submitted successfully."
                        };
                    }
                    _this.toastr.success(toasterMessage.body, toasterMessage.title);
                    ...
                    if (_this.changeRequestReview.reviewStatus != changeRequestReview_model_1.ChangeRequestStatus.Deleted) {
                        toasterMessage = {
                            ...
                            body: "Your review for " + _this.driveTypeChangeRequest.stagingItem.changeType + " " + _this.driveTypeChangeRequest.stagingItem.entityName + " : " + _this.driveTypeChangeRequest.entityStaging.name + "  change request ID " + _this.driveTypeChangeRequest.stagingItem.changeRequestId + " failed."
                        };
                    }
                    else {
                        toasterMessage = {
                            title: constants_warehouse_1.ConstantsWarehouse.reviewDeleteErrorTitle,
                            body: "Your delete request for " + _this.driveTypeChangeRequest.stagingItem.changeType + " " + _this.driveTypeChangeRequest.stagingItem.entityName + " : " + _this.driveTypeChangeRequest.entityStaging.name + "  change request ID " + _this.driveTypeChangeRequest.stagingItem.changeRequestId + " failed."
                        };
                    }
    ...
    DriveTypeReviewComponent.prototype.onAssignReviewer = function () {
        var _this = this;
        ...
        this.assignedReviewer.changeRequestIds[0] = this.driveTypeChangeRequest.stagingItem.changeRequestId;
        this.changeService.assignReviewer(this.assignedReviewer).subscribe(function (result) {
            if (result) {
                var toasterMessage = {
                    ...
                    body: "Your review for " + _this.driveTypeChangeRequest.stagingItem.changeType + " " + _this.driveTypeChangeRequest.stagingItem.entityName + " : " + _this.driveTypeChangeRequest.entityStaging.name + " assigned successfully."
                };
                _this.toastr.success(toasterMessage.body, toasterMessage.title);
                ...
                var toasterMessage = {
                    ...
                    body: "Your assignment for " + _this.driveTypeChangeRequest.stagingItem.changeType + " " + _this.driveTypeChangeRequest.stagingItem.entityName + " : " + _this.driveTypeChangeRequest.entityStaging.name + " failed."
                };
                _this.toastr.warning(toasterMessage.body, toasterMessage.title);
            }
        }, function (error) {
    ...
    DriveTypeReviewComponent.prototype.onCancel = function () {
        // redirect to search result
        this.router.navigateByUrl(this.backNavigation);
    };
    DriveTypeReviewComponent.prototype.validationCheck = function () {
        var status = false;
        //Status Changed
    ...
    DriveTypeReviewComponent.prototype.onLikeClick = function (status) {
        var _this = this;
        var id = Number(this.route.snapshot.params["id"]);
    ...
    DriveTypeReviewComponent.prototype.getLikes = function (changeRequestId) {
        var _this = this;
    ...
    DriveTypeReviewComponent.prototype.onClickLikes = function (id) {
        this.likeComponent.showAllLikedBy(id);
    };
    DriveTypeReviewComponent.prototype.cleanupComponent = function () {
        return this.newAcFileUploader.cleanupAllTempContainers();
    };
    __decorate([
        core_1.ViewChild("newAcFileUploader"), 
        __metadata('design:type', ac_fileuploader_1.AcFileUploader)
    ], DriveTypeReviewComponent.prototype, "newAcFileUploader", void 0);
    __decorate([
        core_1.ViewChild("existingAcFileUploader"), 
        __metadata('design:type', ac_fileuploader_1.AcFileUploader)
    ], DriveTypeReviewComponent.prototype, "existingAcFileUploader", void 0);
    __decorate([
        core_1.ViewChild("likeComponent"), 
        __metadata('design:type', userLikes_component_1.UserLikesComponent)
    ], DriveTypeReviewComponent.prototype, "likeComponent", void 0);
    DriveTypeReviewComponent = __decorate([
        core_1.Component({
            selector: 'driveType-review-comp',
            templateUrl: 'app/templates/driveType/driveType-review.component.html',
            providers: [driveType_service_1.DriveTypeService, likeStaging_service_1.LikeStagingService, user_service_1.UserService, change_service_1.ChangeService],
        }), 
        __metadata('design:paramtypes', [driveType_service_1.DriveTypeService, likeStaging_service_1.LikeStagingService, ng2_toastr_1.ToastsManager, router_1.ActivatedRoute, router_1.Router, shared_service_1.SharedService, user_service_1.UserService, change_service_1.ChangeService, navigation_service_1.NavigationService])
    ], DriveTypeReviewComponent);
    return DriveTypeReviewComponent;
}());
exports.DriveTypeReviewComponent = DriveTypeReviewComponent;
