...
var EngineDesignationReviewComponent = (function () {
    function EngineDesignationReviewComponent(engineDesignationService, likeStagingService, toastr, route, router, sharedService, userService, changeService, navgationService) {
    ...
    EngineDesignationReviewComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.showLoadingGif = true;
        // Load existing base vechile with reference from RouteParams
        var id = Number(this.route.snapshot.params["id"]);
        this.engineDesignationService.getChangeRequestStaging(id).subscribe(function (result) {
            _this.engineDesignationChangeRequest = result;
            // set review's changerequestid
            _this.changeRequestReview.changeRequestId = _this.engineDesignationChangeRequest.stagingItem.changeRequestId;
            //this.getLikes(id);
            ...
            if (_this.engineDesignationChangeRequest.stagingItem.status === "Approved" || _this.engineDesignationChangeRequest.stagingItem.status === "Deleted" || _this.engineDesignationChangeRequest.stagingItem.status === "Rejected") {
                _this.reviewCompleted = true;
            }
            else if (_this.engineDesignationChangeRequest.stagingItem.status === "PreliminaryApproved") {
    ...
    EngineDesignationReviewComponent.prototype.onReviewerChange = function () {
    ...
    EngineDesignationReviewComponent.prototype.onChange = function (approved) {
    ...
    EngineDesignationReviewComponent.prototype.onSubmitReview = function (deletebuttonclicked) {
        var _this = this;
        ...
        this.newAcFileUploader.uploadAttachments().subscribe(function (uploadedFiles) {
            ...
            _this.engineDesignationService.submitChangeRequestReview(_this.engineDesignationChangeRequest.stagingItem.changeRequestId, _this.changeRequestReview).subscribe(function (result) {
                if (result) {
                    ...
                    if (_this.changeRequestReview.reviewStatus != changeRequestReview_model_1.ChangeRequestStatus.Deleted) {
                        toasterMessage = {
                            ...
                            body: "Your review for " + _this.engineDesignationChangeRequest.stagingItem.changeType + " " + _this.engineDesignationChangeRequest.stagingItem.entityName + " : " + _this.engineDesignationChangeRequest.entityStaging.engineDesignationName + " change request ID " + _this.engineDesignationChangeRequest.stagingItem.changeRequestId + " was submitted successfully."
                        };
                    }
                    else {
                        toasterMessage = {
                            title: constants_warehouse_1.ConstantsWarehouse.reviewDeleteSuccessTitle,
                            body: "Your delete request for " + _this.engineDesignationChangeRequest.stagingItem.changeType + " " + _this.engineDesignationChangeRequest.stagingItem.entityName + " : " + _this.engineDesignationChangeRequest.entityStaging.engineDesignationName + "  change request ID " + _this.engineDesignationChangeRequest.stagingItem.changeRequestId + " was submitted successfully."
                        };
                    }
                    _this.toastr.success(toasterMessage.body, toasterMessage.title);
                    ...
                    if (_this.changeRequestReview.reviewStatus != changeRequestReview_model_1.ChangeRequestStatus.Deleted) {
                        toasterMessage = {
                            ...
                            body: "Your review for " + _this.engineDesignationChangeRequest.stagingItem.changeType + " " + _this.engineDesignationChangeRequest.stagingItem.entityName + " : " + _this.engineDesignationChangeRequest.entityStaging.engineDesignationName + "  change request ID " + _this.engineDesignationChangeRequest.stagingItem.changeRequestId + " failed."
                        };
                    }
                    else {
                        toasterMessage = {
                            title: constants_warehouse_1.ConstantsWarehouse.reviewDeleteErrorTitle,
                            body: "Your delete request for " + _this.engineDesignationChangeRequest.stagingItem.changeType + " " + _this.engineDesignationChangeRequest.stagingItem.entityName + " : " + _this.engineDesignationChangeRequest.entityStaging.engineDesignationName + "  change request ID " + _this.engineDesignationChangeRequest.stagingItem.changeRequestId + " failed."
                        };
                    }
    ...
    EngineDesignationReviewComponent.prototype.onAssignReviewer = function () {
        var _this = this;
        ...
        this.assignedReviewer.changeRequestIds[0] = this.engineDesignationChangeRequest.stagingItem.changeRequestId;
        this.changeService.assignReviewer(this.assignedReviewer).subscribe(function (result) {
            if (result) {
                var toasterMessage = {
                    ...
                    body: "Your review for " + _this.engineDesignationChangeRequest.stagingItem.changeType + " " + _this.engineDesignationChangeRequest.stagingItem.entityName + " : " + _this.engineDesignationChangeRequest.entityStaging.engineDesignationName + " assigned successfully."
                };
                _this.toastr.success(toasterMessage.body, toasterMessage.title);
                ...
                var toasterMessage = {
                    ...
                    body: "Your assignment for " + _this.engineDesignationChangeRequest.stagingItem.changeType + " " + _this.engineDesignationChangeRequest.stagingItem.entityName + " : " + _this.engineDesignationChangeRequest.entityStaging.engineDesignationName + " failed."
                };
                _this.toastr.warning(toasterMessage.body, toasterMessage.title);
            }
        }, function (error) {
    ...
    EngineDesignationReviewComponent.prototype.onCancel = function () {
        // redirect to search result
        this.router.navigateByUrl(this.backNavigation);
    };
    EngineDesignationReviewComponent.prototype.validationCheck = function () {
        var status = false;
        //Status Changed
    ...
    EngineDesignationReviewComponent.prototype.onLikeClick = function (status) {
        var _this = this;
        var id = Number(this.route.snapshot.params["id"]);
    ...
    EngineDesignationReviewComponent.prototype.getLikes = function (changeRequestId) {
        var _this = this;
    ...
    EngineDesignationReviewComponent.prototype.onClickLikes = function (id) {
        this.likeComponent.showAllLikedBy(id);
    };
    EngineDesignationReviewComponent.prototype.cleanupComponent = function () {
        return this.newAcFileUploader.cleanupAllTempContainers();
    };
    __decorate([
        core_1.ViewChild("newAcFileUploader"), 
        __metadata('design:type', ac_fileuploader_1.AcFileUploader)
    ], EngineDesignationReviewComponent.prototype, "newAcFileUploader", void 0);
    __decorate([
        core_1.ViewChild("existingAcFileUploader"), 
        __metadata('design:type', ac_fileuploader_1.AcFileUploader)
    ], EngineDesignationReviewComponent.prototype, "existingAcFileUploader", void 0);
    __decorate([
        core_1.ViewChild("likeComponent"), 
        __metadata('design:type', userLikes_component_1.UserLikesComponent)
    ], EngineDesignationReviewComponent.prototype, "likeComponent", void 0);
    EngineDesignationReviewComponent = __decorate([
        core_1.Component({
            selector: 'engineDesignation-review-comp',
            templateUrl: 'app/templates/engineDesignation/engineDesignation-review.component.html',
            providers: [engineDesignation_service_1.EngineDesignationService, likeStaging_service_1.LikeStagingService, user_service_1.UserService, change_service_1.ChangeService],
        }), 
        __metadata('design:paramtypes', [engineDesignation_service_1.EngineDesignationService, likeStaging_service_1.LikeStagingService, ng2_toastr_1.ToastsManager, router_1.ActivatedRoute, router_1.Router, shared_service_1.SharedService, user_service_1.UserService, change_service_1.ChangeService, navigation_service_1.NavigationService])
    ], EngineDesignationReviewComponent);
    return EngineDesignationReviewComponent;
}());
exports.EngineDesignationReviewComponent = EngineDesignationReviewComponent;
