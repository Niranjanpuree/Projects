...
var EngineVersionReviewComponent = (function () {
    function EngineVersionReviewComponent(engineVersionService, likeStagingService, toastr, route, router, sharedService, userService, changeService, navgationService) {
    ...
    EngineVersionReviewComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.showLoadingGif = true;
        // Load existing base vechile with reference from RouteParams
        var id = Number(this.route.snapshot.params["id"]);
        this.engineVersionService.getChangeRequestStaging(id).subscribe(function (result) {
            _this.engineVersionChangeRequest = result;
            // set review's changerequestid
            _this.changeRequestReview.changeRequestId = _this.engineVersionChangeRequest.stagingItem.changeRequestId;
            //this.getLikes(id);
            ...
            if (_this.engineVersionChangeRequest.stagingItem.status === "Approved" || _this.engineVersionChangeRequest.stagingItem.status === "Deleted" || _this.engineVersionChangeRequest.stagingItem.status === "Rejected") {
                _this.reviewCompleted = true;
            }
            else if (_this.engineVersionChangeRequest.stagingItem.status === "PreliminaryApproved") {
    ...
    EngineVersionReviewComponent.prototype.onReviewerChange = function () {
    ...
    EngineVersionReviewComponent.prototype.onChange = function (approved) {
    ...
    EngineVersionReviewComponent.prototype.onSubmitReview = function (deletebuttonclicked) {
        var _this = this;
        ...
        this.newAcFileUploader.uploadAttachments().subscribe(function (uploadedFiles) {
            ...
            _this.engineVersionService.submitChangeRequestReview(_this.engineVersionChangeRequest.stagingItem.changeRequestId, _this.changeRequestReview).subscribe(function (result) {
                if (result) {
                    ...
                    if (_this.changeRequestReview.reviewStatus != changeRequestReview_model_1.ChangeRequestStatus.Deleted) {
                        toasterMessage = {
                            ...
                            body: "Your review for " + _this.engineVersionChangeRequest.stagingItem.changeType + " " + _this.engineVersionChangeRequest.stagingItem.entityName + " : " + _this.engineVersionChangeRequest.entityStaging.engineVersionName + " change request ID " + _this.engineVersionChangeRequest.stagingItem.changeRequestId + " was submitted successfully."
                        };
                    }
                    else {
                        toasterMessage = {
                            title: constants_warehouse_1.ConstantsWarehouse.reviewDeleteSuccessTitle,
                            body: "Your delete request for " + _this.engineVersionChangeRequest.stagingItem.changeType + " " + _this.engineVersionChangeRequest.stagingItem.entityName + " : " + _this.engineVersionChangeRequest.entityStaging.engineVersionName + "  change request ID " + _this.engineVersionChangeRequest.stagingItem.changeRequestId + " was submitted successfully."
                        };
                    }
                    _this.toastr.success(toasterMessage.body, toasterMessage.title);
                    ...
                    if (_this.changeRequestReview.reviewStatus != changeRequestReview_model_1.ChangeRequestStatus.Deleted) {
                        toasterMessage = {
                            ...
                            body: "Your review for " + _this.engineVersionChangeRequest.stagingItem.changeType + " " + _this.engineVersionChangeRequest.stagingItem.entityName + " : " + _this.engineVersionChangeRequest.entityStaging.engineVersionName + "  change request ID " + _this.engineVersionChangeRequest.stagingItem.changeRequestId + " failed."
                        };
                    }
                    else {
                        toasterMessage = {
                            title: constants_warehouse_1.ConstantsWarehouse.reviewDeleteErrorTitle,
                            body: "Your delete request for " + _this.engineVersionChangeRequest.stagingItem.changeType + " " + _this.engineVersionChangeRequest.stagingItem.entityName + " : " + _this.engineVersionChangeRequest.entityStaging.engineVersionName + "  change request ID " + _this.engineVersionChangeRequest.stagingItem.changeRequestId + " failed."
                        };
                    }
    ...
    EngineVersionReviewComponent.prototype.onAssignReviewer = function () {
        var _this = this;
        ...
        this.assignedReviewer.changeRequestIds[0] = this.engineVersionChangeRequest.stagingItem.changeRequestId;
        this.changeService.assignReviewer(this.assignedReviewer).subscribe(function (result) {
            if (result) {
                var toasterMessage = {
                    ...
                    body: "Your review for " + _this.engineVersionChangeRequest.stagingItem.changeType + " " + _this.engineVersionChangeRequest.stagingItem.entityName + " : " + _this.engineVersionChangeRequest.entityStaging.engineVersionName + " assigned successfully."
                };
                _this.toastr.success(toasterMessage.body, toasterMessage.title);
                ...
                var toasterMessage = {
                    ...
                    body: "Your assignment for " + _this.engineVersionChangeRequest.stagingItem.changeType + " " + _this.engineVersionChangeRequest.stagingItem.entityName + " : " + _this.engineVersionChangeRequest.entityStaging.engineVersionName + " failed."
                };
                _this.toastr.warning(toasterMessage.body, toasterMessage.title);
            }
        }, function (error) {
    ...
    EngineVersionReviewComponent.prototype.onCancel = function () {
        // redirect to search result
        this.router.navigateByUrl(this.backNavigation);
    };
    EngineVersionReviewComponent.prototype.validationCheck = function () {
        var status = false;
        //Status Changed
    ...
    EngineVersionReviewComponent.prototype.onLikeClick = function (status) {
        var _this = this;
        var id = Number(this.route.snapshot.params["id"]);
    ...
    EngineVersionReviewComponent.prototype.getLikes = function (changeRequestId) {
        var _this = this;
    ...
    EngineVersionReviewComponent.prototype.onClickLikes = function (id) {
        this.likeComponent.showAllLikedBy(id);
    };
    EngineVersionReviewComponent.prototype.cleanupComponent = function () {
        return this.newAcFileUploader.cleanupAllTempContainers();
    };
    __decorate([
        core_1.ViewChild("newAcFileUploader"), 
        __metadata('design:type', ac_fileuploader_1.AcFileUploader)
    ], EngineVersionReviewComponent.prototype, "newAcFileUploader", void 0);
    __decorate([
        core_1.ViewChild("existingAcFileUploader"), 
        __metadata('design:type', ac_fileuploader_1.AcFileUploader)
    ], EngineVersionReviewComponent.prototype, "existingAcFileUploader", void 0);
    __decorate([
        core_1.ViewChild("likeComponent"), 
        __metadata('design:type', userLikes_component_1.UserLikesComponent)
    ], EngineVersionReviewComponent.prototype, "likeComponent", void 0);
    EngineVersionReviewComponent = __decorate([
        core_1.Component({
            selector: 'engineVersion-review-comp',
            templateUrl: 'app/templates/engineVersion/engineVersion-review.component.html',
            providers: [engineVersion_service_1.EngineVersionService, likeStaging_service_1.LikeStagingService, user_service_1.UserService, change_service_1.ChangeService],
        }), 
        __metadata('design:paramtypes', [engineVersion_service_1.EngineVersionService, likeStaging_service_1.LikeStagingService, ng2_toastr_1.ToastsManager, router_1.ActivatedRoute, router_1.Router, shared_service_1.SharedService, user_service_1.UserService, change_service_1.ChangeService, navigation_service_1.NavigationService])
    ], EngineVersionReviewComponent);
    return EngineVersionReviewComponent;
}());
exports.EngineVersionReviewComponent = EngineVersionReviewComponent;
