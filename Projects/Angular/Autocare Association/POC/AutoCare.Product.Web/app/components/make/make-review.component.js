...
var MakeReviewComponent = (function () {
    function MakeReviewComponent(makeService, likeStagingService, toastr, route, router, sharedService, userService, changeService, navgationService) {
    ...
    MakeReviewComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.showLoadingGif = true;
        // Load existing base vechile with reference from RouteParams
        var id = Number(this.route.snapshot.params["id"]);
        this.makeService.getChangeRequestStaging(id).subscribe(function (result) {
            _this.makeChangeRequest = result;
            // set review's changerequestid
            _this.changeRequestReview.changeRequestId = _this.makeChangeRequest.stagingItem.changeRequestId;
            // get like
            // this.getLikes(id);
            ...
            if (_this.makeChangeRequest.stagingItem.status == "PreliminaryApproved") {
    ...
    MakeReviewComponent.prototype.onReviewerChange = function () {
        if (this.assignedReviewer.assignedToUserId !== "-1" && !this.isPreliminaryApproveChecked) {
            this.isApproveChecked = false;
            this.isRejectChecked = false;
        }
    };
    MakeReviewComponent.prototype.onChange = function (approved) {
    ...
    MakeReviewComponent.prototype.onSubmitReview = function (deletebuttonclicked) {
        var _this = this;
        ...
        if (deletebuttonclicked == 'delete') {
            ...
            if (this.isPreliminaryApproveChecked) {
                ...
                this.changeRequestReview.reviewStatus = changeRequestReview_model_1.ChangeRequestStatus[this.makeChangeRequest.stagingItem.status];
            }
        }
        ...
        this.newAcFileUploader.uploadAttachments().subscribe(function (uploadedFiles) {
            ...
            _this.makeService.submitChangeRequestReview(_this.makeChangeRequest.stagingItem.changeRequestId, _this.changeRequestReview).subscribe(function (result) {
                if (result) {
                    ...
                    if (_this.changeRequestReview.reviewStatus != changeRequestReview_model_1.ChangeRequestStatus.Deleted) {
                        toasterMessage = {
                            ...
                            body: "Your review for " + _this.makeChangeRequest.stagingItem.changeType + " " + _this.makeChangeRequest.stagingItem.entityName + " : " + _this.makeChangeRequest.entityStaging.name + "  change request ID " + _this.makeChangeRequest.stagingItem.changeRequestId + " was submitted successfully."
                        };
                    }
                    else {
                        toasterMessage = {
                            title: constants_warehouse_1.ConstantsWarehouse.reviewDeleteSuccessTitle,
                            body: "Your delete request for " + _this.makeChangeRequest.stagingItem.changeType + " " + _this.makeChangeRequest.stagingItem.entityName + " : " + _this.makeChangeRequest.entityStaging.name + "  change request ID " + _this.makeChangeRequest.stagingItem.changeRequestId + " was submitted successfully."
                        };
                    }
                    _this.toastr.success(toasterMessage.body, toasterMessage.title);
                    ...
                    if (_this.changeRequestReview.reviewStatus != changeRequestReview_model_1.ChangeRequestStatus.Deleted) {
                        toasterMessage = {
                            ...
                            body: "Your review for " + _this.makeChangeRequest.stagingItem.changeType + " " + _this.makeChangeRequest.stagingItem.entityName + " : " + _this.makeChangeRequest.entityStaging.name + "  change request ID " + _this.makeChangeRequest.stagingItem.changeRequestId + " failed."
                        };
                    }
                    else {
                        toasterMessage = {
                            title: constants_warehouse_1.ConstantsWarehouse.reviewDeleteErrorTitle,
                            body: "Your delete request for " + _this.makeChangeRequest.stagingItem.changeType + " " + _this.makeChangeRequest.stagingItem.entityName + " : " + _this.makeChangeRequest.entityStaging.name + "  change request ID " + _this.makeChangeRequest.stagingItem.changeRequestId + " failed."
                        };
                    }
    ...
    MakeReviewComponent.prototype.onAssignReviewer = function () {
        var _this = this;
        ...
        this.changeService.assignReviewer(this.assignedReviewer).subscribe(function (result) {
            if (result) {
                var toasterMessage = {
                    ...
                    body: "Your review for " + _this.makeChangeRequest.stagingItem.changeType + " " + _this.makeChangeRequest.stagingItem.entityName + " : " + _this.makeChangeRequest.entityStaging.name + " assigned successfully."
                };
                _this.toastr.success(toasterMessage.body, toasterMessage.title);
                ...
                var toasterMessage = {
                    ...
                    body: "Your assignment for " + _this.makeChangeRequest.stagingItem.changeType + " " + _this.makeChangeRequest.stagingItem.entityName + " : " + _this.makeChangeRequest.entityStaging.name + " failed."
                };
                _this.toastr.warning(toasterMessage.body, toasterMessage.title);
            }
        }, function (error) {
    ...
    MakeReviewComponent.prototype.onCancel = function () {
        // redirect to search result
        this.router.navigateByUrl(this.backNavigation);
    };
    MakeReviewComponent.prototype.validationCheck = function () {
        var status = false;
        //Status Changed
    ...
    MakeReviewComponent.prototype.onLikeClick = function (status) {
        var _this = this;
        var id = Number(this.route.snapshot.params["id"]);
    ...
    MakeReviewComponent.prototype.getLikes = function (changeRequestId) {
        var _this = this;
    ...
    MakeReviewComponent.prototype.onClickLikes = function (id) {
        this.likeComponent.showAllLikedBy(id);
    };
    MakeReviewComponent.prototype.cleanupComponent = function () {
        return this.newAcFileUploader.cleanupAllTempContainers();
    };
    __decorate([
        core_1.ViewChild("newAcFileUploader"), 
        __metadata('design:type', ac_fileuploader_1.AcFileUploader)
    ], MakeReviewComponent.prototype, "newAcFileUploader", void 0);
    __decorate([
        core_1.ViewChild("existingAcFileUploader"), 
        __metadata('design:type', ac_fileuploader_1.AcFileUploader)
    ], MakeReviewComponent.prototype, "existingAcFileUploader", void 0);
    __decorate([
        core_1.ViewChild("likeComponent"), 
        __metadata('design:type', userLikes_component_1.UserLikesComponent)
    ], MakeReviewComponent.prototype, "likeComponent", void 0);
    MakeReviewComponent = __decorate([
        core_1.Component({
            selector: 'make-review-comp',
            templateUrl: 'app/templates/make/make-review.component.html',
            providers: [make_service_1.MakeService, likeStaging_service_1.LikeStagingService, user_service_1.UserService, change_service_1.ChangeService],
        }), 
        __metadata('design:paramtypes', [make_service_1.MakeService, likeStaging_service_1.LikeStagingService, ng2_toastr_1.ToastsManager, router_1.ActivatedRoute, router_1.Router, shared_service_1.SharedService, user_service_1.UserService, change_service_1.ChangeService, navigation_service_1.NavigationService])
    ], MakeReviewComponent);
    return MakeReviewComponent;
}());
exports.MakeReviewComponent = MakeReviewComponent;
