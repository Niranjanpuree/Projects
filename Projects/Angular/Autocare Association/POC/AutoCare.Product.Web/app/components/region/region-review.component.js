...
var RegionReviewComponent = (function () {
    function RegionReviewComponent(regionService, likeStagingService, toastr, route, router, sharedService, userService, changeService, navgationService) {
    ...
    RegionReviewComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.showLoadingGif = true;
        // Load existing base vechile with reference from RouteParams
        var id = Number(this.route.snapshot.params["id"]);
        this.regionService.getChangeRequestStaging(id).subscribe(function (result) {
            _this.regionChangeRequest = result;
            // set review's changerequestid
            _this.changeRequestReview.changeRequestId = _this.regionChangeRequest.stagingItem.changeRequestId;
            // this.getLikes(id);
            ...
            if (_this.regionChangeRequest.stagingItem.status == "PreliminaryApproved") {
    ...
    RegionReviewComponent.prototype.onReviewerChange = function () {
        if (this.assignedReviewer.assignedToUserId !== "-1" && !this.isPreliminaryApproveChecked) {
            this.isApproveChecked = false;
            this.isRejectChecked = false;
        }
    };
    RegionReviewComponent.prototype.onChange = function (approved) {
    ...
    RegionReviewComponent.prototype.onSubmitReview = function (deletebuttonclicked) {
        var _this = this;
        ...
        if (deletebuttonclicked == 'delete') {
            ...
            if (this.isPreliminaryApproveChecked) {
                ...
                this.changeRequestReview.reviewStatus = changeRequestReview_model_1.ChangeRequestStatus[this.regionChangeRequest.stagingItem.status];
            }
        }
        ...
        this.newAcFileUploader.uploadAttachments().subscribe(function (uploadedFiles) {
            ...
            _this.regionService.submitChangeRequestReview(_this.regionChangeRequest.stagingItem.changeRequestId, _this.changeRequestReview).subscribe(function (result) {
                if (result) {
                    ...
                    if (_this.changeRequestReview.reviewStatus != changeRequestReview_model_1.ChangeRequestStatus.Deleted) {
                        toasterMessage = {
                            ...
                            body: "Your review for " + _this.regionChangeRequest.stagingItem.changeType + " " + _this.regionChangeRequest.stagingItem.entityName + " : " + _this.regionChangeRequest.entityStaging.name + " change request ID ' " + _this.regionChangeRequest.stagingItem.changeRequestId + "' was submitted successfully."
                        };
                    }
                    else {
                        toasterMessage = {
                            title: constants_warehouse_1.ConstantsWarehouse.reviewDeleteSuccessTitle,
                            body: "Your delete request for " + _this.regionChangeRequest.stagingItem.changeType + " " + _this.regionChangeRequest.stagingItem.entityName + " : " + _this.regionChangeRequest.entityStaging.name + " change request ID ' " + _this.regionChangeRequest.stagingItem.changeRequestId + "' was submitted successfully."
                        };
                    }
                    _this.toastr.success(toasterMessage.body, toasterMessage.title);
                    ...
                    if (_this.changeRequestReview.reviewStatus != changeRequestReview_model_1.ChangeRequestStatus.Deleted) {
                        toasterMessage = {
                            ...
                            body: "Your review for " + _this.regionChangeRequest.stagingItem.changeType + " " + _this.regionChangeRequest.stagingItem.entityName + " : " + _this.regionChangeRequest.entityStaging.name + " failed."
                        };
                    }
                    else {
                        toasterMessage = {
                            title: constants_warehouse_1.ConstantsWarehouse.reviewDeleteErrorTitle,
                            body: "Your delete request for " + _this.regionChangeRequest.stagingItem.changeType + " " + _this.regionChangeRequest.stagingItem.entityName + " : " + _this.regionChangeRequest.entityStaging.name + " failed."
                        };
                    }
    ...
    RegionReviewComponent.prototype.onAssignReviewer = function () {
        var _this = this;
        ...
        this.changeService.assignReviewer(this.assignedReviewer).subscribe(function (result) {
            if (result) {
                var toasterMessage = {
                    ...
                    body: "Your review for " + _this.regionChangeRequest.stagingItem.changeType + " " + _this.regionChangeRequest.stagingItem.entityName + " : " + _this.regionChangeRequest.entityStaging.name + " assigned successfully."
                };
                _this.toastr.success(toasterMessage.body, toasterMessage.title);
                ...
                var toasterMessage = {
                    ...
                    body: "Your assignment for " + _this.regionChangeRequest.stagingItem.changeType + " " + _this.regionChangeRequest.stagingItem.entityName + " : " + _this.regionChangeRequest.entityStaging.name + " failed."
                };
                _this.toastr.warning(toasterMessage.body, toasterMessage.title);
            }
        }, function (error) {
    ...
    RegionReviewComponent.prototype.onCancel = function () {
        // redirect to search result
        this.router.navigateByUrl(this.backNavigation);
    };
    RegionReviewComponent.prototype.validationCheck = function () {
        var status = false;
        //Status Changed
    ...
    RegionReviewComponent.prototype.onLikeClick = function (status) {
        var _this = this;
        var id = Number(this.route.snapshot.params["id"]);
    ...
    RegionReviewComponent.prototype.getLikes = function (changeRequestId) {
        var _this = this;
    ...
    RegionReviewComponent.prototype.onClickLikes = function (id) {
        this.likeComponent.showAllLikedBy(id);
    };
    RegionReviewComponent.prototype.cleanupComponent = function () {
        return this.newAcFileUploader.cleanupAllTempContainers();
    };
    __decorate([
        core_1.ViewChild("newAcFileUploader"), 
        __metadata('design:type', ac_fileuploader_1.AcFileUploader)
    ], RegionReviewComponent.prototype, "newAcFileUploader", void 0);
    __decorate([
        core_1.ViewChild("existingAcFileUploader"), 
        __metadata('design:type', ac_fileuploader_1.AcFileUploader)
    ], RegionReviewComponent.prototype, "existingAcFileUploader", void 0);
    __decorate([
        core_1.ViewChild("likeComponent"), 
        __metadata('design:type', userLikes_component_1.UserLikesComponent)
    ], RegionReviewComponent.prototype, "likeComponent", void 0);
    RegionReviewComponent = __decorate([
        core_1.Component({
            selector: 'region-review-comp',
            templateUrl: 'app/templates/region/region-review.component.html',
            providers: [region_service_1.RegionService, likeStaging_service_1.LikeStagingService, user_service_1.UserService, change_service_1.ChangeService],
        }), 
        __metadata('design:paramtypes', [region_service_1.RegionService, likeStaging_service_1.LikeStagingService, ng2_toastr_1.ToastsManager, router_1.ActivatedRoute, router_1.Router, shared_service_1.SharedService, user_service_1.UserService, change_service_1.ChangeService, navigation_service_1.NavigationService])
    ], RegionReviewComponent);
    return RegionReviewComponent;
}());
exports.RegionReviewComponent = RegionReviewComponent;
