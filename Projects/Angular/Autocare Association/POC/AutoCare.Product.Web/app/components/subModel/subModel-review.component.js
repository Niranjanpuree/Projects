...
var SubModelReviewComponent = (function () {
    function SubModelReviewComponent(subModelService, likeStagingService, toastr, route, router, sharedService, userService, changeService, navgationService) {
    ...
    SubModelReviewComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.showLoadingGif = true;
        // Load existing base vechile with reference from RouteParams
        var id = Number(this.route.snapshot.params["id"]);
        this.subModelService.getChangeRequestStaging(id).subscribe(function (result) {
            _this.subModelChangeRequest = result;
            // set review's changerequestid
            _this.changeRequestReview.changeRequestId = _this.subModelChangeRequest.stagingItem.changeRequestId;
            //this.getLikes(id);
            ...
            //this._identityInfo = this.sharedService.getIdentityInfo(String(this.subModelChangeRequest.stagingItem.submittedBy));
            //if (this.subModelChangeRequest.stagingItem.status === "Approved" || this.subModelChangeRequest.stagingItem.status === "Deleted"
            //    || this.subModelChangeRequest.stagingItem.status === "Rejected") {
            //    this.isReviewCompleted = true;
            //} else if (this.subModelChangeRequest.stagingItem.status === "PreliminaryApproved") {
            //    this.showPrelimRadio = false;
            //    if (this._identityInfo.isResearcher)
            //        this.isReviewCompleted = true;
            //}
            // check if Preliminary Approved.
            if (_this.subModelChangeRequest.stagingItem.status == "PreliminaryApproved") {
    ...
    SubModelReviewComponent.prototype.onReviewerChange = function () {
        if (this.assignedReviewer.assignedToUserId !== "-1" && !this.isPreliminaryApproveChecked) {
            this.isApproveChecked = false;
            this.isRejectChecked = false;
        }
    };
    SubModelReviewComponent.prototype.onChange = function (approved) {
    ...
    SubModelReviewComponent.prototype.onSubmitReview = function (deletebuttonclicked) {
        var _this = this;
        ...
        if (deletebuttonclicked == 'delete') {
            ...
            if (this.isPreliminaryApproveChecked) {
                ...
                this.changeRequestReview.reviewStatus = changeRequestReview_model_1.ChangeRequestStatus[this.subModelChangeRequest.stagingItem.status];
            }
        }
        ...
        this.newAcFileUploader.uploadAttachments().subscribe(function (uploadedFiles) {
            ...
            _this.subModelService.submitChangeRequestReview(_this.subModelChangeRequest.stagingItem.changeRequestId, _this.changeRequestReview).subscribe(function (result) {
                if (result) {
                    ...
                    if (_this.changeRequestReview.reviewStatus != changeRequestReview_model_1.ChangeRequestStatus.Deleted) {
                        toasterMessage = {
                            ...
                            body: "Your review for " + _this.subModelChangeRequest.stagingItem.changeType + " " + _this.subModelChangeRequest.stagingItem.entityName + " : " + _this.subModelChangeRequest.entityStaging.name + " change request ID ' " + _this.subModelChangeRequest.stagingItem.changeRequestId + "' was submitted successfully."
                        };
                    }
                    else {
                        toasterMessage = {
                            title: constants_warehouse_1.ConstantsWarehouse.reviewDeleteSuccessTitle,
                            body: "Your delete request for " + _this.subModelChangeRequest.stagingItem.changeType + " " + _this.subModelChangeRequest.stagingItem.entityName + " : " + _this.subModelChangeRequest.entityStaging.name + " change request ID ' " + _this.subModelChangeRequest.stagingItem.changeRequestId + "' was submitted successfully."
                        };
                    }
                    _this.toastr.success(toasterMessage.body, toasterMessage.title);
                    ...
                    if (_this.changeRequestReview.reviewStatus != changeRequestReview_model_1.ChangeRequestStatus.Deleted) {
                        toasterMessage = {
                            ...
                            body: "Your review for " + _this.subModelChangeRequest.stagingItem.changeType + " " + _this.subModelChangeRequest.stagingItem.entityName + " : " + _this.subModelChangeRequest.entityStaging.name + " change request ID ' " + _this.subModelChangeRequest.stagingItem.changeRequestId + "' failed."
                        };
                    }
                    else {
                        toasterMessage = {
                            title: constants_warehouse_1.ConstantsWarehouse.reviewDeleteErrorTitle,
                            body: "Your delete request for " + _this.subModelChangeRequest.stagingItem.changeType + " " + _this.subModelChangeRequest.stagingItem.entityName + " : " + _this.subModelChangeRequest.entityStaging.name + " change request ID ' " + _this.subModelChangeRequest.stagingItem.changeRequestId + "' failed."
                        };
                    }
    ...
    SubModelReviewComponent.prototype.onAssignReviewer = function () {
        var _this = this;
        ...
        this.assignedReviewer.changeRequestIds[0] = this.subModelChangeRequest.stagingItem.changeRequestId;
        this.changeService.assignReviewer(this.assignedReviewer).subscribe(function (result) {
            if (result) {
                var toasterMessage = {
                    ...
                    body: "Your assignment for " + _this.subModelChangeRequest.stagingItem.changeType + " " + _this.subModelChangeRequest.stagingItem.entityName + " : " + _this.subModelChangeRequest.entityStaging.name + " assigned successfully."
                };
                _this.toastr.success(toasterMessage.body, toasterMessage.title);
                ...
                var toasterMessage = {
                    ...
                    body: "Your assignment for " + _this.subModelChangeRequest.stagingItem.changeType + " " + _this.subModelChangeRequest.stagingItem.entityName + " : " + _this.subModelChangeRequest.entityStaging.name + " failed."
                };
                _this.toastr.warning(toasterMessage.body, toasterMessage.title);
            }
        }, function (error) {
    ...
    SubModelReviewComponent.prototype.onCancel = function () {
        // redirect to search result
        this.router.navigateByUrl(this.backNavigation);
    };
    SubModelReviewComponent.prototype.validationCheck = function () {
        var status = false;
        //Status Changed
    ...
    SubModelReviewComponent.prototype.onLikeClick = function (status) {
        var _this = this;
        var id = Number(this.route.snapshot.params["id"]);
    ...
    SubModelReviewComponent.prototype.getLikes = function (changeRequestId) {
        var _this = this;
    ...
    SubModelReviewComponent.prototype.onClickLikes = function (id) {
        this.likeComponent.showAllLikedBy(id);
    };
    SubModelReviewComponent.prototype.cleanupComponent = function () {
        return this.newAcFileUploader.cleanupAllTempContainers();
    };
    __decorate([
        core_1.ViewChild("newAcFileUploader"), 
        __metadata('design:type', ac_fileuploader_1.AcFileUploader)
    ], SubModelReviewComponent.prototype, "newAcFileUploader", void 0);
    __decorate([
        core_1.ViewChild("existingAcFileUploader"), 
        __metadata('design:type', ac_fileuploader_1.AcFileUploader)
    ], SubModelReviewComponent.prototype, "existingAcFileUploader", void 0);
    __decorate([
        core_1.ViewChild("likeComponent"), 
        __metadata('design:type', userLikes_component_1.UserLikesComponent)
    ], SubModelReviewComponent.prototype, "likeComponent", void 0);
    SubModelReviewComponent = __decorate([
        core_1.Component({
            selector: 'subModel-review-comp',
            templateUrl: 'app/templates/subModel/subModel-review.component.html',
            providers: [subModel_service_1.SubModelService, likeStaging_service_1.LikeStagingService, user_service_1.UserService, change_service_1.ChangeService],
        }), 
        __metadata('design:paramtypes', [subModel_service_1.SubModelService, likeStaging_service_1.LikeStagingService, ng2_toastr_1.ToastsManager, router_1.ActivatedRoute, router_1.Router, shared_service_1.SharedService, user_service_1.UserService, change_service_1.ChangeService, navigation_service_1.NavigationService])
    ], SubModelReviewComponent);
    return SubModelReviewComponent;
}());
exports.SubModelReviewComponent = SubModelReviewComponent;
