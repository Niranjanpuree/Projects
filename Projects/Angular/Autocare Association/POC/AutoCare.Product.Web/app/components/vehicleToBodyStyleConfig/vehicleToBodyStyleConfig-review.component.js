...
var VehicleToBodyStyleConfigReviewComponent = (function () {
    function VehicleToBodyStyleConfigReviewComponent(vehicleToBodyStyleConfigService, likeStagingService, toastr, route, router, vehicleService, bodyStyleConfigService, sharedService, userService, changeService, navgationService) {
    ...
    VehicleToBodyStyleConfigReviewComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.showLoadingGif = true;
        // Load existing base vechile with reference from RouteParams
        var id = Number(this.route.snapshot.params["id"]);
        this.vehicleToBodyStyleConfigService.getChangeRequestStaging(id).subscribe(function (result) {
            _this.vehicleToBodyStyleConfigChangeRequest = result;
            if (_this.vehicleToBodyStyleConfigChangeRequest.stagingItem.status == "PreliminaryApproved") {
                _this.showPrelimRadio = false;
            }
            // set review's changerequestid
            _this.changeRequestReview.changeRequestId = _this.vehicleToBodyStyleConfigChangeRequest.stagingItem.changeRequestId;
            //this.getLikes(id);
            _this.likeStagingService.getLikeDetails(id).subscribe(function (result) {
                _this.likeStagingGet = result;
                _this.vehicleService.getVehicle(_this.vehicleToBodyStyleConfigChangeRequest.entityStaging.vehicleId).subscribe(function (result) {
                    _this.vehicleToBodyStyleConfigChangeRequest.entityStaging.vehicle = result;
                    _this.bodyStyleConfigService.getBodyStyleConfig(_this.vehicleToBodyStyleConfigChangeRequest.entityStaging.bodyStyleConfigId).subscribe(function (result) {
                        _this.vehicleToBodyStyleConfigChangeRequest.entityStaging.bodyStyleConfig = result;
    ...
    VehicleToBodyStyleConfigReviewComponent.prototype.onReviewerChange = function () {
        if (this.assignedReviewer.assignedToUserId !== "-1" && !this.isPreliminaryApproveChecked) {
            this.isApproveChecked = false;
            this.isRejectChecked = false;
        }
    };
    VehicleToBodyStyleConfigReviewComponent.prototype.onChange = function (approved) {
    ...
    VehicleToBodyStyleConfigReviewComponent.prototype.onSubmitReview = function (deletebuttonclicked) {
        var _this = this;
        ...
        if (deletebuttonclicked == 'delete') {
            ...
            if (this.isPreliminaryApproveChecked) {
                ...
                this.changeRequestReview.reviewStatus = changeRequestReview_model_1.ChangeRequestStatus[this.vehicleToBodyStyleConfigChangeRequest.stagingItem.status];
            }
        }
        ...
        this.newAcFileUploader.uploadAttachments().subscribe(function (uploadedFiles) {
            ...
            _this.vehicleToBodyStyleConfigService.submitChangeRequestReview(_this.vehicleToBodyStyleConfigChangeRequest.stagingItem.changeRequestId, _this.changeRequestReview).subscribe(function (result) {
                if (result) {
                    ...
                    if (_this.changeRequestReview.reviewStatus != changeRequestReview_model_1.ChangeRequestStatus.Deleted) {
                        toasterMessage = {
                            ...
                            body: "Your review for " + _this.vehicleToBodyStyleConfigChangeRequest.stagingItem.changeType + " " + _this.vehicleToBodyStyleConfigChangeRequest.stagingItem.entityName + " : " + _this.vehicleToBodyStyleConfigChangeRequest.entityStaging.id + " change request ID " + _this.vehicleToBodyStyleConfigChangeRequest.stagingItem.changeRequestId + " was submitted successfully."
                        };
                    }
                    else {
                        toasterMessage = {
                            title: constants_warehouse_1.ConstantsWarehouse.reviewDeleteSuccessTitle,
                            body: "Your delete request for " + _this.vehicleToBodyStyleConfigChangeRequest.stagingItem.changeType + " " + _this.vehicleToBodyStyleConfigChangeRequest.stagingItem.entityName + " : " + _this.vehicleToBodyStyleConfigChangeRequest.entityStaging.id + " change request ID " + _this.vehicleToBodyStyleConfigChangeRequest.stagingItem.changeRequestId + " was submitted successfully."
                        };
                    }
                    _this.toastr.success(toasterMessage.body, toasterMessage.title);
                    ...
                    if (_this.changeRequestReview.reviewStatus != changeRequestReview_model_1.ChangeRequestStatus.Deleted) {
                        toasterMessage = {
                            ...
                            body: "Your review for " + _this.vehicleToBodyStyleConfigChangeRequest.stagingItem.changeType + " " + _this.vehicleToBodyStyleConfigChangeRequest.stagingItem.entityName + " : " + _this.vehicleToBodyStyleConfigChangeRequest.entityStaging.id + " change request ID " + _this.vehicleToBodyStyleConfigChangeRequest.stagingItem.changeRequestId + " failed."
                        };
                    }
                    else {
                        toasterMessage = {
                            title: constants_warehouse_1.ConstantsWarehouse.reviewDeleteErrorTitle,
                            body: "Your delete request for " + _this.vehicleToBodyStyleConfigChangeRequest.stagingItem.changeType + " " + _this.vehicleToBodyStyleConfigChangeRequest.stagingItem.entityName + " : " + _this.vehicleToBodyStyleConfigChangeRequest.entityStaging.id + " change request ID " + _this.vehicleToBodyStyleConfigChangeRequest.stagingItem.changeRequestId + " failed."
                        };
                    }
    ...
    VehicleToBodyStyleConfigReviewComponent.prototype.onAssignReviewer = function () {
        var _this = this;
        ...
        this.assignedReviewer.changeRequestIds[0] = this.vehicleToBodyStyleConfigChangeRequest.stagingItem.changeRequestId;
        this.changeService.assignReviewer(this.assignedReviewer).subscribe(function (result) {
            if (result) {
                var toasterMessage = {
                    ...
                    body: "Your review for " + _this.vehicleToBodyStyleConfigChangeRequest.stagingItem.changeType + " " + _this.vehicleToBodyStyleConfigChangeRequest.stagingItem.entityName + " : " + _this.vehicleToBodyStyleConfigChangeRequest.entityStaging.id + " assigned successfully."
                };
                _this.toastr.success(toasterMessage.body, toasterMessage.title);
                ...
                var toasterMessage = {
                    ...
                    body: "Your assignment for " + _this.vehicleToBodyStyleConfigChangeRequest.stagingItem.changeType + " " + _this.vehicleToBodyStyleConfigChangeRequest.stagingItem.entityName + " : " + _this.vehicleToBodyStyleConfigChangeRequest.entityStaging.id + " failed."
                };
                _this.toastr.warning(toasterMessage.body, toasterMessage.title);
            }
        }, function (error) {
    ...
    VehicleToBodyStyleConfigReviewComponent.prototype.onCancel = function () {
        // redirect to search result
        this.router.navigateByUrl(this.backNavigation);
    };
    VehicleToBodyStyleConfigReviewComponent.prototype.validationCheck = function () {
        var status = false;
        //Status Changed
    ...
    VehicleToBodyStyleConfigReviewComponent.prototype.onLikeClick = function (status) {
        var _this = this;
        var id = Number(this.route.snapshot.params["id"]);
    ...
    VehicleToBodyStyleConfigReviewComponent.prototype.getLikes = function (changeRequestId) {
        var _this = this;
    ...
    VehicleToBodyStyleConfigReviewComponent.prototype.onClickLikes = function (id) {
        this.likeComponent.showAllLikedBy(id);
    };
    VehicleToBodyStyleConfigReviewComponent.prototype.cleanupComponent = function () {
        return this.newAcFileUploader.cleanupAllTempContainers();
    };
    __decorate([
        core_1.ViewChild("newAcFileUploader"), 
        __metadata('design:type', ac_fileuploader_1.AcFileUploader)
    ], VehicleToBodyStyleConfigReviewComponent.prototype, "newAcFileUploader", void 0);
    __decorate([
        core_1.ViewChild("existingAcFileUploader"), 
        __metadata('design:type', ac_fileuploader_1.AcFileUploader)
    ], VehicleToBodyStyleConfigReviewComponent.prototype, "existingAcFileUploader", void 0);
    __decorate([
        core_1.ViewChild("likeComponent"), 
        __metadata('design:type', userLikes_component_1.UserLikesComponent)
    ], VehicleToBodyStyleConfigReviewComponent.prototype, "likeComponent", void 0);
    VehicleToBodyStyleConfigReviewComponent = __decorate([
        core_1.Component({
            selector: 'vehicleToBodyStyleConfig-review-comp',
            templateUrl: 'app/templates/vehicleToBodyStyleConfig/vehicleToBodyStyleConfig-review.component.html',
            providers: [vehicleToBodyStyleConfig_service_1.VehicleToBodyStyleConfigService, vehicle_service_1.VehicleService, bodyStyleConfig_service_1.BodyStyleConfigService, likeStaging_service_1.LikeStagingService, change_service_1.ChangeService, user_service_1.UserService],
        }), 
        __metadata('design:paramtypes', [vehicleToBodyStyleConfig_service_1.VehicleToBodyStyleConfigService, likeStaging_service_1.LikeStagingService, ng2_toastr_1.ToastsManager, router_1.ActivatedRoute, router_1.Router, vehicle_service_1.VehicleService, bodyStyleConfig_service_1.BodyStyleConfigService, shared_service_1.SharedService, user_service_1.UserService, change_service_1.ChangeService, navigation_service_1.NavigationService])
    ], VehicleToBodyStyleConfigReviewComponent);
    return VehicleToBodyStyleConfigReviewComponent;
}());
exports.VehicleToBodyStyleConfigReviewComponent = VehicleToBodyStyleConfigReviewComponent;
