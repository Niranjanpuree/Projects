...
var VehicleToBrakeConfigReviewComponent = (function () {
    function VehicleToBrakeConfigReviewComponent(vehicleToBrakeConfigService, likeStagingService, toastr, route, router, vehicleService, brakeConfigService, sharedService, userService, changeService, navgationService) {
    ...
    VehicleToBrakeConfigReviewComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.showLoadingGif = true;
        // Load existing base vechile with reference from RouteParams
        var id = Number(this.route.snapshot.params["id"]);
        this.vehicleToBrakeConfigService.getChangeRequestStaging(id).subscribe(function (result) {
            _this.vehicleToBrakeConfigChangeRequest = result;
            ...
            if (_this.vehicleToBrakeConfigChangeRequest.stagingItem.status == "PreliminaryApproved") {
                _this.showPrelimRadio = false;
            }
            // set review's changerequestid
            _this.changeRequestReview.changeRequestId = _this.vehicleToBrakeConfigChangeRequest.stagingItem.changeRequestId;
            //this.getLikes(id);
            _this.likeStagingService.getLikeDetails(id).subscribe(function (result) {
                _this.likeStagingGet = result;
                _this.vehicleService.getVehicle(_this.vehicleToBrakeConfigChangeRequest.entityStaging.vehicleId).subscribe(function (result) {
                    _this.vehicleToBrakeConfigChangeRequest.entityStaging.vehicle = result;
                    _this.brakeConfigService.getBrakeConfig(_this.vehicleToBrakeConfigChangeRequest.entityStaging.brakeConfigId).subscribe(function (result) {
                        _this.vehicleToBrakeConfigChangeRequest.entityStaging.brakeConfig = result;
    ...
    VehicleToBrakeConfigReviewComponent.prototype.onReviewerChange = function () {
        if (this.assignedReviewer.assignedToUserId !== "-1" && !this.isPreliminaryApproveChecked) {
            this.isApproveChecked = false;
            this.isRejectChecked = false;
        }
    };
    VehicleToBrakeConfigReviewComponent.prototype.onChange = function (approved) {
    ...
    VehicleToBrakeConfigReviewComponent.prototype.onSubmitReview = function (deletebuttonclicked) {
        var _this = this;
        ...
        if (deletebuttonclicked == 'delete') {
            ...
            if (this.isPreliminaryApproveChecked) {
                ...
                this.changeRequestReview.reviewStatus = changeRequestReview_model_1.ChangeRequestStatus[this.vehicleToBrakeConfigChangeRequest.stagingItem.status];
            }
        }
        ...
        this.newAcFileUploader.uploadAttachments().subscribe(function (uploadedFiles) {
            ...
            _this.vehicleToBrakeConfigService.submitChangeRequestReview(_this.vehicleToBrakeConfigChangeRequest.stagingItem.changeRequestId, _this.changeRequestReview).subscribe(function (result) {
                if (result) {
                    ...
                    if (_this.changeRequestReview.reviewStatus != changeRequestReview_model_1.ChangeRequestStatus.Deleted) {
                        toasterMessage = {
                            ...
                            body: "Your review for " + _this.vehicleToBrakeConfigChangeRequest.stagingItem.changeType + " " + _this.vehicleToBrakeConfigChangeRequest.stagingItem.entityName + " : " + _this.vehicleToBrakeConfigChangeRequest.entityStaging.id + " change request ID " + _this.vehicleToBrakeConfigChangeRequest.stagingItem.changeRequestId + " was submitted successfully."
                        };
                    }
                    else {
                        toasterMessage = {
                            title: constants_warehouse_1.ConstantsWarehouse.reviewDeleteSuccessTitle,
                            body: "Your delete request for " + _this.vehicleToBrakeConfigChangeRequest.stagingItem.changeType + " " + _this.vehicleToBrakeConfigChangeRequest.stagingItem.entityName + " : " + _this.vehicleToBrakeConfigChangeRequest.entityStaging.id + " change request ID " + _this.vehicleToBrakeConfigChangeRequest.stagingItem.changeRequestId + " was submitted successfully."
                        };
                    }
                    _this.toastr.success(toasterMessage.body, toasterMessage.title);
                    ...
                    if (_this.changeRequestReview.reviewStatus != changeRequestReview_model_1.ChangeRequestStatus.Deleted) {
                        toasterMessage = {
                            ...
                            body: "Your review for " + _this.vehicleToBrakeConfigChangeRequest.stagingItem.changeType + " " + _this.vehicleToBrakeConfigChangeRequest.stagingItem.entityName + " : " + _this.vehicleToBrakeConfigChangeRequest.entityStaging.id + " change request ID " + _this.vehicleToBrakeConfigChangeRequest.stagingItem.changeRequestId + " failed."
                        };
                    }
                    else {
                        toasterMessage = {
                            title: constants_warehouse_1.ConstantsWarehouse.reviewDeleteErrorTitle,
                            body: "Your delete request for " + _this.vehicleToBrakeConfigChangeRequest.stagingItem.changeType + " " + _this.vehicleToBrakeConfigChangeRequest.stagingItem.entityName + " : " + _this.vehicleToBrakeConfigChangeRequest.entityStaging.id + " change request ID " + _this.vehicleToBrakeConfigChangeRequest.stagingItem.changeRequestId + " failed."
                        };
                    }
    ...
    VehicleToBrakeConfigReviewComponent.prototype.onAssignReviewer = function () {
        var _this = this;
        ...
        this.changeService.assignReviewer(this.assignedReviewer).subscribe(function (result) {
            if (result) {
                var toasterMessage = {
                    ...
                    body: "Your review for " + _this.vehicleToBrakeConfigChangeRequest.stagingItem.changeType + " " + _this.vehicleToBrakeConfigChangeRequest.stagingItem.entityName + " : " + _this.vehicleToBrakeConfigChangeRequest.entityStaging.id + " assigned successfully."
                };
                _this.toastr.success(toasterMessage.body, toasterMessage.title);
                ...
                var toasterMessage = {
                    ...
                    body: "Your assignment for " + _this.vehicleToBrakeConfigChangeRequest.stagingItem.changeType + " " + _this.vehicleToBrakeConfigChangeRequest.stagingItem.entityName + " : " + _this.vehicleToBrakeConfigChangeRequest.entityStaging.id + " failed."
                };
                _this.toastr.warning(toasterMessage.body, toasterMessage.title);
            }
        }, function (error) {
    ...
    VehicleToBrakeConfigReviewComponent.prototype.onCancel = function () {
        // redirect to search result
        this.router.navigateByUrl(this.backNavigation);
    };
    VehicleToBrakeConfigReviewComponent.prototype.validationCheck = function () {
        var status = false;
        //Status Changed
    ...
    VehicleToBrakeConfigReviewComponent.prototype.onLikeClick = function (status) {
        var _this = this;
        var id = Number(this.route.snapshot.params["id"]);
    ...
    VehicleToBrakeConfigReviewComponent.prototype.getLikes = function (changeRequestId) {
        var _this = this;
    ...
    VehicleToBrakeConfigReviewComponent.prototype.onClickLikes = function (id) {
        this.likeComponent.showAllLikedBy(id);
    };
    VehicleToBrakeConfigReviewComponent.prototype.cleanupComponent = function () {
        return this.newAcFileUploader.cleanupAllTempContainers();
    };
    __decorate([
        core_1.ViewChild("newAcFileUploader"), 
        __metadata('design:type', ac_fileuploader_1.AcFileUploader)
    ], VehicleToBrakeConfigReviewComponent.prototype, "newAcFileUploader", void 0);
    __decorate([
        core_1.ViewChild("existingAcFileUploader"), 
        __metadata('design:type', ac_fileuploader_1.AcFileUploader)
    ], VehicleToBrakeConfigReviewComponent.prototype, "existingAcFileUploader", void 0);
    __decorate([
        core_1.ViewChild("likeComponent"), 
        __metadata('design:type', userLikes_component_1.UserLikesComponent)
    ], VehicleToBrakeConfigReviewComponent.prototype, "likeComponent", void 0);
    VehicleToBrakeConfigReviewComponent = __decorate([
        core_1.Component({
            ...
            providers: [vehicleToBrakeConfig_service_1.VehicleToBrakeConfigService, vehicle_service_1.VehicleService, brakeConfig_service_1.BrakeConfigService, likeStaging_service_1.LikeStagingService, change_service_1.ChangeService, user_service_1.UserService],
        }), 
        __metadata('design:paramtypes', [vehicleToBrakeConfig_service_1.VehicleToBrakeConfigService, likeStaging_service_1.LikeStagingService, ng2_toastr_1.ToastsManager, router_1.ActivatedRoute, router_1.Router, vehicle_service_1.VehicleService, brakeConfig_service_1.BrakeConfigService, shared_service_1.SharedService, user_service_1.UserService, change_service_1.ChangeService, navigation_service_1.NavigationService])
    ], VehicleToBrakeConfigReviewComponent);
    return VehicleToBrakeConfigReviewComponent;
}());
exports.VehicleToBrakeConfigReviewComponent = VehicleToBrakeConfigReviewComponent;
