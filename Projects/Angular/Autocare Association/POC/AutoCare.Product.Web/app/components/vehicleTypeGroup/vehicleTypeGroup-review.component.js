...
var VehicleTypeGroupReviewComponent = (function () {
    function VehicleTypeGroupReviewComponent(vehicleTypeGroupService, likeStagingService, toastr, route, router, sharedService, userService, changeService, navgationService) {
    ...
    VehicleTypeGroupReviewComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.showLoadingGif = true;
        // Load existing base vechile with reference from RouteParams
        var id = Number(this.route.snapshot.params["id"]);
        this.vehicleTypeGroupService.getChangeRequestStaging(id).subscribe(function (result) {
            _this.vehicleTypegroupChangeRequest = result;
            // set review's changerequestid
            _this.changeRequestReview.changeRequestId = _this.vehicleTypegroupChangeRequest.stagingItem.changeRequestId;
            //this.getLikes(id);
            ...
            //this._identityInfo = this.sharedService.getIdentityInfo(String(this.vehicleTypegroupChangeRequest.stagingItem.submittedBy));
            //if (this.vehicleTypegroupChangeRequest.stagingItem.status === "Approved" || this.vehicleTypegroupChangeRequest.stagingItem.status === "Deleted" || this.vehicleTypegroupChangeRequest.stagingItem.status === "Rejected") {
            //    this.isReviewCompleted = true;
            //} else if (this.vehicleTypegroupChangeRequest.stagingItem.status === "PreliminaryApproved") {
            //    this.showPrelimRadio = false;
            //    if (this._identityInfo.isResearcher)
            //        this.isReviewCompleted = true;
            //}
            // check if Preliminary Approved.
            if (_this.vehicleTypegroupChangeRequest.stagingItem.status == "PreliminaryApproved") {
    ...
    VehicleTypeGroupReviewComponent.prototype.onReviewerChange = function () {
        if (this.assignedReviewer.assignedToUserId !== "-1" && !this.isPreliminaryApproveChecked) {
            this.isApproveChecked = false;
            this.isRejectChecked = false;
        }
    };
    VehicleTypeGroupReviewComponent.prototype.onChange = function (approved) {
    ...
    VehicleTypeGroupReviewComponent.prototype.onSubmitReview = function (deletebuttonclicked) {
        var _this = this;
        ...
        if (deletebuttonclicked == 'delete') {
            ...
            if (this.isPreliminaryApproveChecked) {
                ...
                this.changeRequestReview.reviewStatus = changeRequestReview_model_1.ChangeRequestStatus[this.vehicleTypegroupChangeRequest.stagingItem.status];
            }
        }
        ...
        this.newAcFileUploader.uploadAttachments().subscribe(function (uploadedFiles) {
            ...
            _this.vehicleTypeGroupService.submitChangeRequestReview(_this.vehicleTypegroupChangeRequest.stagingItem.changeRequestId, _this.changeRequestReview).subscribe(function (result) {
                if (result) {
                    ...
                    if (_this.changeRequestReview.reviewStatus != changeRequestReview_model_1.ChangeRequestStatus.Deleted) {
                        toasterMessage = {
                            ...
                            body: "Your review for " + _this.vehicleTypegroupChangeRequest.stagingItem.changeType + " " + _this.vehicleTypegroupChangeRequest.stagingItem.entityName + " : " + _this.vehicleTypegroupChangeRequest.entityStaging.name + " change request ID " + _this.vehicleTypegroupChangeRequest.stagingItem.changeRequestId + " was submitted successfully."
                        };
                    }
                    else {
                        toasterMessage = {
                            title: constants_warehouse_1.ConstantsWarehouse.reviewDeleteSuccessTitle,
                            body: "Your delete request for " + _this.vehicleTypegroupChangeRequest.stagingItem.changeType + " " + _this.vehicleTypegroupChangeRequest.stagingItem.entityName + " : " + _this.vehicleTypegroupChangeRequest.entityStaging.name + " change request ID " + _this.vehicleTypegroupChangeRequest.stagingItem.changeRequestId + " was submitted successfully."
                        };
                    }
                    _this.toastr.success(toasterMessage.body, toasterMessage.title);
                    ...
                    if (_this.changeRequestReview.reviewStatus != changeRequestReview_model_1.ChangeRequestStatus.Deleted) {
                        toasterMessage = {
                            ...
                            body: "Your review for " + _this.vehicleTypegroupChangeRequest.stagingItem.changeType + " " + _this.vehicleTypegroupChangeRequest.stagingItem.entityName + " : " + _this.vehicleTypegroupChangeRequest.entityStaging.name + " change request ID " + _this.vehicleTypegroupChangeRequest.stagingItem.changeRequestId + " failed."
                        };
                    }
                    else {
                        toasterMessage = {
                            title: constants_warehouse_1.ConstantsWarehouse.reviewDeleteErrorTitle,
                            body: "Your delete request for " + _this.vehicleTypegroupChangeRequest.stagingItem.changeType + " " + _this.vehicleTypegroupChangeRequest.stagingItem.entityName + " : " + _this.vehicleTypegroupChangeRequest.entityStaging.name + " change request ID " + _this.vehicleTypegroupChangeRequest.stagingItem.changeRequestId + " failed."
                        };
                    }
                ...
                if (_this.changeRequestReview.reviewStatus != changeRequestReview_model_1.ChangeRequestStatus.Deleted) {
                    ...
                    toasterMessage = {
                        title: constants_warehouse_1.ConstantsWarehouse.reviewSubmitErrorTitle,
                        body: "Your delete request for " + _this.vehicleTypegroupChangeRequest.stagingItem.changeType + " " + _this.vehicleTypegroupChangeRequest.stagingItem.entityName + " : " + _this.vehicleTypegroupChangeRequest.entityStaging.name + " failed.\n" + error.toString() + "."
                    };
                }
                _this.toastr.warning(toasterMessage.body, toasterMessage.title);
                _this.showLoadingGif = false;
    ...
    VehicleTypeGroupReviewComponent.prototype.onAssignReviewer = function () {
        var _this = this;
        ...
        this.assignedReviewer.changeRequestIds[0] = this.vehicleTypegroupChangeRequest.stagingItem.changeRequestId;
        this.changeService.assignReviewer(this.assignedReviewer).subscribe(function (result) {
            if (result) {
                var toasterMessage = {
                    ...
                    body: "Your review for " + _this.vehicleTypegroupChangeRequest.stagingItem.changeType + " " + _this.vehicleTypegroupChangeRequest.stagingItem.entityName + " : " + _this.vehicleTypegroupChangeRequest.entityStaging.name + " assigned successfully."
                };
                _this.toastr.success(toasterMessage.body, toasterMessage.title);
                // redirect to search result
                _this.router.navigateByUrl(_this.backNavigation);
                ...
                var toasterMessage = {
                    ...
                    body: "Your assignment for " + _this.vehicleTypegroupChangeRequest.stagingItem.changeType + " " + _this.vehicleTypegroupChangeRequest.stagingItem.entityName + " : " + _this.vehicleTypegroupChangeRequest.entityStaging.name + " failed."
                };
                _this.toastr.warning(toasterMessage.body, toasterMessage.title);
            }
        }, function (error) {
    ...
    VehicleTypeGroupReviewComponent.prototype.onCancel = function () {
        // redirect to search result
        this.router.navigateByUrl(this.backNavigation);
    };
    VehicleTypeGroupReviewComponent.prototype.onLikeClick = function (status) {
        var _this = this;
        var id = Number(this.route.snapshot.params["id"]);
    ...
    VehicleTypeGroupReviewComponent.prototype.getLikes = function (changeRequestId) {
        var _this = this;
    ...
    VehicleTypeGroupReviewComponent.prototype.onClickLikes = function (id) {
        this.likeComponent.showAllLikedBy(id);
    };
    VehicleTypeGroupReviewComponent.prototype.cleanupComponent = function () {
        return this.newAcFileUploader.cleanupAllTempContainers();
    };
    VehicleTypeGroupReviewComponent.prototype.validationCheck = function () {
        var status = false;
        //Status Changed
    ...
    ], VehicleTypeGroupReviewComponent.prototype, "newAcFileUploader", void 0);
    __decorate([
        core_1.ViewChild("existingAcFileUploader"), 
        __metadata('design:type', ac_fileuploader_1.AcFileUploader)
    ], VehicleTypeGroupReviewComponent.prototype, "existingAcFileUploader", void 0);
    __decorate([
        core_1.ViewChild("likeComponent"), 
        __metadata('design:type', userLikes_component_1.UserLikesComponent)
    ], VehicleTypeGroupReviewComponent.prototype, "likeComponent", void 0);
    VehicleTypeGroupReviewComponent = __decorate([
        core_1.Component({
            selector: 'vehicleTypeGroup-review-comp',
            templateUrl: 'app/templates/vehicleTypeGroup/vehicleTypeGroup-review.component.html',
            providers: [vehicleTypeGroup_service_1.VehicleTypeGroupService, likeStaging_service_1.LikeStagingService, user_service_1.UserService, change_service_1.ChangeService],
        }), 
        __metadata('design:paramtypes', [vehicleTypeGroup_service_1.VehicleTypeGroupService, likeStaging_service_1.LikeStagingService, ng2_toastr_1.ToastsManager, router_1.ActivatedRoute, router_1.Router, shared_service_1.SharedService, user_service_1.UserService, change_service_1.ChangeService, navigation_service_1.NavigationService])
    ], VehicleTypeGroupReviewComponent);
    return VehicleTypeGroupReviewComponent;
}());
exports.VehicleTypeGroupReviewComponent = VehicleTypeGroupReviewComponent;
