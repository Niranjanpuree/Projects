...
var YearReviewComponent = (function () {
    function YearReviewComponent(yearService, likeStagingService, toastr, route, router, sharedService, userService, changeService, navgationService) {
    ...
    YearReviewComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.showLoadingGif = true;
        // Load existing base vechile with reference from RouteParams
        var id = Number(this.route.snapshot.params["id"]);
        this.yearService.getChangeRequestStaging(id).subscribe(function (result) {
            _this.yearChangeRequest = result;
            // set review's changerequestid
            _this.changeRequestReview.changeRequestId = _this.yearChangeRequest.stagingItem.changeRequestId;
            //this.getLikes(id);
            ...
            //this._identityInfo = this.sharedService.getIdentityInfo(String(this.yearChangeRequest.stagingItem.submittedBy));
            //if (this.yearChangeRequest.stagingItem.status === "Approved" || this.yearChangeRequest.stagingItem.status === "Deleted"
            //    || this.yearChangeRequest.stagingItem.status === "Rejected") {
            //    this.reviewCompleted = true;
            //} else if (this.yearChangeRequest.stagingItem.status === "PreliminaryApproved") {
            //    this.showPrelimRadio = false;
            //    if (this._identityInfo.isResearcher)
            //        this.reviewCompleted = true;
            //}
            // check if Preliminary Approved.
            if (_this.yearChangeRequest.stagingItem.status == "PreliminaryApproved") {
    ...
    YearReviewComponent.prototype.onReviewerChange = function () {
        if (this.assignedReviewer.assignedToUserId !== "-1" && !this.isPreliminaryApproveChecked) {
            this.isApproveChecked = false;
            this.isRejectChecked = false;
        }
    };
    YearReviewComponent.prototype.onChange = function (approved) {
    ...
    YearReviewComponent.prototype.onSubmitReview = function (deletebuttonclicked) {
        var _this = this;
        ...
        if (deletebuttonclicked == 'delete') {
            ...
            if (this.isPreliminaryApproveChecked) {
                ...
                this.changeRequestReview.reviewStatus = changeRequestReview_model_1.ChangeRequestStatus[this.yearChangeRequest.stagingItem.status];
            }
        }
        ...
        this.newAcFileUploader.uploadAttachments().subscribe(function (uploadedFiles) {
            ...
            _this.yearService.submitChangeRequestReview(_this.yearChangeRequest.stagingItem.changeRequestId, _this.changeRequestReview).subscribe(function (result) {
                if (result) {
                    ...
                    if (_this.changeRequestReview.reviewStatus != changeRequestReview_model_1.ChangeRequestStatus.Deleted) {
                        toasterMessage = {
                            ...
                            body: "Your review for " + _this.yearChangeRequest.stagingItem.changeType + " " + _this.yearChangeRequest.stagingItem.entityName + " : " + _this.yearChangeRequest.entityStaging.id + " change request ID " + _this.yearChangeRequest.stagingItem.changeRequestId + " was submitted successfully."
                        };
                    }
                    else {
                        toasterMessage = {
                            title: constants_warehouse_1.ConstantsWarehouse.reviewDeleteSuccessTitle,
                            body: "Your delete request for " + _this.yearChangeRequest.stagingItem.changeType + " " + _this.yearChangeRequest.stagingItem.entityName + " : " + _this.yearChangeRequest.entityStaging.id + " change request ID " + _this.yearChangeRequest.stagingItem.changeRequestId + " was submitted successfully."
                        };
                    }
                    _this.toastr.success(toasterMessage.body, toasterMessage.title);
                    ...
                    if (_this.changeRequestReview.reviewStatus != changeRequestReview_model_1.ChangeRequestStatus.Deleted) {
                        toasterMessage = {
                            ...
                            body: "Your review for " + _this.yearChangeRequest.stagingItem.changeType + " " + _this.yearChangeRequest.stagingItem.entityName + " : " + _this.yearChangeRequest.entityStaging.id + " change request ID " + _this.yearChangeRequest.stagingItem.changeRequestId + " failed."
                        };
                    }
                    else {
                        toasterMessage = {
                            title: constants_warehouse_1.ConstantsWarehouse.reviewDeleteErrorTitle,
                            body: "Your delete request for " + _this.yearChangeRequest.stagingItem.changeType + " " + _this.yearChangeRequest.stagingItem.entityName + " : " + _this.yearChangeRequest.entityStaging.id + " change request ID " + _this.yearChangeRequest.stagingItem.changeRequestId + " failed."
                        };
                    }
    ...
    YearReviewComponent.prototype.onAssignReviewer = function () {
        var _this = this;
        ...
        this.assignedReviewer.changeRequestIds[0] = this.yearChangeRequest.stagingItem.changeRequestId;
        this.changeService.assignReviewer(this.assignedReviewer).subscribe(function (result) {
            if (result) {
                var toasterMessage = {
                    ...
                    body: "Your review for " + _this.yearChangeRequest.stagingItem.changeType + " " + _this.yearChangeRequest.stagingItem.entityName + " : " + _this.yearChangeRequest.entityStaging.id + " assigned successfully."
                };
                _this.toastr.success(toasterMessage.body, toasterMessage.title);
                // redirect to search result
                _this.router.navigateByUrl(_this.backNavigation);
                ...
                var toasterMessage = {
                    ...
                    body: "Your assignment for " + _this.yearChangeRequest.stagingItem.changeType + " " + _this.yearChangeRequest.stagingItem.entityName + " : " + _this.yearChangeRequest.entityStaging.id + " failed."
                };
                _this.toastr.warning(toasterMessage.body, toasterMessage.title);
            }
        }, function (error) {
    ...
    YearReviewComponent.prototype.onCancel = function () {
        // redirect to search result
        this.router.navigateByUrl(this.backNavigation);
    };
    YearReviewComponent.prototype.validationCheck = function () {
        var status = false;
        //Status Changed
    ...
    YearReviewComponent.prototype.onLikeClick = function (status) {
        var _this = this;
        var id = Number(this.route.snapshot.params["id"]);
    ...
    YearReviewComponent.prototype.getLikes = function (changeRequestId) {
        var _this = this;
    ...
    YearReviewComponent.prototype.onClickLikes = function (id) {
        this.likeComponent.showAllLikedBy(id);
    };
    YearReviewComponent.prototype.cleanupComponent = function () {
        return this.newAcFileUploader.cleanupAllTempContainers();
    };
    __decorate([
        core_1.ViewChild("newAcFileUploader"), 
        __metadata('design:type', ac_fileuploader_1.AcFileUploader)
    ], YearReviewComponent.prototype, "newAcFileUploader", void 0);
    __decorate([
        core_1.ViewChild("existingAcFileUploader"), 
        __metadata('design:type', ac_fileuploader_1.AcFileUploader)
    ], YearReviewComponent.prototype, "existingAcFileUploader", void 0);
    __decorate([
        core_1.ViewChild("likeComponent"), 
        __metadata('design:type', userLikes_component_1.UserLikesComponent)
    ], YearReviewComponent.prototype, "likeComponent", void 0);
    YearReviewComponent = __decorate([
        core_1.Component({
            selector: 'year-review-comp',
            templateUrl: 'app/templates/year/year-review.component.html',
            providers: [year_service_1.YearService, likeStaging_service_1.LikeStagingService, user_service_1.UserService, change_service_1.ChangeService],
        }), 
        __metadata('design:paramtypes', [year_service_1.YearService, likeStaging_service_1.LikeStagingService, ng2_toastr_1.ToastsManager, router_1.ActivatedRoute, router_1.Router, shared_service_1.SharedService, user_service_1.UserService, change_service_1.ChangeService, navigation_service_1.NavigationService])
    ], YearReviewComponent);
    return YearReviewComponent;
}());
exports.YearReviewComponent = YearReviewComponent;
