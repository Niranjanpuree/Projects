                            ...
                            <tr>
                                <td>
                                    <table style="border-collapse: collapse;width:100%">
                                        ...
                                        <tr>
                                            <td colspan="2" style="padding:0; font-size: 12px;line-height: 1.5; margin-top:20px; padding:20px 20px 0 20px; border-top:1px solid #eee;">
                                                    <div>
                                        ...
                                        <tr>
                                            <td colspan="2" style="font-size: 14px; line-height: 2.5; text-align:center; padding-top:30px;"><span style="display:block; padding-bottom:5px;">Details of the updated task order Mod</span></td>
                                        </tr>
                                        <tr>
                                            <td colspan="2" style="font-size: 14px;line-height: 2.5; text-align:center; padding-bottom:30px; padding-top:10px;">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td style="padding:8px 20px; font-size: 14px;line-height: 2.5; text-align:center; padding-bottom:30px; padding-top:30px;"
                                                        colspan="2">  <table cellpadding="0" cellspacing="0" border="0" style="width:100%">
                                                                <tr>
                                                                    <td></td>
                                                                    <td style="background:#00649B; text-align:center; border-radius:4px; letter-spacing: 1px; color:#fff; text-transform: uppercase; height:40px;"
                                                                        width="200">
                                                                        <a style="padding:10px 0; color:#fff; display:block;  text-decoration: none;"
                                                                            href="{Redirect_Url}">Go To Contract Detail</a></td>
                                                                    <td></td>
                                                                </tr>
                                                            </table>
                                                ...
                                                <table cellpadding="0" cellspacing="0" border="0" style="width:100%">
                                                        <tr>
                                                            ...
                                                            <td style="background:#00649B; text-align:center; border-radius:4px; letter-spacing: 1px; color:#fff; text-transform: uppercase; height:40px;"
                                                                width="200">
                                                                <a style="padding:10px 0; color:#fff; display:block;  text-decoration: none;"
                                                                    href="{JOBREQUEST_URL}">View Detail</a></td>
                                                            <td></td>
                                                        </tr>
                                                    </table>
                                            </td>
                ...
                <tr>
                    <td>
                        ...
                        <p style="line-height:1.6;">
                            {SUBMITTED_NAME} has updated a task order in the Contract Management System (CMS). You have been identified as someone who needs to add additional information to complete the submission process. You can see the task order details by clicking the button below. If you have any questions, please contact {SUBMITTED_NAME} for more information.
                        </p>
                        <br>
                        <table
                            style="width: 100%;margin: 0 auto; overflow:hidden; padding-top:10px;border: 1px solid #eee; background: #fff;line-height: 1.5;border-radius: 5px;">
                            <tr>
                                <td>
                                    ...
                                    <table style="border-collapse: collapse;width:100%">
                                        ...
                                        <tr>
                                            <td colspan="2" style="font-size: 14px;line-height: 2.5; text-align:center;"><span style="display:block; padding-bottom:5px;">Details of the updated Task order</span></td>
                                        </tr>
                            ...
                            <tr>
                                <td>
                                    ...
                                    <table style="border-collapse: collapse;width:100%">
                                        ...
                                        <td>
                                            <td colspan="2" style="padding:8px 20px; font-size: 14px;line-height: 2.5; text-align:center; padding-top:30px;">
                                                    <span style="display:block; padding-bottom:5px;">Details of the added task order Mod</span>
                                                </td>
                                        </td>
                                        <tr>
                                            <td colspan="2"
                                                style="padding:8px 20px; font-size: 14px;line-height: 2.5; text-align:center; padding-bottom:30px;">
            ...
            <table style="max-width:600px; width:100%; margin:30px auto;" align="center">
                <tr>
                    <td>
                        ...
                        <p style="line-height:1.6;"> {SUBMITTED_NAME} has new task order in the Contract Management System (CMS). You have been identified as someone who needs to add additional information to complete the submission process. You can see the contract details by clicking the button below. If you have any questions, please contact {SUBMITTED_NAME} for more information.
                        </p>
                        <br>
                        <table
                            style="width: 100%;margin: 0 auto; overflow:hidden; padding-top:10px;border: 1px solid #eee; background: #fff;line-height: 1.5;border-radius: 5px;">
