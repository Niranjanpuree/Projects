...
{
    public class RevenueRecognition : BaseModel
    {
        ...
        private IList<ContractResourceFile> contractFileList;

        public IList<ContractResourceFile> ContractFileList
        {
            get { return contractFileList; }
            set { contractFileList = value; }
        }
        
    }

    public class RevenueTriggeredDetailModel
    {
