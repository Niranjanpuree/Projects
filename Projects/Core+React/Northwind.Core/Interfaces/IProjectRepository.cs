...
//        IEnumerable<ProjectViewModel> GetAll(Guid ContractGuid, string searchValue, int pageSize, int skip, string sortField, string sortDirection);
        ...
        ContractQuestionaire GetContractQuestionaireById(Guid id);
        ...
        IEnumerable<EmployeeBillingRates> GetBillingRates(string path);
        ...
        IEnumerable<LaborCategoryRates> GetCategoryRates(string path);
