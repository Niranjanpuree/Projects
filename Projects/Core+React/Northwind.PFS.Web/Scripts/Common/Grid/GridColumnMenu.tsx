...
import {
    GridFilterCellProps,
    GridColumnMenuSort,
    GridColumnMenuFilter, GridColumnMenuProps, GridColumnMenuItemGroup, GridColumnMenuItemContent, GridColumnMenuItem } from '@progress/kendo-react-grid';
...
export class GridColumnMenu extends React.Component<CustomColumnMenuProps, GridColumnMenuState> {
    selectedColumns: any[] = []
