...
export class KendoGroupableGrid extends React.Component<IGridProps, IGridState> {
    ...
    constructor(props: IGridProps)
    {
        ...
        let dState: any = { take: 10, skip: 0, searchValue: searchValue, dir: 'asc', sortField: '', additionalFilter: tmpAdditionalFilter.value, group: groups, data: [], total: 0 };
    ...
    clearSelection()
    {
        ...
        if (this.state.gridState && this.state.gridState.data && this.state.gridState.data.data) {
            ...
            this.setState({ gridState: { ...this.state.gridState, data: { ...this.state.gridState.data, data: this.state.gridState.data.data } }, persistentSelection: [], gridHeaderChecked: false }, this.loadGridData);
        }
    ...
    getCommandCell(e: any)
    {
        ...
        return (<td style={{ overflow: 'visible'}}><CommandCell menuItems={this.props.rowMenus} dataItem={e.dataItem} parent={this} /></td>);
    }
    ...
    onPageChange(e: any)
    {
        this.setState({ gridState: { ...this.state.gridState, skip: e.page.skip, take: e.page.take, searchValue: this.state.gridState.searchValue, dir: this.state.gridState.dir, sortField: this.state.gridState.sortField } }, this.loadGridData)
    }
    ...
    loadGridData(columnMenu: any = undefined)
    {
        ...
        if (this.state.gridState.method === 'post' || (this.props.searchParameters && this.props.searchParameters.advancedSearchConditions && this.props.searchParameters.advancedSearchConditions.length > 0)) {
            ...
            Remote.postData(this.url, postValue, (data: any) =>
            {
    ...
    {
        this.setState({ advancedSearchConditions: conditions, gridState: { ...this.state.gridState, method: 'post' } }, this.loadGridData);
    }
    ...
    onAdditionalFilterChange(e: any)
    {
        ...
        this.setState({ additionalFilterValue: value, gridState: { ...this.state.gridState, additionalFilter: value.value } }, this.loadGridData);
    }
    ...
    render()
    {
        let gridStyle = { ...this.state.gridStyle, width: '100%', maxHeight: this.state.clientHeight };    
        return (<div id="groupableGrid">
            {this.renderSearchBoxAndActions()}
            <Grid ref={(c) => { this.grid = c; }} sortable={true} onSortChange={this.onSortChange} style={gridStyle} selectedField="selected" {...this.state.gridState} groupable={{ footer: 'visible' }} onExpandChange={this.expandChange} onPageChange={this.onPageChange} onHeaderSelectionChange={this.onHeaderSelectionChange}
