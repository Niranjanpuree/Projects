$(document).ready(function () {
    var uploadGrid = document.getElementsByClassName("SubLaborGridList");
    ...
    function onSorting(arg) {
        var dataUrl = "/contract/" + controller + "?id=" + $(idvalue).val() + '&sortField=' + arg.sort.field + '&sortDirection=' + (arg.sort.dir == null ? "asc" : arg.sort.dir);
        var grid = $(gridId).data("kendoGrid");
