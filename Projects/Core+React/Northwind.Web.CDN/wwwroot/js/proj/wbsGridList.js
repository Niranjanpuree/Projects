$(document).ready(function () {
    var uploadGrid = document.getElementsByClassName("WbsGridList");
    ...
    // Section grid..
    function LoadGrid() {
        var dataUrl = "/project/" + controller + "?id=" + $(idvalue).val();
                ...
                columns.push({
                    command: [{
                        name: "Delete", click: function (e1) {
                            var sender = this;
                            Dialog.confirm({
                                text: "Are you sure you want to delete this?", title: "Delete confirmation", sender: e1, ok: function (e, e1) {
