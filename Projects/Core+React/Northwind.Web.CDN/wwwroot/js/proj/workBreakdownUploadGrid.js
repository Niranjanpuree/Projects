$(document).ready(function () {
    var uploadGrid = document.getElementsByClassName("WBSUploadGrid");
    ...
    function LoadWBSGrid() {
        ...
        $(downloadGrid).on('click', function (e) {
            ...
            $.ajax({
                ...
                success: function (values) {
                    window.location.href = "/contract/DownloadDocument?filePath=" + fileUploadName + "&&fileName=" + fileName;
                },
        ...
        $(addRow).on('click', function (e) {
            ...
            dataSource.add({ contractGuid: $(idvalue).val() })
    ...
    function onSorting(arg) {
        var dataUrl = "/" + controller + "/Get?id=" + $(idvalue).val(); + '&sortField=' + arg.sort.field + '&sortDirection=' + (arg.sort.dir == null ? "asc" : arg.sort.dir);
        var grid = $(gridId).data("kendoGrid");
