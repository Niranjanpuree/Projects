...
export class KendoGroupableGrid1 extends React.Component<IGridProps, IGridState> {

    static instance: KendoGroupableGrid1 = null;
    grid: Grid;
    searchText: any;
    dialog: any;
    columnMenus: any[];
    ...
    constructor(props: IGridProps) {
        super(props);
        KendoGroupableGrid1.instance = this;
        let groups: any[] = [];
        let searchValue = '';
    ...
    exportPDFClick(fieldUrl: string) {
        ...
        }, KendoGroupableGrid1.instance.dialog.openForm)
    }
