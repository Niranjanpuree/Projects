...
gulp.task('gulp-clean', function (e) {
    return gulp.src(paths.css+'*.css.map', {read: false})
        .pipe(clean());
        e();
});
...
gulp.task('build', gulp.series('clear', gulp.parallel('styles-build', 'styles_vendor-build', 'gulp-clean'), function (e) {
    e();
}));
