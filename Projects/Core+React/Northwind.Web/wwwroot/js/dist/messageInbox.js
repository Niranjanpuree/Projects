...
/******/ 	return __webpack_require__(__webpack_require__.s = "./Scripts/Component/MessageInbox/index.tsx");
/******/ })
/************************************************************************/
/******/ ({
...
var Remote = function () {
    ...
    _createClass(Remote, null, [{
        ...
        value: function post(url, form, callback, error) {
            ...
            fetch(url, { credentials: 'same-origin', method: 'post', body: JSON.stringify(data), headers: { 'Accept': 'application/json', 'Content-Type': 'application/json', 'Cache-Control': 'no-cache' } }).then(function (response) {
        ...
        value: function postPlainFormData(url, data, callback, error) {
            fetch(url, { credentials: 'same-origin', method: 'post', body: data }).then(function (response) {
        ...
        value: function onError(data, callback) {
            ...
            if (message == "") message = data.statusText;
            callback(message);
        }
    }, {
        key: "download",
...
/***/ "./Scripts/Component/MessageInbox/MessageInbox.tsx":
/*!*********************************************************!*\
  !*** ./Scripts/Component/MessageInbox/MessageInbox.tsx ***!
  \*********************************************************/
/*! no static exports found */
...
var NotificationSummary_1 = __webpack_require__(/*! ../NotificationSummary/NotificationSummary */ "./Scripts/Component/NotificationSummary/NotificationSummary.tsx");
var SingleMessageEntity_1 = __webpack_require__(/*! ./SingleMessageEntity */ "./Scripts/Component/MessageInbox/SingleMessageEntity.tsx");

var MessageInbox = function (_React$Component) {
    _inherits(MessageInbox, _React$Component);

    function MessageInbox(props) {
        _classCallCheck(this, MessageInbox);

        var _this = _possibleConstructorReturn(this, (MessageInbox.__proto__ || Object.getPrototypeOf(MessageInbox)).call(this, props));
        ...
        _this.state = {
            ...
            notificationProps: '',
            searchValue: '',
            notificationMessageGuid: _this.props.notificationMessageGuid,
            showNotFoundMessage: false
        };
        return _this;
    }

    _createClass(MessageInbox, [{
        key: "getDesktopNotifications",
        value: function getDesktopNotifications(searchValue) {
            var sender = this;
            Remote_1.Remote.get("/Notification/GetDesktopNotification?searchValue=" + searchValue, function (response) {
                sender.setState({
        ...
        key: "getInitialMessage",
        value: function getInitialMessage(searchValue) {
            var sender = this;
            Remote_1.Remote.get("/Admin/Inbox/GetMessageByNotificationMessageId?notificationMessageGuid=" + this.props.notificationMessageGuid, function (response) {
                sender.setState({
                    notificationProps: response
                });
            }, function (err) {
                window.Dialog.alert(err);
            });
        ...
        value: function renderMessageList() {
            ...
            return React.createElement("div", null, React.createElement("div", { className: "inbox-container" }, React.createElement("div", { className: "row" }, React.createElement("div", { className: "inbox-list-container col-md-4 col-lg-3" }, React.createElement("div", { className: "inbox-header border-bottom" }, React.createElement("div", { className: "input-group search-form-r" }, React.createElement("input", { type: "text", className: "form-control", id: "inlineFormInputGroup", onChange: this.onSearchChange, value: this.state.searchValue, placeholder: "Search" }), React.createElement("div", { className: "input-group-append" }, React.createElement("div", { className: "input-group-text" }, React.createElement("a", { href: "javascript:void(0)", onClick: this.onSearchClick, className: "k-icon k-i-search" }))))), React.createElement("ul", { className: "list-unstyled mb-0 inbox-list" }, this.state.notificationList.map(function (value, index) {
                if (value.notificationMessageGuid === _this2.state.notificationMessageGuid) {
                    return React.createElement("li", { key: index, className: value.userResponse == true ? "notification-read py-3 border-bottom active" : "py-3 border-bottom showActiveMessage" }, React.createElement("div", { onClick: function onClick() {
                    ...
                    return React.createElement("li", { key: index, className: value.userResponse === true ? "notification-read py-3 border-bottom " : "py-3 border-bottom" }, React.createElement("div", { onClick: function onClick() {
                            return _this2.individualNotificationClick(value);
                        }, className: "notification-item individualNotification" }, React.createElement("p", { className: "notification-subject" }, value.subject), React.createElement("p", { className: "notification-message-additional" }, value.additionalMessage), React.createElement("div", { className: "notification-item-footer" }, React.createElement("span", { className: "notification-item-created" }, value.createdByName), React.createElement("span", { className: "notification-item-date" }, React.createElement("i", { className: "k-icon k-i-clock" }), value.createdOnFormatDateTime))));
                }
            }), this.state.showNotFoundMessage && React.createElement("li", null, React.createElement("div", { className: "not-found-message" }, React.createElement("i", { className: "material-icons" }, "sms_failed "), React.createElement("h6", null, "No results found"), React.createElement("small", null, "It seems we can\u2019t find any results based on your search."))))), React.createElement("div", { className: "col-sm-8 col-lg-9" }, this.state.notificationProps !== '' && React.createElement(SingleMessageEntity_1.SingleMessageEntity, { notificationProps: this.state.notificationProps })))));
        }
    }, {
        key: "render",
        ...
        value: function individualNotificationClick(notificationProps) {
            ...
            var sender = this;
            Remote_1.Remote.postData("/Notification/EditUserResponseByNotificationMessageId", notificationProps.notificationMessageGuid, function (data) {
                _this3.getDesktopNotifications(_this3.state.searchValue || '');
                sender.forceUpdate();
            }, function (error) {});
            ...
            if (document.getElementById('notificationSummary')) {
                ...
                ReactDOM.render(React.createElement(NotificationSummary_1.NotificationSummary, { parentDomId: "notificationSummary" }), document.getElementById("notificationSummary"));
            }
        }
    }]);
...
/***/ "./Scripts/Component/MessageInbox/SingleMessageEntity.tsx":
/*!****************************************************************!*\
  !*** ./Scripts/Component/MessageInbox/SingleMessageEntity.tsx ***!
  \****************************************************************/
/*! no static exports found */
...
Object.defineProperty(exports, "__esModule", { value: true });
var React = __webpack_require__(/*! react */ "react");
function SingleMessageEntity(props) {
    var _props$notificationPr = props.notificationProps,
        subject = _props$notificationPr.subject,
        message = _props$notificationPr.message,
        additionalMessage = _props$notificationPr.additionalMessage,
        createdOnFormatDateTime = _props$notificationPr.createdOnFormatDateTime;

    return React.createElement("div", null, React.createElement("div", { className: "inbox-detail-container" }, React.createElement("div", { className: "inbox-detail-header" }, React.createElement("h5", null, subject)), React.createElement("div", { className: "inbox-detail" }, React.createElement("div", { dangerouslySetInnerHTML: { __html: message } }))));
}
exports.SingleMessageEntity = SingleMessageEntity;

/***/ }),

/***/ "./Scripts/Component/MessageInbox/index.tsx":
/*!**************************************************!*\
  !*** ./Scripts/Component/MessageInbox/index.tsx ***!
  \**************************************************/
/*! no static exports found */
...
var React = __webpack_require__(/*! react */ "react");
var ReactDOM = __webpack_require__(/*! react-dom */ "react-dom");
var MessageInbox_1 = __webpack_require__(/*! ./MessageInbox */ "./Scripts/Component/MessageInbox/MessageInbox.tsx");
function loadMessageInbox(notificationMessageGuid) {
    ReactDOM.render(React.createElement(MessageInbox_1.MessageInbox, { parentDomId: "messageInbox", notificationMessageGuid: notificationMessageGuid }), document.getElementById("messageInbox"));
}
...
/******/ });
//# sourceMappingURL=messageInbox.js.map