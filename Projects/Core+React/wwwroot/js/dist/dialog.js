...
/******/ 	return __webpack_require__(__webpack_require__.s = "./Scripts/Common/Dialog/index.tsx");
/******/ })
/************************************************************************/
/******/ ({

/***/ "./Scripts/Common/Dialog/Dialog.tsx":
/*!******************************************!*\
  !*** ./Scripts/Common/Dialog/Dialog.tsx ***!
  \******************************************/
...
var Remote_1 = __webpack_require__(/*! ../Remote/Remote */ "./Scripts/Common/Remote/Remote.tsx");

var KendoDialog = function (_React$Component) {
    _inherits(KendoDialog, _React$Component);

    function KendoDialog(props) {
        _classCallCheck(this, KendoDialog);

        var _this = _possibleConstructorReturn(this, (KendoDialog.__proto__ || Object.getPrototypeOf(KendoDialog)).call(this, props));
    ...
    _createClass(KendoDialog, [{
        ...
        value: function onButtonClick(e) {
            ...
            if (buttonIndex > -1) {
                if (button.requireValidation) {
                        ...
                        $("form").find("input, textarea").each(function (e, index) {
                            if ($(this).attr("data-val-required")) {
                                if ($("#" + $(this).attr("id") + "-error").length > 0) {
                                    ...
                                    if ($(this).is(":invalid")) {
                                        var objValidation = $('[data-valmsg-for="' + $(this).attr("id") + '"]');
                    ...
                    var _postValue = dlg.serializeToJson($("form"));
                    this.setState({ visible: false, formText: '' }, this.forceUpdate);
                    button.action(evt, _postValue);
                }
            }
        }
    }, {
        key: "getClickedButton",
        value: function getClickedButton(e) {
            ...
            if (this.props.buttons.length == 1) {
                if (this.props.buttons[0].length > 0) {
                    this.props.buttons[0].forEach(function (e, index) {
                        buttons.push(React.createElement(kendo_react_buttons_1.Button, { key: _this2.props.uniqueKey + "button" + index, primary: e.primary, itemID: index + "", onClick: _this2.onButtonClick }, e.text));
                    });
                } else {
        ...
        value: function componentDidMount() {
            ...
            if (!this.props || !this.props.getUrl || this.props.getUrl == "") return;
            var sender = this;
            Remote_1.Remote.getText(this.props.getUrl, function (result) {
                sender.setState(Object.assign({}, _this3.state, { visible: _this3.state.visible, formText: result }));
            }, function (error) {
            ...
            if (!(!this.props && !this.props.getUrl && this.props.getUrl === "")) {
                ...
                if (prop.getMethod.toLowerCase() === "get") {
                    Remote_1.Remote.getText(this.props.getUrl, function (result) {
                        ...
                        if (arr.length > 0) {
                            dialogController.setState({ formText: result, visible: true }, _this4.forceUpdate);
                            for (var cnt in arr) {
                    ...
                    Remote_1.Remote.postDataText(this.props.getUrl, prop.postData, function (result) {
                        var arr = [];
                        var extractscript = /<script\b[^<]*(?:(?!<\/script>)<[^<]*)*<\/script>/gi.exec(result);
                        while (extractscript && extractscript.length > 0) {
                            arr.push(extractscript[0]);
        ...
        value: function render() {
            return React.createElement("div", null, this.state.visible && React.createElement(kendo_react_dialogs_1.Dialog, { key: this.props.uniqueKey, title: this.props.dialogTitle, width: this.props.dialogWidth, height: this.props.dialogHeight }, React.createElement("div", { className: "container" }, React.createElement("div", { dangerouslySetInnerHTML: { __html: unescape(this.state.formText) } })), this.props.children, React.createElement(kendo_react_dialogs_1.DialogActionsBar, null, this.renderButtons())));
        }
    }]);
...
/***/ "./Scripts/Common/Dialog/Events.tsx":
/*!******************************************!*\
  !*** ./Scripts/Common/Dialog/Events.tsx ***!
  \******************************************/
/*! no static exports found */
...
var DialogEvents = function () {
    function DialogEvents() {
        _classCallCheck(this, DialogEvents);
    }

    _createClass(DialogEvents, null, [{
        key: "registerEvent",
        value: function registerEvent(component, event) {
        ...
        key: "getEvent",
        value: function getEvent(component) {
        ...
        key: "onClick",
        value: function onClick(e, component) {
...
/***/ "./Scripts/Common/Dialog/index.tsx":
/*!*****************************************!*\
  !*** ./Scripts/Common/Dialog/index.tsx ***!
  \*****************************************/
/*! no static exports found */
...
var Dialog_1 = __webpack_require__(/*! ./Dialog */ "./Scripts/Common/Dialog/Dialog.tsx");
var Events_1 = __webpack_require__(/*! ./Events */ "./Scripts/Common/Dialog/Events.tsx");
...
var LoadDialog = function () {
    ...
    _createClass(LoadDialog, null, [{
        ...
        value: function loadDialog() {
            for (var _i = 0; _i < document.getElementsByClassName("kendoDialogMenu").length; _i++) {
                var element = document.getElementsByClassName("kendoDialogMenu")[_i];
...
var Dialog = /** @class */ (function (_super) {
    ...
    Dialog.prototype.render = function () {
        ...
        return (react__WEBPACK_IMPORTED_MODULE_0__["createElement"]("div", { className: 'k-dialog-wrapper' +
